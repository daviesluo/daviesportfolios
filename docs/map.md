...
| `docs/agents/scripts/fp5/screen.py`, `docs/agents/scripts/fp5/screen_pass2.py`, `docs/agents/scripts/fp5/screen_pass5.py`, `docs/agents/scripts/fp5/screen_pass6.py`, `docs/agents/scripts/fp5/screen_pass7.py`, `docs/agents/scripts/fp5/screen_pass8.py`, `docs/agents/scripts/fp5/screen_pass9.py`, `docs/agents/scripts/fp5/screen_pass10.py`, `docs/agents/scripts/fp5/screen_pass11.py`, `docs/agents/scripts/fp5/*_rule.txt`, `docs/agents/reviews/2026-09-25-revolut-x-search.md`, `docs/agents/backtests/fp5/summary.json`, `docs/agents/backtests/fp5/summary_pass2.json`, `docs/agents/backtests/fp5/summary_pass3.json`, `docs/agents/backtests/fp5/summary_pass4.json`, `docs/agents/backtests/fp5/summary_pass5.json`, `docs/agents/backtests/fp5/summary_pass6.json`, `docs/agents/backtests/fp5/summary_pass7.json`, `docs/agents/backtests/fp5/summary_pass8.json`, `docs/agents/backtests/fp5/summary_pass9.json`, `docs/agents/backtests/fp5/summary_pass10.json`, `docs/agents/backtests/fp5/summary_pass11.json` | The 2026-09-25 Revolut X search: the arithmetic screens, the later frozen rules, the review, and the summaries. Nothing reached a pre-registered pass. |
