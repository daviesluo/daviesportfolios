...
| `docs/agents/scripts/fp16/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Lag-1 correlation of BTC's 24 hourly returns, long BTC the next day. The fill is fp5's. |
