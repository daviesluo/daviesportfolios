...
| `docs/agents/scripts/fp54/common.py`, `pin_test.py`, `fetch.py`, `measure.py`, `clock_test.py` | Where BTC's quote volume sits through the day, long BTC the next day. The fill is fp5's. The screen is `docs/agents/backtests/fp54/screen_2023.json`. |
...
| `docs/agents/scripts/fp57/common.py`, `pin_test.py`, `fetch.py`, `measure.py`, `base_test.py` | The change in BTC's base volume, long BTC the next day. The fill is fp5's. The screen is `docs/agents/backtests/fp57/screen_2023.json`. |
