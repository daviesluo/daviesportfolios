...
| `docs/agents/scripts/fp22/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How concentrated BTC's quote volume is across the day's hours, long BTC the next day. The fill is fp5's. |
