...
| `docs/agents/scripts/fp12/common.py`, `pin_test.py`, `fetch.py`, `measure.py`, `dom_up_test.py` | BTC dominance 8h return as a signal for the next BTC spot bar. The fill is fp5's. The protocol is `docs/agents/reviews/2026-09-25-fp12-protocol.md` and the pre-registration is `docs/agents/reviews/2026-09-25-fp12-prereg-dom-up.md`. |
