...
| `docs/agents/backtests/fp6/` | fp6, the fourth Binance search, on its derivatives: the keyless fetch scripts and pull manifest, the pre-registered rules' decision code, and the phase-1 counts. |
