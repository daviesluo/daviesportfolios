...
| `docs/agents/scripts/fp217/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Monday's open is bought and Friday's open is sold. One USDT-perpetual leg. Funding cash is not added. |
| `docs/agents/scripts/fp218/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | A UTC day numbered 1 through 7 is bought and sold at the next month's first open. One USDT-perpetual leg. Funding cash is not added. |
| `docs/agents/scripts/fp219/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The front quarterly is bought when 7 to 35 days remain and sold at the expiry open. One leg. Funding cash is not added. |
| `docs/agents/scripts/fp220/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | At least five of the seven finished sessions closed below their open: the next open is bought and sold seven days later. One USDT-perpetual leg. Funding cash is not added. |
| `docs/agents/scripts/fp221/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Spot's close finished strictly above its close seven days earlier: the next open is bought and sold seven days later. One spot leg. Funding cash is not added. |
| `docs/agents/scripts/fp222/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Friday's open is bought and the next Friday's open is sold. One USDT-perpetual leg. Funding cash is not added. |
| `docs/agents/scripts/fp223/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The 16:00 funding rate finished strictly below the 16:00 rate seven days earlier: the next open is bought and sold seven days later. One USDT-perpetual leg. Funding cash is not added. |
| `docs/agents/scripts/fp224/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The coin-margined seven-day return finished strictly below the USDT return: the next open is sold and bought back seven days later. One coin-margined leg. Funding cash is not added. |
