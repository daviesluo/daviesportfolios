...
| `docs/agents/scripts/fp218/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | A UTC day numbered 1 through 7 is bought and sold at the next month's first open. One USDT-perpetual leg. Funding cash is not added. The first screen is `docs/agents/backtests/fp218/screen_2023.json`. Its seven-day null is not a pass. The same-length null is `docs/agents/reviews/2026-09-25-fp218-matched-protocol.md` and is not yet scored. |
