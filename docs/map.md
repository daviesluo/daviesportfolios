...
| `docs/agents/scripts/fp13/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | ETH implied vol minus BTC implied vol, long BTC the next day. The fill is fp5's. The protocol is `docs/agents/reviews/2026-09-25-fp13-protocol.md`. |
