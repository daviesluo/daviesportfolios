...
| `docs/agents/scripts/fp177/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | A bullish engulfing body: long BTC the next day from the open to the close. |
| `docs/agents/scripts/fp178/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | An up day whose upper wick is strictly longer than the body: short BTC the next day from the open to the next open. The funding cash is not added. |
| `docs/agents/scripts/fp179/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | A close above yesterday's close and under yesterday's high: long BTC the next day from the open to the close. |
| `docs/agents/scripts/fp180/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Yesterday closed under its open, and today closed above that open: long BTC the next day from the open to the close. |
| `docs/agents/scripts/fp181/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | A lower high and a lower low: short BTC the next day from the open to the next open. The funding cash is not added. |
| `docs/agents/scripts/fp182/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | A low under yesterday's low and a close above yesterday's close: long BTC the next day from the open to the close. |
| `docs/agents/scripts/fp183/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | An up day whose body is strictly wider than yesterday's body: long BTC the next day from the open to the close. |
| `docs/agents/scripts/fp184/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | A close above the high of two days ago and under yesterday's high: long BTC the next day from the open to the close. |
