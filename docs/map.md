...
| `docs/agents/scripts/fp7/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The next Binance screen: MVRV, active addresses, and BTC's share of BTC+ETH volume. The fill is fp5's. |
