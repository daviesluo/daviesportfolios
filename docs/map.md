...
| `docs/agents/scripts/fp201/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT taker-buy average finished strictly above the mark close: short the coin-margined perpetual the next day from the open to the close. Funding cash is not added. |
| `docs/agents/scripts/fp202/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT close finished strictly above that day's average trade: short the coin-margined perpetual the next day from the open to the next open. |
| `docs/agents/scripts/fp203/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The coin-margined close/open finished strictly above the index close/open: short the USDT perpetual the next day from the open to the close. |
| `docs/agents/scripts/fp204/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The mark close/open finished strictly above the coin-margined close/open: next day, long the coin-margined perpetual and short the USDT perpetual, open to the next open. Funding cash is not added. |
| `docs/agents/scripts/fp205/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT close finished strictly above the mark close: short the USDT perpetual the next day from the open to the next open. Funding cash is not added. |
| `docs/agents/scripts/fp206/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The coin-margined 00:00 funding rate is strictly negative and the 16:00 rate strictly positive: short that day's close to the next open. Funding cash is not added. |
| `docs/agents/scripts/fp207/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT close finished strictly above the index close: short spot from the next close to the following close. |
| `docs/agents/scripts/fp208/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The mark close/open finished strictly above the USDT close/open: short the coin-margined perpetual from the next close to the following close. Funding cash is not added. |
