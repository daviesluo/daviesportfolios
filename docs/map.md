...
| `docs/agents/scripts/fp54/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Where BTC's quote volume sits through the day, long BTC the next day. The fill is fp5's. |
| `docs/agents/scripts/fp55/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How far BTC's close finished above the day's low, long BTC the next day. The fill is fp5's. |
| `docs/agents/scripts/fp56/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How many of BTC's hourly closes break the day's running close, long BTC the next day. The fill is fp5's. |
| `docs/agents/scripts/fp57/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The change in BTC's base volume, long BTC the next day. The fill is fp5's. |
| `docs/agents/scripts/fp58/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How late the later of BTC's high and low printed, long BTC the next day. The fill is fp5's. |
| `docs/agents/scripts/fp59/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The share of BTC's base volume in hours that closed above the prior hour, long BTC the next day. The fill is fp5's. |
| `docs/agents/scripts/fp60/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | BTC's open versus the previous day's low, long BTC the next day. The fill is fp5's. |
| `docs/agents/scripts/fp61/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | BTC's last hour's return, long BTC the next day. The fill is fp5's. |
