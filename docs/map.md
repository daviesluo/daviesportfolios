...
| `docs/agents/scripts/fp26/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The candle body as a share of the day's range, long BTC the next day. The fill is fp5's. |
