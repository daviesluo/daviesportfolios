...
| `docs/agents/scripts/fp29/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | BTC's close versus the prior 30 daily closes' high, long BTC the next day. The fill is fp5's. |
