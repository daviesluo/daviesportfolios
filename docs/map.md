...
| `docs/agents/scripts/fp6/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The next Binance search, after LS-FADE failed: five rules, the 2023 screen, and the pins. The fill is fp5's. |
