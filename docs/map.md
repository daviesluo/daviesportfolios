...
| `docs/agents/scripts/fp257/common.py`, `pin_test.py`, `fetch.py`, `measure.py`, `oos_fetch.py`, `pick_test.py` | Spot's finished four-day return is strictly negative. The next coin-margined open is bought and sold nine days later. The other trade buys spot for those same nine days. One leg. Funding cash is not added. The null is not that coin-margined long with the decline turned off. The protocol is `docs/agents/reviews/2026-09-25-fp257-protocol.md`. The screen is `docs/agents/backtests/fp257/screen_2023.json`. The pre-registration is `docs/agents/reviews/2026-09-25-fp257-prereg-pick.md`. |
