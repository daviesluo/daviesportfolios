...
| `docs/agents/scripts/fp103/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How wide BTC's three funding prints sat on the day, long BTC for two days. The fill is fp5's. |
| `docs/agents/scripts/fp104/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How wide BTC's three funding prints sat on the day, long BTC for three days. The fill is fp5's. |
| `docs/agents/scripts/fp105/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How wide BTC's three funding prints sat on the day, long BTC for four days. The fill is fp5's. |
| `docs/agents/scripts/fp106/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How wide BTC's three funding prints sat on the day, long BTC for five days. The fill is fp5's. |
| `docs/agents/scripts/fp107/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How wide BTC's three funding prints sat on the day, long BTC for six days. The fill is fp5's. |
| `docs/agents/scripts/fp108/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How wide BTC's three funding prints sat on the day, long BTC for seven days. The fill is fp5's. |
| `docs/agents/scripts/fp109/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How wide BTC's three funding prints sat on the day, long BTC for ten days. The fill is fp5's. |
| `docs/agents/scripts/fp110/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | How wide BTC's three funding prints sat on the day, long BTC for fourteen days. The fill is fp5's. |
