...
| `docs/agents/scripts/fp324/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the LBMA Gold Price PM divided by the completed Coin Metrics BUSD price. The previous PAXGBUSD close is at least fifty basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp324-protocol.md`. |
| `docs/agents/scripts/fp325/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the ECB US dollars per euro divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least twenty-five basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp325-protocol.md`. |
| `docs/agents/scripts/fp326/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the US Big Mac price over the euro-area Big Mac price, divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least two hundred basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp326-protocol.md`. |
| `docs/agents/scripts/fp327/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is US CPI-U over euro-area HICP, scaled by the 2022-12-30 ECB rate and divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least one basis point under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp327-protocol.md`. |
...
| `docs/agents/scripts/fp329/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is US average hourly earnings over the euro-area calendar-adjusted wage index, scaled by the 2022-12-30 ECB rate and divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least five hundred basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp329-protocol.md`. |
...
| `docs/agents/scripts/fp331/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is US airline fares over euro-area passenger air, scaled by the 2022-12-30 ECB rate and divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least one basis point under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp331-protocol.md`. |
