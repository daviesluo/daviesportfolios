...
| `docs/agents/scripts/fp174/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | A range strictly wider than the range six days earlier: long BTC from the next open to the open two days later. The screen is `docs/agents/backtests/fp174/screen_2023.json`. The pre-registration is `docs/agents/reviews/2026-09-25-fp174-prereg-lag6.md`. |
...
| `docs/agents/scripts/fp176/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The close is strictly above each of the prior three closes: long BTC from the next open to the open three days later. The screen is `docs/agents/backtests/fp176/screen_2023.json`. The pre-registration is `docs/agents/reviews/2026-09-25-fp176-prereg-c3.md`. |
