...
| `docs/agents/scripts/fp193/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The last book snapshot's ask notional is strictly above its bid notional: short BTC the next day from the open to the close. |
| `docs/agents/scripts/fp194/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The index close/open finished strictly above the spot close/open: short BTC the next day from the open to the next open. |
| `docs/agents/scripts/fp195/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT perpetual's average trade finished strictly above the spot average: next day, long spot and short that perpetual, open to close. Funding cash is not added. |
| `docs/agents/scripts/fp196/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The coin-margined close finished strictly above the spot close: next day, long spot and short that perpetual, open to close. Funding cash is not added. |
| `docs/agents/scripts/fp197/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The 16:00 funding rate finished strictly above the 08:00 rate: short BTC from that day's close to the next open. Funding cash is not added. |
| `docs/agents/scripts/fp198/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Coin open interest finished strictly above its first print: short the USDT perpetual the next day from the open to the close. Funding cash is not added. |
| `docs/agents/scripts/fp199/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The mark close/open finished strictly above the index close/open: short the USDT perpetual the next day from the open to the next open. Funding cash is not added. |
| `docs/agents/scripts/fp200/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT taker-buy share finished strictly above the coin-margined share: next day, long the coin-margined perpetual and short the USDT perpetual, open to close. Funding cash is not added. |
