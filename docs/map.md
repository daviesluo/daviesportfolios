...
| `docs/agents/scripts/fp225/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The front quarterly is bought when 21 to 35 days remain and sold ten days later, before expiry. One leg. Funding cash is not added. The protocol is `docs/agents/reviews/2026-09-25-fp225-protocol.md`. The screen is not scored yet. |
| `docs/agents/scripts/fp226/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Spot's close finished above its close twenty days earlier and below its close five days earlier. The next open is bought and sold ten days later. One spot leg. Funding cash is not added. The protocol is `docs/agents/reviews/2026-09-25-fp226-protocol.md`. The screen is not scored yet. |
| `docs/agents/scripts/fp227/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The coin-margined close finished above its close fifteen days earlier. The next open is sold and bought back eight days later. One coin-margined leg. Funding cash is not added. The protocol is `docs/agents/reviews/2026-09-25-fp227-protocol.md`. The screen is not scored yet. |
| `docs/agents/scripts/fp228/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT close finished below its close thirty days earlier. The next open is bought and sold five days later. One USDT-perpetual leg. Funding cash is not added. The protocol is `docs/agents/reviews/2026-09-25-fp228-protocol.md`. The screen is not scored yet. |
| `docs/agents/scripts/fp229/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Spot's finished ten-day return was strictly above the USDT return. The next spot open is sold and bought back fourteen days later. One spot leg. Funding cash is not added. The protocol is `docs/agents/reviews/2026-09-25-fp229-protocol.md`. The screen is not scored yet. |
| `docs/agents/scripts/fp230/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The coin-margined twelve-day return finished negative and below the spot twelve-day return. The next open is bought and sold twelve days later. One coin-margined leg. Funding cash is not added. The protocol is `docs/agents/reviews/2026-09-25-fp230-protocol.md`. The screen is not scored yet. |
| `docs/agents/scripts/fp231/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The most recently listed quarterly is bought during its first fourteen days and sold eleven days later, before expiry. One leg. Funding cash is not added. The protocol is `docs/agents/reviews/2026-09-25-fp231-protocol.md`. The screen is not scored yet. |
| `docs/agents/scripts/fp232/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT close finished above its close nine days earlier. The next open is sold and bought back nine days later. One USDT-perpetual leg. Funding cash is not added. The protocol is `docs/agents/reviews/2026-09-25-fp232-protocol.md`. The screen is not scored yet. |
