...
| `docs/agents/scripts/fp5/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The fourth Binance search's frozen screen: the rules, the pins, the public puller, and the 2023-only scorer. |
