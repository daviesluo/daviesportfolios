...
| `docs/agents/scripts/fp28/common.py`, `pin_test.py`, `fetch.py`, `measure.py`, `impact_test.py` | Whether BTC's hourly quote volume lined up with the hourly move, long BTC the next day. The fill is fp5's. The screen is `docs/agents/backtests/fp28/screen_2023.json`. |
