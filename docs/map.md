...
| `docs/agents/scripts/fp9/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The gap between Deribit DVOL and 30-day realized vol, and 8h cross-sectional dispersion. The fill is fp5's. The protocol is `docs/agents/reviews/2026-09-25-fp9-protocol.md`. |
