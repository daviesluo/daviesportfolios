...
| `docs/agents/scripts/fp281/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The finished spot close was strictly above each of the twenty-nine closes before it. Buy spot for eleven days. The other trade buys spot eleven days later for another eleven days. Both windows have to fill. One leg. Funding cash is not added. The null is not this leg with the condition turned off. The protocol is `docs/agents/reviews/2026-09-25-fp281-protocol.md`. The screen is `docs/agents/backtests/fp281/screen_2023.json`. |
| `docs/agents/scripts/fp282/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The finished seven-day USDT return was positive and the seven-day return that ended seven days earlier was negative. Buy the USDT book for eight days. The other trade buys it eight days later for another eight days. Both windows have to fill. One leg. Funding cash is not added. The null is not this leg with the condition turned off. The protocol is `docs/agents/reviews/2026-09-25-fp282-protocol.md`. The screen is `docs/agents/backtests/fp282/screen_2023.json`. |
| `docs/agents/scripts/fp283/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The finished eight-day coin-margined return was negative and the eight-day return that ended eight days earlier was positive. Sell the coin-margined book for eleven days. The other trade sells it eleven days later for another eleven days. Both windows have to fill. One leg. Funding cash is not added. The null is not this leg with the condition turned off. The protocol is `docs/agents/reviews/2026-09-25-fp283-protocol.md`. The screen is `docs/agents/backtests/fp283/screen_2023.json`. |
| `docs/agents/scripts/fp284/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Spot, the USDT book and the coin-margined book each finished a ten-day rise. Buy the coin-margined book for twenty-one days. The other trade buys spot for those same twenty-one days. One leg. Funding cash is not added. The null is not this leg with the condition turned off. The protocol is `docs/agents/reviews/2026-09-25-fp284-protocol.md`. The screen is `docs/agents/backtests/fp284/screen_2023.json`. |
| `docs/agents/scripts/fp285/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The finished nine-day coin-margined return was negative and strictly below the USDT nine-day return. Sell the coin-margined book for fifteen days. The other trade sells the USDT book for those same fifteen days. One leg. Funding cash is not added. The null is not this leg with the condition turned off. The protocol is `docs/agents/reviews/2026-09-25-fp285-protocol.md`. The screen is `docs/agents/backtests/fp285/screen_2023.json`. |
| `docs/agents/scripts/fp286/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Three non-overlapping finished five-day spot returns went up, then down, then up. Buy spot for five days. The other trade buys spot five days later for another five days. Both windows have to fill. One leg. Funding cash is not added. The null is not this leg with the condition turned off. The protocol is `docs/agents/reviews/2026-09-25-fp286-protocol.md`. The screen is `docs/agents/backtests/fp286/screen_2023.json`. |
| `docs/agents/scripts/fp287/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Spot and the USDT book both finished a sixteen-day rise, and the USDT rise was strictly smaller. Buy the USDT book for twenty days. The other trade buys spot for those same twenty days. One leg. Funding cash is not added. The null is not this leg with the condition turned off. The protocol is `docs/agents/reviews/2026-09-25-fp287-protocol.md`. The screen is `docs/agents/backtests/fp287/screen_2023.json`. |
| `docs/agents/scripts/fp288/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The lowest of the last eight finished spot closes was strictly above the lowest of the eight closes before those, and the finished eight-day spot return was positive. Buy spot for fifteen days. The other trade buys spot fifteen days later for another fifteen days. Both windows have to fill. One leg. Funding cash is not added. The null is not this leg with the condition turned off. The protocol is `docs/agents/reviews/2026-09-25-fp288-protocol.md`. The screen is `docs/agents/backtests/fp288/screen_2023.json`. |
| `docs/agents/scripts/fp289/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value of the USDT book is the spot close. The finished USDT close was at least five basis points under that fair value. Buy the USDT book for nine days. The other trade buys it for nine days when that discount is absent. One leg. Funding cash is not added. The null is the same leg with the edge turned off. The protocol is `docs/agents/reviews/2026-09-25-fp289-protocol.md`. The screen is `docs/agents/backtests/fp289/screen_2023.json`. |
| `docs/agents/scripts/fp290/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value of the USDT book is the spot close. The finished USDT close was strictly above that fair value. Sell the USDT book for twelve days. The other trade sells it for twelve days when it is not rich to spot. One leg. Funding cash is not added. The null is the same leg with the edge turned off. The protocol is `docs/agents/reviews/2026-09-25-fp290-protocol.md`. The screen is `docs/agents/backtests/fp290/screen_2023.json`. |
| `docs/agents/scripts/fp291/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value of spot is the USDT close. The finished spot close was strictly under that fair value. Buy spot for fourteen days. The other trade buys spot for fourteen days when it is not cheap to the USDT book. One leg. Funding cash is not added. The null is the same leg with the edge turned off. The protocol is `docs/agents/reviews/2026-09-25-fp291-protocol.md`. The screen is `docs/agents/backtests/fp291/screen_2023.json`. |
| `docs/agents/scripts/fp292/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The basis is the USDT close over the spot close. It finished positive and strictly above the basis five days earlier. Sell the USDT book for eight days. The other trade sells it for eight days when that wider premium is absent. One leg. Funding cash is not added. The null is the same leg with the edge turned off. The protocol is `docs/agents/reviews/2026-09-25-fp292-protocol.md`. The screen is `docs/agents/backtests/fp292/screen_2023.json`. |
| `docs/agents/scripts/fp293/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value of the coin-margined book is the USDT close. The finished coin-margined close was strictly under that fair value. Buy the coin-margined book for eleven days. The other trade buys it for eleven days when it is not cheap to the USDT book. One leg. Funding cash is not added. The null is the same leg with the edge turned off. The protocol is `docs/agents/reviews/2026-09-25-fp293-protocol.md`. The screen is `docs/agents/backtests/fp293/screen_2023.json`. |
| `docs/agents/scripts/fp294/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value of the USDT book is the coin-margined close. The finished USDT close was at least five basis points under that fair value. Buy the USDT book for six days. The other trade buys it for six days when that discount is absent. One leg. Funding cash is not added. The null is the same leg with the edge turned off. The protocol is `docs/agents/reviews/2026-09-25-fp294-protocol.md`. The screen is `docs/agents/backtests/fp294/screen_2023.json`. |
| `docs/agents/scripts/fp295/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The basis is the coin-margined close over the USDT close. It finished positive and strictly above the basis six days earlier. Sell the coin-margined book for ten days. The other trade sells it for ten days when that wider premium is absent. One leg. Funding cash is not added. The null is the same leg with the edge turned off. The protocol is `docs/agents/reviews/2026-09-25-fp295-protocol.md`. The screen is `docs/agents/backtests/fp295/screen_2023.json`. |
| `docs/agents/scripts/fp296/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value of the coin-margined book is the USDT close. The finished coin-margined close was at least five basis points above that fair value. Sell the coin-margined book for sixteen days. The other trade sells it for sixteen days when that premium is absent. One leg. Funding cash is not added. The null is the same leg with the edge turned off. The protocol is `docs/agents/reviews/2026-09-25-fp296-protocol.md`. The screen is `docs/agents/backtests/fp296/screen_2023.json`. |
| `docs/agents/scripts/fp297/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the Coinbase Exchange BTC-USD daily close, used only after that bucket has ended. The finished USDT close was at least ten basis points under it. Buy the USDT book for nine days. The other trade buys it for nine days when that discount is absent. The USDT open is the fill only. Spot, the coin-margined book and the USDT book are not each other's fair value. The protocol is `docs/agents/reviews/2026-09-25-fp297-protocol.md`. The screen is `docs/agents/backtests/fp297/screen_2023.json`. |
| `docs/agents/scripts/fp298/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the Coinbase Exchange BTC-USD daily close, used only after that bucket has ended. The finished USDT close was strictly above it. Sell the USDT book for twelve days. The other trade sells it for twelve days when that premium is absent. The USDT open is the fill only. Spot, the coin-margined book and the USDT book are not each other's fair value. The protocol is `docs/agents/reviews/2026-09-25-fp298-protocol.md`. The screen is `docs/agents/backtests/fp298/screen_2023.json`. |
| `docs/agents/scripts/fp299/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the Coinbase Exchange BTC-USD daily close, used only after that bucket has ended. The finished Binance spot close was at least five basis points under it. Buy Binance spot for fourteen days. The other trade buys it for fourteen days when that discount is absent. The spot open is the fill only. Spot, the coin-margined book and the USDT book are not each other's fair value. The protocol is `docs/agents/reviews/2026-09-25-fp299-protocol.md`. The screen is `docs/agents/backtests/fp299/screen_2023.json`. |
| `docs/agents/scripts/fp300/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the Coinbase Exchange BTC-USD daily close, used only after that bucket has ended. The USDT-over-Coinbase basis finished positive and strictly above the basis five days earlier. Sell the USDT book for eight days. The other trade sells it for eight days when that wider premium is absent. The USDT open is the fill only. Spot, the coin-margined book and the USDT book are not each other's fair value. The protocol is `docs/agents/reviews/2026-09-25-fp300-protocol.md`. The screen is `docs/agents/backtests/fp300/screen_2023.json`. |
| `docs/agents/scripts/fp301/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the Deribit BTC-PERPETUAL daily close, used only after that 08:00 UTC candle has ended. The finished USDT close was strictly under it. Buy the USDT book for eleven days. The other trade buys it for eleven days when that discount is absent. The USDT open is the fill only. Spot, the coin-margined book and the USDT book are not each other's fair value. The protocol is `docs/agents/reviews/2026-09-25-fp301-protocol.md`. The screen is `docs/agents/backtests/fp301/screen_2023.json`. |
| `docs/agents/scripts/fp302/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the Deribit BTC-PERPETUAL daily close, used only after that 08:00 UTC candle has ended. The finished coin-margined close was at least five basis points above it. Sell the coin-margined book for sixteen days. The other trade sells it for sixteen days when that premium is absent. The coin-margined open is the fill only. Spot, the coin-margined book and the USDT book are not each other's fair value. The protocol is `docs/agents/reviews/2026-09-25-fp302-protocol.md`. The screen is `docs/agents/backtests/fp302/screen_2023.json`. |
| `docs/agents/scripts/fp303/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the Deribit BTC-PERPETUAL daily close, used only after that 08:00 UTC candle has ended. The finished coin-margined close was strictly under it. Buy the coin-margined book for six days. The other trade buys it for six days when that discount is absent. The coin-margined open is the fill only. Spot, the coin-margined book and the USDT book are not each other's fair value. The protocol is `docs/agents/reviews/2026-09-25-fp303-protocol.md`. The screen is `docs/agents/backtests/fp303/screen_2023.json`. |
| `docs/agents/scripts/fp304/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the Deribit BTC-PERPETUAL daily close, used only after that 08:00 UTC candle has ended. The USDT-over-Deribit basis finished positive and strictly above the basis six days earlier. Sell the USDT book for ten days. The other trade sells it for ten days when that wider premium is absent. The USDT open is the fill only. Spot, the coin-margined book and the USDT book are not each other's fair value. The protocol is `docs/agents/reviews/2026-09-25-fp304-protocol.md`. The screen is `docs/agents/backtests/fp304/screen_2023.json`. |
| `docs/agents/scripts/fp305/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the Bitstamp BTC/USD daily close, used only after that 00:00 UTC bucket has ended. The finished USDT close was at least ten basis points under it. Buy the USDT book for nine days. The other trade buys it for nine days when that discount is absent. The USDT open is the fill only. A book ticker is not read. Spot, the coin-margined book and the USDT book are not each other's fair value. Coinbase and Deribit are not reused. The protocol is `docs/agents/reviews/2026-09-25-fp305-protocol.md`. The screen is `docs/agents/backtests/fp305/screen_2023.json`. |
| `docs/agents/scripts/fp306/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the Bitfinex tBTCUSD daily close, used only after that 00:00 UTC candle has ended. The finished USDT close was strictly above it. Sell the USDT book for twelve days. The other trade sells it for twelve days when that premium is absent. The USDT open is the fill only. A book ticker is not read. Spot, the coin-margined book and the USDT book are not each other's fair value. Coinbase and Deribit are not reused. The protocol is `docs/agents/reviews/2026-09-25-fp306-protocol.md`. The screen is `docs/agents/backtests/fp306/screen_2023.json`. |
| `docs/agents/scripts/fp307/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the BitMEX XBTUSD daily close, used only after that 00:00 UTC bucket has ended. The finished coin-margined close was strictly under it. Buy the coin-margined book for seven days. The other trade buys it for seven days when that discount is absent. The coin-margined open is the fill only. The 2023-08-28 through 2023-08-31 gap is not filled in. A book ticker is not read. Spot, the coin-margined book and the USDT book are not each other's fair value. Coinbase and Deribit are not reused. The protocol is `docs/agents/reviews/2026-09-25-fp307-protocol.md`. The screen is `docs/agents/backtests/fp307/screen_2023.json`. |
| `docs/agents/scripts/fp308/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the OKX spot BTC-USDT daily close, used only after that 00:00 UTC candle has ended. The finished Binance spot close was strictly under it. Buy Binance spot for fourteen days. The other trade buys it for fourteen days when that discount is absent. The spot open is the fill only. A book ticker is not read. Spot, the coin-margined book and the USDT book are not each other's fair value. Coinbase and Deribit are not reused. The protocol is `docs/agents/reviews/2026-09-25-fp308-protocol.md`. The screen is `docs/agents/backtests/fp308/screen_2023.json`. |
| `docs/agents/scripts/fp309/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the Gate.io BTC_USDT daily close, used only after that 00:00 UTC window has ended. The finished USDT close was at least five basis points under it. Buy the USDT book for eight days. The other trade buys it for eight days when that discount is absent. The USDT open is the fill only. A book ticker is not read. Spot, the coin-margined book and the USDT book are not each other's fair value. Coinbase and Deribit are not reused. The protocol is `docs/agents/reviews/2026-09-25-fp309-protocol.md`. The screen is `docs/agents/backtests/fp309/screen_2023.json`. |
| `docs/agents/scripts/fp310/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the KuCoin BTC-USDT daily close, used only after that 00:00 UTC candle has ended. The finished coin-margined close was at least five basis points under it. Buy the coin-margined book for eleven days. The other trade buys it for eleven days when that discount is absent. The coin-margined open is the fill only. The 2023-08-28 through 2023-08-31 gap is not filled in. A book ticker is not read. Spot, the coin-margined book and the USDT book are not each other's fair value. Coinbase and Deribit are not reused. The protocol is `docs/agents/reviews/2026-09-25-fp310-protocol.md`. The screen is `docs/agents/backtests/fp310/screen_2023.json`. |
| `docs/agents/scripts/fp311/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the HTX btcusdt daily close, used only after that 16:00 UTC candle has ended. The finished USDT close was strictly under it. Buy the USDT book for ten days. The other trade buys it for ten days when that discount is absent. The USDT open is the fill only. A book ticker is not read. Spot, the coin-margined book and the USDT book are not each other's fair value. Coinbase and Deribit are not reused. The protocol is `docs/agents/reviews/2026-09-25-fp311-protocol.md`. The screen is `docs/agents/backtests/fp311/screen_2023.json`. |
| `docs/agents/scripts/fp312/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the WhiteBIT BTC_USDT daily close, used only after that 00:00 UTC candle has ended. The finished Binance spot close was at least five basis points under it. Buy Binance spot for sixteen days. The other trade buys it for sixteen days when that discount is absent. The spot open is the fill only. A book ticker is not read. Spot, the coin-margined book and the USDT book are not each other's fair value. Coinbase and Deribit are not reused. The protocol is `docs/agents/reviews/2026-09-25-fp312-protocol.md`. The screen is `docs/agents/backtests/fp312/screen_2023.json`. |
| `docs/agents/scripts/fp313/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the price index inside Binance's funding formula for BTCUSDT. The last settled funding rate is negative, so that contract finished below the index. Buy the USDT book for two days. The other trade buys it for two days when that rate is not negative. The open is the fill only. Funding cash is not added. Another venue's close is not an input. A book ticker is not read. The protocol is `docs/agents/reviews/2026-09-25-fp313-protocol.md`. The screen is `docs/agents/backtests/fp313/screen_2023.json`. |
| `docs/agents/scripts/fp314/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the price index inside Binance's funding formula for BTCUSD_PERP. The last settled funding rate is negative, so that contract finished below the index. Buy the coin-margined book for two days. The other trade buys it for two days when that rate is not negative. The open is the fill only. Funding cash is not added. Another venue's close is not an input. A book ticker is not read. The 2023-08-28 through 2023-08-31 gap is not filled in. The protocol is `docs/agents/reviews/2026-09-25-fp314-protocol.md`. The screen is `docs/agents/backtests/fp314/screen_2023.json`. |
| `docs/agents/scripts/fp315/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the price index inside Binance's funding formula for ETHUSD_PERP. The last settled funding rate is negative, so that contract finished below the index. Buy the ETH coin-margined book for two days. The other trade buys it for two days when that rate is not negative. The open is the fill only. Funding cash is not added. Another venue's close is not an input. A book ticker is not read. The 2023-08-28 through 2023-08-31 gap is not filled in. The protocol is `docs/agents/reviews/2026-09-25-fp315-protocol.md`. The screen is `docs/agents/backtests/fp315/screen_2023.json`. |
| `docs/agents/scripts/fp316/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the price index inside Binance's funding formula for BNBUSDT. The last settled funding rate is negative, so that contract finished below the index. Buy the BNB USDT book for two days. The other trade buys it for two days when that rate is not negative. The open is the fill only. Funding cash is not added. Another venue's close is not an input. A book ticker is not read. The protocol is `docs/agents/reviews/2026-09-25-fp316-protocol.md`. The screen is `docs/agents/backtests/fp316/screen_2023.json`. |
| `docs/agents/scripts/fp317/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the price index grossed up by the already-published SOFR carry. The last settled BTCUSDT funding rate is strictly below that eight-hour SOFR rate, so the contract finished cheap to the cash-and-carry. Buy the USDT book for two days. The other trade buys it for two days when the settled rate is not below that SOFR rate. The open is the fill only. Funding cash is not added. Another venue's close is not an input. A book ticker is not read. The protocol is `docs/agents/reviews/2026-09-25-fp317-protocol.md`. The screen is `docs/agents/backtests/fp317/screen_2023.json`. |
| `docs/agents/scripts/fp318/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the price index grossed up by the already-published SOFR carry. The last settled BTCUSD_PERP funding rate is strictly below that eight-hour SOFR rate, so the contract finished cheap to the cash-and-carry. Buy the coin-margined book for two days. The other trade buys it for two days when the settled rate is not below that SOFR rate. The open is the fill only. Funding cash is not added. Another venue's close is not an input. A book ticker is not read. The 2023-08-28 through 2023-08-31 gap is not filled in. The protocol is `docs/agents/reviews/2026-09-25-fp318-protocol.md`. The screen is `docs/agents/backtests/fp318/screen_2023.json`. |
| `docs/agents/scripts/fp319/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the price index grossed up by the already-published SOFR carry. The last settled ETHUSDT funding rate is strictly below that eight-hour SOFR rate, so the contract finished cheap to the cash-and-carry. Buy the ETH USDT book for two days. The other trade buys it for two days when the settled rate is not below that SOFR rate. The open is the fill only. Funding cash is not added. Another venue's close is not an input. A book ticker is not read. The protocol is `docs/agents/reviews/2026-09-25-fp319-protocol.md`. The screen is `docs/agents/backtests/fp319/screen_2023.json`. |
| `docs/agents/scripts/fp320/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the price index grossed up by the already-published SOFR carry. The last settled ETHUSD_PERP funding rate is strictly below that eight-hour SOFR rate, so the contract finished cheap to the cash-and-carry. Buy the ETH coin-margined book for two days. The other trade buys it for two days when the settled rate is not below that SOFR rate. The open is the fill only. Funding cash is not added. Another venue's close is not an input. A book ticker is not read. The 2023-08-28 through 2023-08-31 gap is not filled in. The protocol is `docs/agents/reviews/2026-09-25-fp320-protocol.md`. The screen is `docs/agents/backtests/fp320/screen_2023.json`. |
| `docs/agents/scripts/fp321/common.py`, `pin_test.py`, `fetch.py`, `measure.py`, `oos_fetch.py`, `ereal_test.py` | Fair value is the Coin Metrics realized ETH price in USD. The previous ETHUSD_PERP close is at least one basis point under that price. Buy the coin-margined book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The entry day's close is not an input. A book ticker is not read. The 2023-08-28 through 2023-08-31 gap is not filled in. The protocol is `docs/agents/reviews/2026-09-25-fp321-protocol.md`. The screen is `docs/agents/backtests/fp321/screen_2023.json`. The pre-registration is `docs/agents/reviews/2026-09-25-fp321-prereg-ereal.md`. The out-of-sample record is `docs/agents/backtests/fp321/ereal_oos.json`. |
| `docs/agents/scripts/fp322/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is Binance's published WBETH exchange rate, ETH per WBETH. The previous WBETHETH close is at least twenty-five basis points under that rate. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The entry day's close is not an input. A book ticker is not read. April 2023 is not filled in. The protocol is `docs/agents/reviews/2026-09-25-fp322-protocol.md`. The screen is `docs/agents/backtests/fp322/screen_2023.json`. |
| `docs/agents/scripts/fp323/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the standing par of one BTC per WBTC. The previous WBTCBTC close is at least one basis point under that par. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The entry day's close is not an input. A book ticker is not read. The protocol is `docs/agents/reviews/2026-09-25-fp323-protocol.md`. The screen is `docs/agents/backtests/fp323/screen_2023.json`. |
| `docs/agents/scripts/fp324/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the LBMA Gold Price PM divided by the completed Coin Metrics BUSD price. The previous PAXGBUSD close is at least fifty basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp324-protocol.md`. The screen is `docs/agents/backtests/fp324/screen_2023.json`. |
| `docs/agents/scripts/fp325/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the ECB US dollars per euro divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least twenty-five basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp325-protocol.md`. The screen is `docs/agents/backtests/fp325/screen_2023.json`. |
| `docs/agents/scripts/fp326/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is the US Big Mac price over the euro-area Big Mac price, divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least two hundred basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp326-protocol.md`. The screen is `docs/agents/backtests/fp326/screen_2023.json`. |
| `docs/agents/scripts/fp327/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is US CPI-U over euro-area HICP, scaled by the 2022-12-30 ECB rate and divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least one basis point under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp327-protocol.md`. The screen is `docs/agents/backtests/fp327/screen_2023.json`. |
| `docs/agents/scripts/fp328/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is US finished-goods PPI over euro-area producer prices, scaled by the 2022-12-30 ECB rate and divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least five hundred basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp328-protocol.md`. The screen is `docs/agents/backtests/fp328/screen_2023.json`. |
| `docs/agents/scripts/fp329/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is US average hourly earnings over the euro-area calendar-adjusted wage index, scaled by the 2022-12-30 ECB rate and divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least five hundred basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp329-protocol.md`. The screen is `docs/agents/backtests/fp329/screen_2023.json`. |
| `docs/agents/scripts/fp330/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is US apparel CPI over euro-area clothing and footwear, scaled by the 2022-12-30 ECB rate and divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least one thousand basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp330-protocol.md`. The screen is `docs/agents/backtests/fp330/screen_2023.json`. |
| `docs/agents/scripts/fp331/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Fair value is US airline fares over euro-area passenger air, scaled by the 2022-12-30 ECB rate and divided by the completed Coin Metrics BUSD price. The previous EURBUSD close is at least one basis point under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. The open is the fill only. The protocol is `docs/agents/reviews/2026-09-25-fp331-protocol.md`. The screen is `docs/agents/backtests/fp331/screen_2023.json`. |
| `docs/agents/scripts/fp332/common.py`, `pin_test.py`, `fetch.py`, `measure.py`, `oos_fetch.py`, `oos_test.py` | The buyer of the front BTCUSDT quarterly pays more than the Binance spot open for a coin the contract meets at delivery. The result is the change in that basis between the entry opens and the expiry-day opens, minus forty basis points. The spot move is not the result. The previous close basis is at least 100 basis points. The same package is the other trade when it is not. The protocol is `docs/agents/reviews/2026-09-25-fp332-protocol.md`. The screen is `docs/agents/backtests/fp332/screen_2023.json`. The pre-registration is `docs/agents/reviews/2026-09-25-fp332-prereg-spqtr.md`. The later years are `docs/agents/backtests/fp332/spqtr_oos.json`. |
| `docs/agents/scripts/fp333/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The buyer of 1000PEPEUSDT overpays versus the PEPEUSDT open after dividing by one thousand. The result is the change in that premium between two daily opens, minus forty basis points. The coin's move and the funding cash are not the result. The previous close premium is at least 50 basis points. The same package is the other trade when it is not. The protocol is `docs/agents/reviews/2026-09-25-fp333-protocol.md`. The screen is `docs/agents/backtests/fp333/screen_2023.json`. |
| `docs/agents/scripts/fp334/common.py`, `pin_test.py`, `fetch.py`, `measure.py`, `oos_fetch.py`, `oos_test.py` | A negative TRBUSDT funding rate is cash the short pays the long, on a long-perpetual short-spot package. The result is that cash minus forty basis points. The coin's move is not added. The signal is the completed-interval premium, at least 50 basis points cheap, and the print is not the signal. The same package is the other trade when that premium is not that cheap. The protocol is `docs/agents/reviews/2026-09-25-fp334-protocol.md`. The screen is `docs/agents/backtests/fp334/screen_2023.json`. The pre-registration is `docs/agents/reviews/2026-09-25-fp334-prereg-fdcsh.md`. The later years are `docs/agents/backtests/fp334/fdcsh_oos.json`. |
