...
| `docs/agents/scripts/fp169/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | An outside day: long BTC the next day from the open to the close. |
| `docs/agents/scripts/fp170/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The 08:00 funding rate is strictly the lowest of the three: long BTC for one day. The funding cash is not added. |
| `docs/agents/scripts/fp171/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The close finished strictly above yesterday's high: long BTC the next day from the open to the close. |
| `docs/agents/scripts/fp172/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | A down day: the next day buys the open and sells at the prior day's low when that low trades, otherwise at the close. |
| `docs/agents/scripts/fp173/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | A day strictly inside the high and the low of three days earlier: long BTC the next day from the open to the close. |
| `docs/agents/scripts/fp174/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | A range strictly wider than the range six days earlier: long BTC from the next open to the open two days later. |
| `docs/agents/scripts/fp175/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Two higher highs: short BTC the next day from the open to the next open. The funding cash is not added. |
| `docs/agents/scripts/fp176/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The close is strictly above each of the prior three closes: long BTC from the next open to the open three days later. |
