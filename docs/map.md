...
| `docs/agents/scripts/fp28/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Whether BTC's hourly quote volume lined up with the hourly move, long BTC the next day. The fill is fp5's. |
