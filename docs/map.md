...
| `docs/agents/scripts/fp26/common.py`, `pin_test.py`, `fetch.py`, `measure.py`, `body_test.py` | The candle body as a share of the day's range, long BTC the next day. The fill is fp5's. The screen is `docs/agents/backtests/fp26/screen_2023.json`. |
