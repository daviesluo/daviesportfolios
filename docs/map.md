...
| `docs/agents/scripts/fp246/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Three finished two-day spot rises, back to back. The next coin-margined open is bought and sold three days later. One coin-margined leg. Funding cash is not added. The null is that three-day long on every day. The screen is `docs/agents/backtests/fp246/screen_2023.json`. The pre-registration is `docs/agents/reviews/2026-09-25-fp246-prereg-trip.md`. |
| `docs/agents/scripts/fp247/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Two finished five-day coin-margined declines, back to back. The next USDT open is bought and sold eighteen days later. One USDT-perpetual leg. Funding cash is not added. The null is that eighteen-day long on every day. The screen is `docs/agents/backtests/fp247/screen_2023.json`. The pre-registration is `docs/agents/reviews/2026-09-25-fp247-prereg-cfal.md`. |
