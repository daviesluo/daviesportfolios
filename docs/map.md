...
| `docs/agents/scripts/fp8/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Exchange outflow, hash-rate drops, and quarterly-futures backwardation. The fill is fp5's. |
