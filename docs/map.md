...
| `docs/agents/scripts/fp209/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Spot and the USDT perpetual disagree on close over that session's average, and the gap widened: next session, long the lower score and short the higher. Funding cash is not added. |
| `docs/agents/scripts/fp210/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT close/open and the coin-margined close/open differ, and the gap widened: next session, long the lower return and short the higher. Funding cash is not added. |
| `docs/agents/scripts/fp211/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT and coin-margined 16:00 funding rates differ, and the gap widened: next open to the following open, long the lower rate and short the higher. Funding cash is not added. |
| `docs/agents/scripts/fp212/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The front coin-margined quarterly close/open finished above the perpetual's: next session, long the perpetual and short that quarterly. Funding cash is not added. |
| `docs/agents/scripts/fp213/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT and coin-margined 16:00 funding changes have opposite signs: next session, long the book whose rate fell and short the book whose rate rose. Funding cash is not added. |
| `docs/agents/scripts/fp214/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Spot's residual to the mark and the USDT residual have opposite signs: next close to the following close, long the more negative residual and short the more positive. Funding cash is not added. |
| `docs/agents/scripts/fp215/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | The USDT close and the coin-margined close differ, and the gap widened: next close to the following close, long the lower close and short the higher. Funding cash is not added. |
| `docs/agents/scripts/fp216/common.py`, `pin_test.py`, `fetch.py`, `measure.py` | Spot's residual to the mark and the coin-margined residual have opposite signs: next session, long the more negative residual and short the more positive. Funding cash is not added. |
