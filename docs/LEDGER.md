...
**fp217–fp224 are protocols only. No return of these rules has been computed.** fp209–fp216 were recorded and none passed. Every gross was positive and every mean was negative. Each trade was long one contract and short another. Same-day two-leg mean reversion stops here. These eight are single-leg holds, and none is a one-day or overnight long or short. Counts taken before the freeze, with no profit computed: MONX 52, MTH 84, XEXP 112, BRD 81, SMO 204, FRI7 51, FWK 135, CMS 171. The count stays 30. No rule was scored. No pull request. Main was not pushed.
