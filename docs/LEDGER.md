...
**fp305–fp312 are frozen. No return of these rules has been computed.** Eight public fair values, one side each. Coinbase and Deribit are not reused. A book ticker is not read. The fill is that contract's own daily open. Fair value is not a Binance line. Counts with no profit computed: BSTCH 174/183, BFXRH 163/191, MEXCH 157/193, OKXCH 176/176, GATCH 178/180, KUCCH 170/176, HTXCH 171/185, WBTCH 168/182. The coin-margined book is missing 2023-08-28 through 2023-08-31. Those days are not filled in. HTX candles start at 16:00 UTC. The screen count stays 30. A mean that clears the edge-off trade by 20 bps or less is not taken out of sample. No testing row is added. The next eight are not frozen. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.351. No pull request. Main was not pushed.
