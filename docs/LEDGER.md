...
**fp332–fp334 are scored. PEPRM is negative and is not taken out of sample. SPQTR and FDCSH clear by more than 20 bps and are pre-registered. Their later years are not computed yet.** The protocol was `60b1b33`, pushed before any of these returns. Each screen was written twice and the copies matched. The result is the discount change, or the funding cash, not the coin's open-to-open move. SPQTR 125 / file gross +133.2947 / file mean +93.2947 / null +9.2826 / +$116.6183 (`d137286d…`). Median entry basis +130.5214 bp, median exit −1.0325 bp. The gap is 84.0121 bps. PEPRM 48 / file gross +9.153 / file mean −30.847 / null −28.058 / −$14.8065 (`93512407…`). Median signal +69.9624 bp, median entry premium −15.558 bp, median exit −11.5694 bp. It sits 2.789 bp under its null. FDCSH 85 / file gross +128.5634 / file mean +88.5634 / null −36.9061 / +$75.2789 (`42030f61…`). Median cash +105.9454 bp, exit 0. The gap is 125.4695 bps. The scored counts match the freeze: 125/240, 48/191, 85/815 on 36 days. The counted failures were not used to fill eight. Pre-registrations `docs/agents/reviews/2026-09-25-fp332-prereg-spqtr.md` (`be28a67e…`) and `docs/agents/reviews/2026-09-25-fp334-prereg-fdcsh.md` (`883f3de6…`). No later-year return has been computed. No testing row. Reference §3.390. No pull request. Main was not pushed.
