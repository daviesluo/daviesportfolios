...
**fp225–fp232 are scored. CMF and QNEW pass the 2023 screen and are not testing rows. The other six fail. MTH is void.** The protocol was `ec08ec7`, pushed before any of these returns. Two runs of each screen matched. QFAR 56 trades, +$120.9954, mean under its null. PBK 72 trades, +$214.761, mean under its null. CFD 223 trades, −$359.582, mean negative and under its null. UFL 122 trades, +$59.1019, mean under its null. SLD 177 trades, −$710.8227, mean negative and under its null. CMF 96 trades, +$471.5815, mean +491.2307 bps against a null of +480.976 bps. QNEW 40 trades, +$304.5022, mean +761.2554 bps against a null of +599.9328 bps. UMFD 206 trades, −$361.5356, mean negative and above its null. Each position is one leg. The later years are not scored. MTH stays void (`dde12644`). The count stays 30. No pull request. Main was not pushed.
