...
**fp54–fp61 screens are scored. VOL-CLOCK and BASE-CHG passed 2023. Their later years are not pulled.** Protocol was `68b331f`. The one-element field tuples were fixed in `96b48c5` before any pull. Each file was scored twice and the two copies matched. VOL-CLOCK 38 / +66.65 / null +65.90 / +$25.33 (`b3b2686d…`), screen pass. BOUNCE 40 / +0.07 / +67.59 / +$0.03 (`9f3afa15…`). CLOSE-HIGHS 28 / +54.86 / +84.17 / +$15.36 (`0c2613ce…`). BASE-CHG 44 / +65.20 / +63.98 / +$28.69 (`faa31420…`), screen pass. LAST-EXT 19 / −33.27 / file null +90.987 / −$6.32 (`9cbc5fb5…`). STEP-BASE 30 / +62.48 / +75.19 / +$18.74 (`1d11c890…`). OPEN-YLOW 41 / +5.82 / +70.16 / +$2.39 (`02e1a3d5…`). LAST-HOUR 43 / +58.92 / +66.23 / +$25.33 (`2e03db8d…`). VOL-CLOCK's pre-registration is `d0083afe…` and BASE-CHG's is `1b455c48…`, both frozen at 2026-09-25T04:06:10Z, bid 84178.00000000, ask 84178.01000000, half-spread 5.9397938896041255e-08. No hourly quote and no base volume from 2024 onward has been read. The 2024-01-01 open already in the screen files is an exit print. BASE-CHG stores that bar's base volume as 0. Score both through 2026-09-24 only after this commit is on the remote. The six failures stay recorded. Do not score a neighbour of a failed screen. Do not flip a sign. Do not lower the count of 30. Do not shrink the window. fp46–fp53 stay dead (§3.75–§3.82), including AVG-CHG and its positive 95th. IMPACT, PEAK, BAL-CHG, BODY and fp30–fp45 stay closed. No testing row. No pull request. No push to main.
