...
The queue was written into `pass79_*_rule.txt` and hashed at 2026-09-25 23:57:45 UTC, before any print in the score stretch was joined to a P&L. After a signal sell, and only while flat, the bid is the signal price minus one quote step. The signal print is not the fill. The fill is the first later aggressor sell at or under that bid. A sell at the signal price does not fill. A buy before that sell cancels the bid and is not a trip. A bid still working at the end is `left_working` and is not a trip. The ask is the fill price plus one quote step. The exit is the first later aggressor buy at or above that ask. A long with no exit is marked to the last print and counted. Maker fee stays 0%. Stress is `(exit print - step) / (entry print + step) - 1`, in bps. A doubled maker fee of 0 is not the stress. A fraction of the print quantity is not this score. The tapes, the cutoff day, and the quote steps are the pass 78 files. The predicates were not refit after this score.

Hashes: `rxbounce` 0cc9f9ce559acaf300a8345d661eb2dbac4143949a73c8eead3b8a47eaa89fc1, `rxadverse` e513edd57d7ee994ae96346e8156a1f884cdfcd95708e5bdc576b7f533cba027, `rximpact` 8c21dfc5ab2817a6223efa88f6801a64fa5f4e2ee8f9dc645bf5ff5b73d43c9c, `rxround` 83575d8f2acea4eb1f96b1ffd569fbff90437867202d6dd4f16a4729cdb764a4, `rxgap` a7e2c3c7baaecf70f0956d7f067522bf519da4e331d4cf04334298ab5f42bc5c, `rxlag` 6d131a5dab3cd7271b7101671ff89c5f82158e4034f56ce9eba7d0f85c2a5937, `rxmonday` 4ec36944b527ca4374b1300babc68eb002a3b6e5af49143e3c713638f6b2b032, `rxquiet` 49897e6bfb938bc8499420674cda8271d4c3110a2cb0610355ce908bc6a50053.

`rxbounce`. Signal: a sell whose previous print is a buy. Lesser trips 76. Pool 1682.6276712516. Stress 1627.4172392281, which is 55.2104320235 bp under the pool. Null p95 832.0627464916. Edge-off, the same queue after every sell, 1687.4610546575. The filter is 4.8333834059 bp under that control. BTC prints 78098, sells 38969, signals 11616, acted 1296, fills 353, cancels 943, exits 352, marks 1, 2385.6716703451 bp. XRP signals 6543, acted 220, fills 76, cancels 144, exits 75, marks 1, 979.5836721581 bp. August is 0.6840151605 of the pool. The month gate fails. The first BTC fill is not the 00:34:51.769 signal. It is 2026-06-17 00:35:42.958 UTC at 65721.42, exit 00:41:16.420 UTC at 65764.74, which is 6.5914583099 bp, and 6.5884141596 bp after one 0.01 step each way. The unfiltered queue on BTC is 354 trips and on XRP 77. Bounce is 353 and 76. The pool sits next to the control because nearly every queued fill was a sell after a buy, not because every sell was booked as a fill.

`rxadverse`. Signal: a sell whose previous print is a sell. Lesser trips 66. Pool 1824.4292799338. Stress 1776.5875945617. Null p95 1001.9137516258. BTC acted 1067, fills 372, cancels 695, 2602.3984632782 bp. XRP acted 164, fills 66, cancels 98, 1046.4600965893 bp. August is 0.8491373658. The month gate fails.

`rximpact`. Signal: a sell at or above the cutoff day's own sell-quantity 95th percentile. Not a 15-minute candle. Lesser trips 85. Pool 2095.1065023864. Stress 2022.6205578031. BTC fills 356 against an every-sell queue of 354. XRP fills 85 against 77. The lesser count is longer than the unfiltered queue, so the null is undefined and the null gate fails. That comparison was written before the score. August is 0.5491085854. BTC 3017.9977012469 bp over 356. XRP 1172.215303526 bp over 85.

`rxround`. Signal: a sell on a 100-step price. Lesser trips 45. Pool 1584.8929541374. Stress 1553.1444695691. Null p95 720.6083960072. BTC 1461.7407975057 bp over 199. XRP 1708.0451107691 bp over 45. August is 0.7135962444. The trip count is under 60 and the month gate fails. The first XRP fill is 2026-06-17 01:28:50.361 UTC at 1.2094, exit 01:28:55.939 UTC at 1.2102, which is 6.614850339 bp, and 4.9607275734 bp after one 0.0001 step each way.

`rxgap`. Signal: a sell at least 10 bp under the previous print. The 10 bp was fixed. Lesser trips 56. Pool 1539.7388794169. Stress 1498.0456078412. Null p95 866.972152643. BTC 2428.6636192662 bp over 265. XRP 650.8141395676 bp over 56. August is 0.4543966492. The trip count is under 60 and the month gate fails.

`rxlag`. Signal: a follower sell inside 60000 ms after a BTC aggressor buy strictly more than 1 bp above the previous BTC print. Books ETH-USD and SOL-USD. Lesser trips 173. Pool 3135.3339041161. Stress 3105.2076384396. Null p95 2690.4691144188. Edge-off 4484.3191657985. ETH acted 774, fills 263, cancels 511, marks 0, 3664.6636871482 bp. SOL acted 518, fills 173, cancels 345, marks 1, 2606.004121084 bp. August is 0.4503442293. The month gate fails. The first SOL fill is 2026-06-17 11:03:40.141 UTC at 71.823, exit 11:21:18.014 UTC at 71.991, which is 23.3908358047 bp, and 23.1120516819 bp after one 0.001 step each way.

`rxmonday`. Signal: a Monday UTC sell. XRP is the book the 2019 paper said does not have the effect. Lesser trips 130. Pool 1927.5054782231. Stress 1830.3892777804. XRP fills 130 against an every-sell queue of 77, so the null is undefined and the null gate fails. September is 0.4580033345. BTC 1574.3016514108 bp over 185. XRP 2280.7093050354 bp over 130.

`rxquiet`. Signal: a sell after a silence at least as long as the cutoff day's own 95th percentile gap. Not a weekend flag. Lesser trips 37. Pool 1480.8558160515. Stress 1453.734826879. Null p95 630.9544204783. BTC acted 1049, fills 304, cancels 744, left_working 1, 2090.2716341724 bp. XRP acted 93, fills 37, cancels 56, 871.4399979305 bp. September is 0.4329073227. The trip count is under 60 and the month gate fails.

The pool is the equal-weight average of the two books' summed base bps. The null draws the lesser count from each book's unfiltered queued moves, 500 draws, seed 20260925, index 474, and it is compared with the base pool. A count of 0 would have been scored as 0. None of the eight is 0. No rule cleared every gate. A numeric clear would still not be a testing row, and there is not one. No order of this account was shown crossing the book. The record is `summary_pass79.json`. Branch `cursor/revolut-x-search-d133`.

### [2026-09-25 23:48 UTC] Platform: Cursor | Model: Grok 4.7
**Eight print-level mechanisms were scored. None cleared every gate.** No order, no new row, no edit to PR5, `trend-4h` or `pmrw.ts`, and this was not pushed to `main`. The 21:32 line that pass 78 stays unopened is the state at that clock. This round opened pass 78. `rxpar` is not recomputed. An hourly close is not a fill. A four-hour close is not a fill. The public fill is `GET /api/1.0/public/trades/all?region=UK`. The maker fee is 0%. Doubling it is 0, so stress equals the pool. The 0.09% taker schedule and the old 20 bp taker charge are not put on a resting fill. The archive is `https://web.archive.org/web/20250813002900/https://www.revolut.com/legal/crypto-exchange-fees/`, read 2026-09-25; the live page returned 403. `reached_preregistration` stays false. No testing row is opened. The five earlier numeric clears and the confirmation-time fall after a higher day stay void. The pass 67 result of +263.2 bps over 17 trips stays not close to a pass.

The pair list was read again with the trade route, not only the ticker. `census_pass78.py` requested one UK page for each of the 455 active pairs on 2026-09-24, start 1790208000000 end 1790294399999, finished 2026-09-25 22:37:46 UTC. Every request returned HTTP 200. 341 pairs returned 100 prints and a further cursor. 48 returned a shorter page. 66 returned an empty page: all 61 EUR pairs, plus DOLO-USD, FLUID-USD, PUMP-USD, SOMI-USD and SYND-USD. USD full pages 263, GBP 58, USDC 20. BTC-USD, ETH-USD, SOL-USD and XRP-USD were full pages. A year earlier, 2025-09-17 was pulled in full: BTC-USD 5450, ETH-USD 6306, SOL-USD 3079, XRP-USD 2902. That day is not the cutoff and not the score.

The cutoff day is 2026-06-16, start 1781568000000 end 1781654399999, and it is not inside the score. BTC-USD 930 prints, ETH-USD 332, SOL-USD 254, XRP-USD 295. Sell-quantity 95th percentile, nearest rank: BTC-USD 0.07521000, XRP-USD 5080.256020. Inter-print 95th percentile: BTC-USD 322180 ms, XRP-USD 1072376 ms. Lag window is the follower's lower median gap clamped to 1000–60000 ms: ETH-USD 60000, SOL-USD 60000. Round unit is 100 quote steps. The pairs route was read 2026-09-25: BTC-USD quote step 0.01 so the unit is 1.00, XRP-USD quote step 0.0001 so the unit is 0.0100. The score stretch is 2026-06-17 00:00:00.000 UTC through 2026-09-24 23:59:59.999 UTC, start 1781654400000 end 1790294399999. BTC-USD 78098 prints, ETH-USD 39035, SOL-USD 43569, XRP-USD 40107. The eight rule texts were hashed at 2026-09-25 22:40:17 UTC, before any of those score prints was joined to a P&L.

Entry is an aggressor sell. We were the resting bid, filled at that print. Exit is the next aggressor buy on the same book. We were the resting ask. One position at a time. A buy that never reaches an exit is marked to the last print and counted. Both leftover marks on the bounce rule, and the one on the quiet rule, are the last print marked to itself, so each is 0 bp. They are inside the trip count.

`rxbounce`, bid-ask bounce, Roll 1984 and the Bitcoin trade-to-trade autocorrelation. A sell whose previous print is a buy. Lesser trips 6543. Pool 11977.7346858786. Stress 11977.7346858786. Null p95 11732.4696454611. Edge-off 11975.0922478183. BTC 3550.470339439 over 11616 trips, XRP 20404.9990323183 over 6543. August is 0.4643167899 of the pool. June 0.0203989567, July 0.1559693157, September 0.3593149377. The month gate fails. The first BTC trip is 2026-06-17 00:34:51.769 UTC at 65751.38, exit 00:41:16.420 UTC at 65764.74, which is 2.0318965168 bp.

`rxadverse`, a sell after a sell. Lesser trips 3345. Pool 4606.5873012208. Null p95 6679.6207536068. BTC 48.6708244671 over 6294, XRP 9164.5037779745 over 3345. August is 0.6399041158. Fails the null and the month.

`rximpact`, a sell at or above the cutoff day's own sell-quantity 95th percentile. Not a 15-minute candle. Lesser trips 750. Pool 1419.3405995661. Null p95 1991.8714319194. BTC 1128.365307098 over 1387, XRP 1710.3158920343 over 750. August is 0.7088508126. Fails the null and the month.

`rxround`, a sell on a 100-step price. Lesser trips 958. Pool −645.4761731674. Stress equals that pool. BTC −1958.7603479824 over 1776, XRP 667.8080016475 over 958. The pool is not positive, so the stressed pool is not positive either. The doubled maker fee is still 0. One book is not positive. The null p95 is 2378.3481901303. The month share is empty because the pool is not positive. Fails the 400 bp gate as well.

`rxgap`, a sell at least 10 bp under the previous print. The 10 bp was fixed. Lesser trips 1594. Pool 3606.3154285819. Stress 3606.3154285819. Null p95 3635.4806286936. BTC 111.8469235737 over 1594, XRP 7100.7839335902 over 3056. September is 0.3836841234. The only failed gate is the null.

`rxlag`, a follower sell inside 60000 ms after a BTC aggressor buy strictly more than 1 bp above the previous BTC print. Books ETH-USD and SOL-USD. Lesser trips 1173. Pool 1620.3888932102. Null p95 2066.0946481213. Edge-off 6764.7198545726. ETH 3171.471224539 over 1320, SOL 69.3065618814 over 1173. August is 0.634025847. Fails the null and the month.

`rxmonday`, a Monday UTC sell. XRP is the book the 2019 paper said does not have the effect. Lesser trips 955. Pool 1809.5212604353. Null p95 2412.0844296374. BTC 500.4475692173 over 1773, XRP 3118.5949516532 over 955. August is 0.5589602052. Fails the null and the month.

`rxquiet`, a sell after a silence at least as long as the cutoff day's own 95th percentile gap. Not a weekend flag. Lesser trips 532. Pool 1247.9011486285. Null p95 1516.5782338553. BTC 582.5273823678 over 2202, XRP 1913.2749148892 over 532. August is 0.4100312623. Fails the null and the month.

The pool sums every trip on both books and divides by two. The null draws the lesser count from each book's unfiltered sell-to-next-buy population, 500 draws, seed 20260925, index 474. On the bounce rule the longer book has 11616 trips and the null draws 6543 of them. That is the same construction as pass 76. It was not changed after this score. No rule cleared every gate. A numeric clear would still not be a testing row, and there is not one. No order of this account was shown crossing the book. Branch `cursor/revolut-x-search-d133`.
...
The fee page `https://www.revolut.com/legal/crypto-exchange-fees/` returned 403 on 2026-09-25. The latest archive capture is `https://web.archive.org/web/20250813002900/https://www.revolut.com/legal/crypto-exchange-fees/`, timestamp 20250813002900. The table says Maker fee 0% and Taker fee 0.09%. Reference §2 records the schedule as flat, with no tiers, so this account pays 0% to rest. Doubling 0% is 0. Stress equals the pool. That is not a cut from 20 bp to 9 bp.

The pair list, `GET https://revx.revolut.com/api/1.0/public/configuration/pairs`, was read 2026-09-25 21:00 UTC. 455 pairs are active: 307 quoted in USD, 64 in GBP, 61 in EUR, and 23 in USDC. `BTC-EUR` with `region=UK` returned 400, so EUR is not this account's book. UK tickers were read the same hour. USDC-USD bid 1.0000, ask 1.0001. USDT-USD bid 0.9998, ask 1.0002. FIL-USD last 1.0374 is not a published one-dollar redemption. PAXG-USD last 4284.11 and XAUT-USD last 4288.33 are an ounce of gold, which is the backing sentence, and they were not opened. MSOL-USD last 169.401 against SOL-USD last 121.197 is one staking book, and the dollar level moves with SOL, so it was not opened. A sterling stable against an official pound would be this par with the quote currency changed, and it was not opened. Copying the bid onto another coin was not opened. Seven slots stayed shut. A zero-trip variant was not used to fill them.

One rule was hashed at 2026-09-25 21:12:21 UTC, before any hour close was joined to a P&L. `rxpar` is `cef434cc494f4866de969211c52646c56e3c61328f8bd3d64412b0735b6a8d48`. The record is `docs/agents/backtests/fp5/summary_pass76.json`. Who is wrong: the seller of UK USDC-USD or USDT-USD through 0.9999. That is one quote step of 0.0001 below the published 1.0000. USDC and USDT are the two books of this one rule. The bid rests at 0.9999. A fill is a later hour whose volume is strictly above zero and whose close is at or below 0.9999. The fill price is 0.9999. The exit rests at 1.0000 and fills on a later traded close at or above 1.0000. One dollar is still the redemption. High and low are not fills. A zero-volume hour is not a fill. The tape is `GET https://revx.revolut.com/api/1.0/public/candles/{SYM}?interval=60&region=UK`, pulled 2026-09-25 21:11:28 UTC through 21:11:56 UTC. USDC-USD is 8,758 hours, 2025-09-25 00:00 UTC through 2026-09-25 21:00 UTC, 3,809 with volume. USDT-USD is 8,772 hours and 5,541 with volume. Absent hours are not filled.

USDC completed 525 trips. USDT completed 454. The lesser count is 454. The 60-trip gate is not lowered to 454, and 454 still clears it. Each trip is 1.0000 / 0.9999, which is +1.00010001 bp, and the fee is 0. The pool is 489.5489548955 bp. Stress is 489.5489548955. USDC is 525.0525052505 and USDT is 454.0454045405. April 2026 is 152 of 979 half-trips, share 0.1552604699. The null's p95 is 184.3696213435. The pool beats it. The edge-off sum of every next traded hour is 18.6693389296. The first USDC entry is 2025-11-26 21:00 UTC, millisecond 1764190800000, close 0.9994, volume 1570.11889. The 23:00 bar, millisecond 1764198000000, closed 1.0003 on volume 0 and is not the exit. The exit is 2025-11-27 00:00 UTC, millisecond 1764201600000, close 1.0003, volume 10.06604. Hand: 1.0000 divided by 0.9999 is +1.00010001 bp. The first USDT entry is 2025-12-16 16:00 UTC, millisecond 1765900800000, close 0.9996, volume 451.87464. The next hour closed 1.0007 on volume 527.99055. The same one tick.

The numeric gates clear. `reached_preregistration` stays false. No sign is flipped. No testing row is opened. A numeric clear on these closes is not paper testing, because no order of this account was shown crossing the book. This is one scored rule, not eight. Pass 77 is not opened. Branch `cursor/revolut-x-search-d133`.

### [2026-09-25 20:53 UTC] Platform: Cursor | Model: Grok 4.7

**No external published price was hashed. Eight rules were not opened.** No order, no new row, no edit to PR5, `trend-4h` or `pmrw.ts`, and this was not pushed to `main`. The 20:44 line that pass 75 was not opened is the state at that clock. This round opened pass 75 and closed it without a hash. Pass 74's three triangles stay scored at zero trips. They are not rerun. The fill is not switched to a zero-volume mid. The 20 bp taker charge is not cut to the published 9 bp. The same-minute requirement is not widened. A different causal was required: a published series other than a price this account can trade, a fill that is a real UK print, and a sentence that names who is wrong on which price, which book and which level this account hits, that the level is still there at the exit, and the bps left after the fee. A sentence that cannot be written is not run. A zero-trade count is not used to fill an empty slot. The banned sentences stay banned: a triangle with the quote currency changed, a four-hour forward, a company cost, a macro number, a funding percent, another venue's last trade, and the UK book's own shape. The 60-trip gate, both books, 40% of any month, doubled cost, the random null, and 400 bps were not loosened. The five earlier numeric clears and the confirmation-time fall after a higher day stay void. The pass 67 result of +263.2 bps over 17 trips stays not close to a pass.

The CME CF Bitcoin Reference Rate, `https://www.cfbenchmarks.com/data/indices/BRR`, read 2026-09-25 20:51 UTC, was 83,671.72, last updated Fri, 25 Sep 2026 15:00:00 GMT. The methodology guide, `https://www.cmegroup.com/trading/files/bitcoin-reference-rate-methodology.pdf`, builds that rate from constituent-exchange trades in the hour to 4:00 p.m. London and disseminates it between 4:00 and 4:30 p.m. London. That is an average of other venues' last trades. It is not a new causal. The UK book, `GET https://revx.revolut.com/api/1.0/public/candles/BTC-USD?interval=1&region=UK`, read 20:51 UTC, has no volume at 15:00 UTC, so that print is a mid and is not a fill. The first trade is 15:03 UTC at 83,880.8. The fixing is 24.9 bp below that trade, so the UK ask is not the cheap side. The 17:00 UTC trade is 83,744.37, a move of -16.3 bp. After 40 bp that remainder is -56.3. At 17:00 the same fixing is still 8.7 bp below the UK trade. The fixing did not update. That is a stale print, and this account cannot sell it. The Ether reference rate, `https://www.cfbenchmarks.com/data/indices/ETHUSD_RR`, was 2,687.71 at the same 15:00:00 GMT stamp. The first UK ETH trade, 15:03 UTC, is 2,693.49. The rate is 21.5 bp below that trade. The 17:00 trade is 2,684.21, a move of -34.5 bp, and after 40 bp the remainder is -74.5. New York and Asia-Pacific variants are the same sentence. They were not opened.

The CME CF Bitcoin Real Time Index, `https://www.cfbenchmarks.com/data/indices/BRTI`, was 83,964.82, last updated Fri, 25 Sep 2026 20:50:42 GMT. It is the same constituent exchanges' books, once each 200 milliseconds, not a last trade and not a second rule. The UK book, `GET https://revx.revolut.com/api/2.0/public/order-book/BTC-USD?region=UK&limit=1`, at 20:51:05 GMT, metadata timestamp 1790369465949, was bid 83,956.00 and ask 83,967.71. Buying the ask against the index is -0.344 bp. After 40 bp the remainder is -40.3. The bid is 1.05 bp under the index, so hitting it sells the cheap side. The Ether real-time index, `https://www.cfbenchmarks.com/data/indices/ETHUSD_RTI`, was 2,687.95 at 20:52:00 GMT. The UK ETH ask at 20:51:06 GMT was 2,687.65, which is +1.12 bp cheap. After 40 bp the remainder is -38.9. The bid was 2,687.37. Both asks are not cheap by more than the fee, and the index is not a level on this account. Nasdaq's real-time reference price is named on the same site as another company's copy of that sentence. It was not opened.

Coin Metrics `ReferenceRateUSD`, `https://community-api.coinmetrics.io/v4/timeseries/asset-metrics`, answered 200 at 20:51 UTC. BTC is 84,386.58 and ETH is 2,689.17, both stamped 2026-09-25T00:00:00.000000000Z. Against the 20:51 UK ask the midnight BTC rate is +49.9 bp. That gap is the coin's move since midnight. It is not a level that is still there, and the rate is still an aggregate of market trades. Pyth, `https://hermes.pyth.network/v2/updates/price/latest`, returned 401 at 20:51:06 UTC. The historical benchmark requires a key after 2026-08-26, `https://docs.pyth.network/price-feeds/core/use-historical-price-data`. No bps were written. Yahoo Finance chart returned 429 at 20:51 UTC and was not used. A futures chart would have been the four-hour forward. An ETF price divided by coins would have been the company cost. The CF Bitcoin volatility index is a vol point, not dollars per coin, so the bps on the UK ask cannot be written. No rule text was hashed. No screen was written. No summary was written. `reached_preregistration` stays false. No sign is flipped. No testing row is opened. A numeric clear on a UK print would still not be paper testing, because no order of this account was shown crossing the book. Pass 76 is not opened. Branch `cursor/revolut-x-search-d133`.

### [2026-09-25 20:44 UTC] Platform: Cursor | Model: Grok 4.7

**Three same-minute UK triangles scored zero trips. The four-hour exit is unchanged as a conclusion and is not the fill.** No order, no new row, no edit to PR5, `trend-4h` or `pmrw.ts`, and this was not pushed to `main`. The 20:18 line that pass 74 was not opened is the state at that clock. This round opened pass 74. At the next UK four-hour open the same-bar cross is still about +1.5 bp and does not pay 40 bp. The previous bar's open is not the fair value. The exit is the same minute: hit one book's close and the other book's close together, then turn the proceeds back into dollars. It is not the next UK four-hour open. Pass 72's six forwards are not rerun. Pass 71's inventory cost and equity cap, pass 70's macro change, funding percent, and volatility points, pass 69's other-venue last trade, and pass 68's own UK opens stay banned. Passes 62 through 67 stay banned. EUR is not this account's book. There is no BTC/USDT or ETH/USDT. There is no GBP-USD book. Kraken is not a leg. The charge is 20 bps on each taker order. The 9 bp schedule is not used. Stress is 40 bps on each order. The 60-trip gate, both books, 40% of any month, doubled cost, the random null, and 400 bps were not loosened. A count below 60 is scored. A zero count is scored as zero. The five earlier numeric clears and the confirmation-time fall after a higher day stay void. The pass 67 result of +263.2 bps over 17 trips stays not close to a pass.

Three rules were hashed at 2026-09-25 20:36:22 UTC, before any minute close was joined to a P&L. `rxusdc` is `d6f59a0d3ae5c06ddb0cfacb72bcd2ca231a13d974e86913c4259288cc5ea689`. `rxgbp` is `132bdf3a9336bcab7d58be25cced574719d344a352333d14f94744f6cf8d22c7`. `rxsgbp` is `15eff7020b2435febef76fc284ccda36aa2b787cf784646fff5ba3dda5a583aa`. The record is `docs/agents/backtests/fp5/summary_pass74.json`. The tape is one-minute closes, `GET https://revx.revolut.com/api/1.0/public/candles/{SYM}?interval=1&region=UK`, pulled 2026-09-25 20:24:52 UTC through 20:34:26 UTC. Each file is start, close, and volume, 41,543 rows, 2026-08-28 00:00 UTC through 2026-09-25 20:24 UTC. 2026-09-03 06:40 UTC and 06:41 UTC are absent on every book and are not filled. A minute counts only when every leg has volume strictly above zero. Traded minutes are BTC-USD 10,370, ETH-USD 7,855, BTC-USDC 375, ETH-USDC 170, USDC-USD 810, BTC-GBP 16,487, ETH-GBP 10,715, and USDC-GBP 1,247. A zero-volume minute is the vendor's mid and is not a fill. The public tape does not store the historical bid or ask. The fill is that minute's close, the last trade. Two closes in one minute can be up to sixty seconds apart. A positive close-cross is not a print that the resting bid was hittable. The live touch on 2026-09-25 20:14 UTC was about -7 bp before fees.

`rxusdc` buys the USD book and sells the USDC book, or the reverse, and trades USDC-USD. Three taker orders, 60 bps, stress 120. Dollars from selling the USDC book are the USDC close times the USDC-USD close. Dollars paid are the USD close. Both coins must clear. Eligible minutes are 3. Trips are 0. One ETH minute cleared the fee and BTC on that minute did not, so it is not a trip. The 60-trip gate is not lowered to 0 or to 1. The largest gross that both coins cleared together is 47.1 bp, under 60. The pool is 0.0. Stress is 0.0. BTC is 0.0 and ETH is 0.0. The null's p95 is 0.0. The pool does not beat it. The edge-off sum of the three minutes is -89.5. Sitting above that negative sum is not a pass. The first eligible minute is 2026-09-04 12:30 UTC, millisecond 1788525000000. BTC-USD 80,190.71, BTC-USDC 80,560.07, ETH-USD 2,479.39, ETH-USDC 2,495.52, USDC-USD 1.0001. Both coins buy the USD book and sell the USDC book. Hand: 80,560.07 times 1.0001 divided by 80,190.71 is +47.0648 bp, net -12.9352. ETH is +66.0628 bp, net +6.0628. The other two minutes, 2026-09-09 19:50 UTC and 2026-09-10 12:47 UTC, pool -33.3430 and -52.6947. The three pools sum to -89.4739.

`rxgbp` buys the USD book and sells the sterling book, or the reverse. Sterling becomes dollars through USDC-USD and USDC-GBP. Four taker orders, 80 bps, stress 160. Eligible minutes are 4. Trips are 0. One-sided clears are 0. The largest joint gross is 26.6 bp, under 80. The pool is 0.0. Stress is 0.0. The null's p95 is 0.0. The edge-off sum is -281.0. The first eligible minute is 2026-08-30 23:17 UTC, millisecond 1788131820000. BTC buys sterling and sells USD, gross +0.4857 bp, net -79.5143. ETH buys USD and sells sterling, gross +5.7640 bp, net -74.2360. The four minute pools are -76.8751, -52.6587, -75.8131, and -75.6619, summing to -281.0088.

`rxsgbp` buys the USDC coin book and sells the sterling coin book, or the reverse, starting and ending in dollars. The USD coin book is not one of the two coin books. Five taker orders, 100 bps, stress 200. The two USDC-USD orders use one close, so their prices cancel and their fees do not. Eligible minutes are 1. Trips are 0. The joint gross is 18.9 bp, under 100. The pool is 0.0. Stress is 0.0. The null's p95 is 0.0. The edge-off is -70.9. That minute is 2026-09-04 12:30 UTC. Both coins buy sterling and sell USDC. BTC gross +18.8858 bp, net -81.1142. ETH gross +39.4014 bp, net -60.5986. The pool is -70.8564.

The three fire sets are empty, so each Jaccard is zero trips over an empty union. No eligible minute had both coins strictly above the fee. `reached_preregistration` stays false. No sign is flipped. No testing row is opened. A numeric clear on these closes would still not be paper testing, because no order of this account was shown crossing the book. Pass 75 is not opened. Branch `cursor/revolut-x-search-d133`.

### [2026-09-25 20:18 UTC] Platform: Cursor | Model: Grok 4.7

**No USD price tradable at the next UK open was hashed. Eight rules were not opened. Pass 72's six do not count as a round.** No order, no new row, no edit to PR5, `trend-4h` or `pmrw.ts`, and this was not pushed to `main`. The 19:59 line that pass 73 was not opened is the state at that clock. This round opened the search under the new admission and closed it without a hash. The mispricing has to be cashable inside the four-hour hold. The exit is the next UK open, so the fair value has to be a USD-per-coin price this account can already trade at that exit. A fixing one year out, an option expiry, and a future this account cannot sell are gaps the next open does not earn. The settled-funding forward, the front Friday synthetic, the Treasury implied spot, the funding implied spot, the straddle median, and the year-end median are not rerun. An index coat, another expiry, and a third financing rate are not rerun. Pass 71's inventory cost and equity cap, pass 70's macro change, funding percent, and volatility points, pass 69's other-venue last trade, and pass 68's own UK opens stay banned. Passes 62 through 67 stay banned. The fill would still have been the printed Revolut X UK four-hour open to the next open, on BTC-USD and ETH-USD, `region=UK`. The 60-trip gate, both books, 40% of any month, doubled cost, and the random null were not loosened. The five earlier numeric clears and the confirmation-time fall after a higher day stay void. The pass 67 result of +263.2 bps over 17 trips stays not close to a pass. Pairs, `GET https://revx.revolut.com/api/1.0/public/configuration/pairs`, answered Fri, 25 Sep 2026 20:16:56 GMT. BTC and ETH list against USD, USDC, GBP, and EUR. USDC/USD, USDC/GBP, USDT/USD, and USDT/GBP list. BTC/USDT and ETH/USDT do not. EUR is not this account's book. Candles, `GET https://revx.revolut.com/api/1.0/public/candles/{SYM}?interval=240&region=UK`, were read 2026-09-25 20:11:16 UTC through 20:15:56 UTC. A window opening 2025-09-11 returned no bars for BTC-USD itself at 20:13:35 UTC, so that empty reply is the public retention, not a missing listing. A slice 340 days back, first bar 2025-10-21 00:00 UTC, returned bars for BTC-USD, BTC-USDC, USDC-USD, and BTC-GBP at 20:14:46 UTC through 20:14:51 UTC. The last 30 days returned 180 bars on each of BTC-USD, ETH-USD, BTC-USDC, ETH-USDC, USDC-USD, BTC-GBP, ETH-GBP, and USDC-GBP, from 2026-08-27 00:00 UTC through the bar that starts 2026-09-25 20:00 UTC. The order book, `GET https://revx.revolut.com/api/2.0/public/order-book/{SYM}?region=UK&limit=1`, was read 20:14:53 UTC through 20:15:03 UTC. BTC-USD bid 83,955.17, ask 83,967.92, metadata timestamp 1790367293474. BTC-USDC bid 83,909.15, ask 84,050.25, timestamp 1790367296735. USDC-USD bid 1.0000, ask 1.0001, timestamp 1790367300060. Selling the USDC bid and the USDC-USD bid converts to 83,909.15 dollars. Against the UK ask that is -7.00 bp. ETH-USDC bid 2,688.22 against the ETH-USD ask 2,690.13 is -7.10 bp. BTC-GBP bid 63,377.32 divided by the USDC-GBP ask 0.7551 and times the USDC-USD bid 1.0000 is 83,932.22 dollars, -4.24 bp against the same UK ask. The price this account can sell is below the price it pays. On the 180 aligned opens the same-bar USDC cross, other open times USDC-USD open, has BTC median +1.48 bp and maximum +13.59 bp, with 0 bars above 40 bp, and ETH median +0.77 bp and maximum +48.77 bp, with 1 bar above 40 bp. Both books above 40 bp on that cross is 0 bars. The GBP triangle's same-bar maximum is +21.45 bp on BTC and +27.62 bp on ETH, and neither has a bar above 40 bp. That same-millisecond open is not a legal entry print. The previous bar's open is four hours stale. At the next open the cross is back to a BTC median of +1.54 bp, 0 of 178 above 40 bp, and an ETH median of +0.77 bp, 1 of 178 above 40 bp. The stale gap is not still there, and the gap that is still there does not pay 40 bp. Selling the next UK open does not fill the other book's bid. Both books positive on the stale discount counted 73 of 178 and was not frozen. USDC and GBP are one sentence. USDT has no BTC or ETH book. Kraken `GET https://api.kraken.com/0/public/Spread?pair=XBTUSD`, read 20:15:04 UTC, returned 250 rows from 20:04:27 UTC to 20:14:42 UTC. The documented spread call keeps the latest top of book, `https://docs.kraken.com/api-reference/market-data/get-recent-spreads`. Depth `count=1`, read 20:15:07 UTC, is bid 83,959.40 and ask 83,959.50. That bid against the UK ask is -1.01 bp. The ETH pair is -1.08 bp. The books are not crossed. Kraken OHLC is a last trade. Tardis documents a free Kraken quotes file for the first day of each month, `https://docs.tardis.dev/historical-data-details/kraken`, not a continuous year, and that bid is not this exit. This turn did not re-read the private Kraken balance. No sentence could say that at the next UK open the gap is still there and this account can trade at that dollar price. No rule text was hashed. No screen was written. No summary was written. `reached_preregistration` stays false. No sign is flipped. No testing row is opened. A numeric clear on these UK opens would still not be paper testing, because no order of this account was shown crossing the book. Pass 74 is not opened. Branch `cursor/revolut-x-search-d133`.

### [2026-09-25 19:59 UTC] Platform: Cursor | Model: Grok 4.7

**Six USD-per-coin forwards missed the testing bar. Two slots were not opened.** No order, no new row, no edit to PR5, `trend-4h` or `pmrw.ts`, and this was not pushed to `main`. Pass 71 scored the inventory average and the equity cap per coin. Both pools were negative. Those two prices are not a round and they are not rerun. The 16:23 line that pass 72 was not opened is the state at that clock. This round opened pass 72 for published forwards. A rewrite of a banned sentence was not opened. Pass 70 is not a price edge. Pass 69's other-venue last trade and pass 68's own UK opens stay banned. Passes 62 through 67 stay banned. The fill is a printed Revolut X UK four-hour open to the next open, on BTC-USD and ETH-USD. `region=UK` is on every request. EEA candles are not read. No other pair is stood in. This is the same pull as pass 62. The UK open is the price paid. Fair value is USD per coin. `discount_bps = (fair_usd / uk_open - 1) * 10000`. Both books are bought only when both discounts are strictly positive. The edge-off control is that same long-both fill with the cheapness filter off. It is not an extra rule. The random null stays: 500 long-both draws from that rule's own window, seed 20260925, index 474. The 60-trip gate is not lowered. The five earlier numeric clears and the confirmation-time fall after a higher day stay void. The pass 67 result of +263.2 bps over 17 trips stays not close to a pass. Six rules were hashed at 2026-09-25 19:55:07 UTC, before their own results. The record is `docs/agents/backtests/fp5/summary_pass72.json`. Counts before any return were 927 of 2,261, 889 of 2,257, 753 of 2,261, 1,104 of 2,261, 660 of 1,360, and 802 of 1,233. No pair has Jaccard at or above 0.75. The settled-funding forward overlaps the pass 69 Coinbase hourly set of 904 at Jaccard 0.965. That one overlap is the required example. The rate's median is about 0.06 bp, so after 40 bp the coat cannot pay. The Treasury spot's containment inside that forward is 0.859. The funding spot against the Treasury spot is Jaccard 0.430. The straddle median against the synthetic is Jaccard 0.343. Fourteen of the 15 capitalization bars sit inside the year-end set, Jaccard 0.017. The funding forward, the Treasury spot, and the funding spot share the 2,261-bar window, so their edge-off line is the same long-both of every bar, -92,733.0 bps. Deribit funding history, URL `https://www.deribit.com/api/v2/public/get_funding_rate_history`. Deribit chart, URL `https://www.deribit.com/api/v2/public/get_tradingview_chart_data`. Treasury 3-month, URL `https://home.treasury.gov/resource-center/data-chart-center/interest-rates/daily-treasury-rates.csv`. Kalshi series, URL `https://api.elections.kalshi.com/trade-api/v2/series`, events KXBTCY-27JAN0100 and KXETHY-27JAN0100. The settled-funding forward is -41,303.9 bps over 927 trips, both books negative. Stress is -78,383.9. BTC is -40,514.6 and ETH is -42,093.1. The null's p95 is -33,973.1. The edge-off long is -92,733.0. The front Friday synthetic is -40,806.5 bps over 889 trips, both books negative. Stress is -76,366.5. BTC is -39,839.2 and ETH is -41,773.8. The null's p95 is -32,276.0. The edge-off long is -92,426.5. The Treasury implied spot is -34,540.1 bps over 753 trips, both books negative. Stress is -64,660.1. BTC is -33,396.8 and ETH is -35,683.5. The null's p95 is -27,004.3. The edge-off long is -92,733.0. The funding implied spot is -49,260.8 bps over 1,104 trips, both books negative. Stress is -93,420.8. BTC is -48,090.2 and ETH is -50,431.3. The null's p95 is -40,957.6. The edge-off long is -92,733.0. The straddle median is -26,936.9 bps over 660 trips, both books negative. Stress is -53,336.9. BTC is -26,785.7 and ETH is -27,088.1. The null's p95 is -25,774.0. The edge-off long is -59,722.3. The year-end median is -29,388.3 bps over 802 trips, both books negative. Stress is -61,468.3. BTC is -29,608.2 and ETH is -29,168.3. The null's p95 is -26,984.0. The edge-off long is -45,322.9. Every pool beats its edge-off long and does not beat its null. Every pool is negative. This is not close to a pass. On a trip the cost gap is 40 bps times the trip count. That charge is not lowered. Two slots were not opened. A company cost, equity divided by coins, a macro change, a funding percent, a volatility point, another last trade, the UK book's own shape, an index coat, a tenor or company twin, a third deflator, a fourth option functional, a second prediction-market date, the option-density mode, and the linear USDC future were not frozen. From the next round a rule is not opened unless the causal is written first. Pass 73 is not opened. No sign is flipped. No testing row is opened. A numeric clear on these UK opens would still not be paper testing, because no order of this account was shown crossing the book. Branch `cursor/revolut-x-search-d133`.

### [2026-09-25 16:23 UTC] Platform: Cursor | Model: Grok 4.7

**Pass 70 was not a price edge. Two USD-per-coin prices were scored and missed. Pass 72 is not opened.** No order, no new row, no edit to PR5, `trend-4h` or `pmrw.ts`, and this was not pushed to `main`. From this round on, the review is written before the next round is frozen. Pass 70's eight rules compared no UK open to a same-unit price. None could say how many bps cheaper the open was. Five are one sentence: the 10-year yield fell, the 10-year breakeven rose, the dollar index rose, CPI-U year-over-year rose, or the public-debt total rose, so buy both books. Breakeven is a yield, not a USD price. That is side selection, not a price edge, and it is not rerun. Two are one sentence: DVOL below its previous close, and DVOL below its 30-day median. Volatility points are not a price. The funding rule is a settled percent and a sign bet, not a USD price. Funding cash is not in the P&L. Pass 70's only control was a random long-both null. There was no price to turn off, so that null tested the timing of a direction bet. That control was contaminated by side selection. Pass 69's other-venue last trade and pass 68's own UK opens stay banned. Passes 62 through 67 stay banned. None of those is rerun as a new threshold or a new lag. The fill is a printed Revolut X UK four-hour open to the next open, on BTC-USD and ETH-USD. `region=UK` is on every request. EEA candles are not read. No other pair is stood in. This is the same pull as pass 62. The UK open is the price paid. Fair value is USD per coin. `discount_bps = (fair_usd / uk_open - 1) * 10000`. Both books are bought only when both discounts are strictly positive. The edge-off control is that same long-both fill with the cheapness filter off. It is not a ninth rule. The random null stays: 500 long-both draws from the 1,829-bar window, seed 20260925, index 474. The 60-trip gate is not lowered. The five earlier numeric clears and the confirmation-time fall after a higher day stay void. The pass 67 result of +263.2 bps over 17 trips stays not close to a pass. No rule here repeats a scored set. No pair has Jaccard at or above 0.75. Strategy Inc, CIK 0001050446, Form 8-K aggregate average purchase price, URL `https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001050446&type=8-K`, parsed 2026-09-25 16:04:11 UTC. `acceptanceDateTime` is the publication instant. Bitmine Immersion Technologies, CIK 0001829311, ETH cost line, URL `https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001829311&type=10-`. The cost column is thousands of USD. USD per ETH is that cost times 1000 divided by the ETH units. The fair-value column is not used. The second price is the common-equity cap per coin. Yahoo Finance MSTR and BMNR daily closes, fetched 2026-09-25 15:44:56 UTC, URLs `https://query1.finance.yahoo.com/v8/finance/chart/MSTR?interval=1d` and the BMNR twin. Class B is 19,640,250 and converts one for one. Two rules were hashed at 2026-09-25 16:19:22 UTC, before their own results. The record is `docs/agents/backtests/fp5/summary_pass71.json`. Counts before any return, out of 1,829 bars, indices 432 through 2260, were 964 and 15. The sets share no bar. Both books below the inventory cost is -36,091.9 bps over 964 trips, both books negative. Stress is -74,651.9. BTC is -37,184.2 and ETH is -34,999.7. The null's p95 is -34,108.1. The edge-off long is -72,048.4. The pool beats that edge-off pool and does not beat the null. The pool is negative. This is not close to a pass. Both books below the equity cap is -797.5 bps over 15 trips, both books negative. Stress is -1,397.5. BTC is -776.7 and ETH is -818.3. The null's p95 is +29.7. The 60-trip gate is not lowered to 15. This is not close to a pass. Coin Metrics realized price peaks at 56,463.11 and the UK BTC open's low is 58,488.28, so both-below is not a rule. The latest lot, option-implied spot, and an ETF implied coin price were not frozen. No threshold or lag was added to make eight rules. On a trip the cost gap is 40 bps times the trip count. That charge is not lowered. Pass 71's review: the round tested two USD-per-coin prices, and the control was the cheapness filter turned off, not a direction bet. The next round does not retest those prices or the banned classes. Pass 72 is not opened. No further published USD price was left that is not a rewrite of a banned sentence. No sign is flipped. No testing row is opened. A numeric clear on these UK opens would still not be paper testing, because no order of this account was shown crossing the book. Branch `cursor/revolut-x-search-d133`.

### [2026-09-25 15:21 UTC] Platform: Cursor | Model: Grok 4.7

**Eight published funding, volatility, and macro fair values missed the testing bar. Pass 69 does not count as a new price edge.** No order, no new row, no edit to PR5, `trend-4h` or `pmrw.ts`, and this was not pushed to `main`. Pass 69 bought when the UK open was below another venue's close of the same coin. The hourly close, the daily close, a 24-hour lag, and a 7-day lag are that same sentence. That family is not a new price edge and it is not rerun. Pass 68 priced the UK book's own opens, means, ratios, and last trades. It does not count as an external fair value and it is not rerun. The fill is a printed Revolut X UK four-hour open to the next open, on BTC-USD and ETH-USD. `region=UK` is on every request. EEA candles are not read. No other pair is stood in. A zero-volume open is not a fill. This is the same pull as pass 62: 2,262 bars on each book, from 2025-09-11 00:00 UTC through the bar that starts 2026-09-22 20:00 UTC, every step four hours, and no zero-volume bar. The UK open is the price this account can pay. It is not the fair value. The UK high, the UK low, the UK close, the UK mean, a UK ratio, and the UK last trade are not the fair value. Another spot last trade or futures last trade of BTC or of ETH is not the fair value. This is not a Binance daily open. The 29-day minute tape is not the fill. It has no ETH-USD. The 60-trip gate is not lowered. The five earlier numeric clears and the confirmation-time fall after a higher day stay void as Revolut X fills. Passes 62 through 67 are not rerun and their signs are not flipped. The pass 67 result of +263.2 bps over 17 trips stays not close to a pass. Spot is not shorted. The rich side is not the control and is not scored. Buying every eligible bar is not reported as a control. The null is 500 long-both draws from that rule's own window, seed 20260925, index 474. No rule here selects the same entry bars as one already scored. No chosen set is a subset of another, and no pair has Jaccard at or above 0.75. Deribit public funding-rate history, instruments BTC-PERPETUAL and ETH-PERPETUAL, URL `https://www.deribit.com/api/v2/public/get_funding_rate_history`, was fetched 2026-09-25 14:47:22 UTC. The timestamp is the publication instant. `interest_8h` is the settled 8-hour rate. The index price is not stored. The Deribit volatility index, URL `https://www.deribit.com/api/v2/public/get_volatility_index_data`, resolution 3600, was fetched at the same time. The close is published at the bucket start plus 3600 seconds. The US Treasury par and real yield curves were fetched 2026-09-25 15:05:49 UTC. A curve date is published at that date plus 86400 seconds. Breakeven is the nominal 10-year minus the real 10-year on the same date. The dollar index DX-Y.NYB was fetched 2026-09-25 14:47:22 UTC. A close is published at the next stored timestamp when the gap is at most 86400 seconds, otherwise one day after the bar start. BLS CPI-U CUUR0000SA0 was fetched 2026-09-25 15:05:34 UTC from `https://api.bls.gov/publicAPI/v2/timeseries/data/`. A month is published at 00:00 UTC on the 1st of the month two months later. Debt to the Penny, field `tot_pub_debt_out_amt`, was fetched 2026-09-25 15:07:57 UTC. A record date is published one day later. A print at the same second as the UK open is not used. Yahoo ^TNX down counted 967, Jaccard 0.547 with the Treasury 10-year, and was not frozen. Yahoo ^IRX down counted 1,038 and was not frozen. The real-yield decline counted 868, Jaccard 0.800 with the nominal, and was not frozen. Both 1-hour funding rates positive counted 859, containment 0.944, and was not frozen. Both UK opens stay above Coin Metrics realized price, so that dollar cost basis is not a rule. Eight rules were hashed at 2026-09-25 15:18:12 UTC, before their own results. The record is `docs/agents/backtests/fp5/summary_pass70.json`. Counts before any return were 1,287, 772, 1,072 of 2,176, 910, 1,031, 1,197, 1,405, and 1,349. Both settled 8-hour funding rates strictly positive is -56,793.5 bps over 1,287 trips, both books negative. The null's p95 is -48,815.0. Both DVOL closes strictly below the previous published close is -31,402.4 bps over 772 trips, both books negative. The null's p95 is -27,801.0. Both DVOL closes strictly below the trailing 30-day median is -41,580.7 bps over 1,072 trips, both books negative. The null's p95 is -39,531.1. The 10-year par yield strictly below its previous print is -34,091.6 bps over 910 trips, both books negative. The null's p95 is -33,223.7. The 10-year breakeven strictly above its previous print is -43,891.1 bps over 1,031 trips, both books negative. The null's p95 is -38,324.5. The dollar index strictly above its previous close is -52,964.1 bps over 1,197 trips, both books negative. The null's p95 is -44,995.9. CPI-U year-over-year strictly above its previous print is -59,553.2 bps over 1,405 trips, both books negative. The null's p95 is -53,449.3. Total public debt strictly above its previous print is -52,967.7 bps over 1,349 trips, both books negative. The null's p95 is -51,341.6. None of these eight beats its null. Every pool is negative and both books are negative. This is not close to a pass. On every trip both books are bought, so the cost gap is 40 bps times the trip count. That charge is not lowered. No sign is flipped. No testing row is opened. A numeric clear on these UK opens would still not be paper testing, because no order of this account was shown crossing the book. None of these eight cleared. Branch `cursor/revolut-x-search-d133`.

### [2026-09-25 14:38 UTC] Platform: Cursor | Model: Grok 4.7

**Eight external fair values missed the testing bar. Pass 68 does not count.** No order, no new row, no edit to PR5, `trend-4h` or `pmrw.ts`, and this was not pushed to `main`. Pass 68 priced the UK book's own opens, means, ratios, and last trades. That is still side selection. It is not an external fair value and it is not rerun. The fill is a printed Revolut X UK four-hour open to the next open, on BTC-USD and ETH-USD. `region=UK` is on every request. EEA candles are not read. No other pair is stood in. A zero-volume open is not a fill. This is the same pull as pass 62: 2,262 bars on each book, from 2025-09-11 00:00 UTC through the bar that starts 2026-09-22 20:00 UTC, every step four hours, and no zero-volume bar. The UK open is the price this account can pay. It is not the fair value. The UK high, the UK low, the UK close, the UK mean, a UK ratio, and the UK last trade are not the fair value. This is not a Binance daily open. The 29-day minute tape is not the fill. It has no ETH-USD. The 60-trip gate is not lowered. The five earlier numeric clears and the confirmation-time fall after a higher day stay void as Revolut X fills. Passes 62 through 67 are not rerun and their signs are not flipped. The pass 67 result of +263.2 bps over 17 trips stays not close to a pass. Spot is not shorted. The rich side of a spread is not the control and is not scored. Buying every eligible bar is not reported as a control. The null is 500 long-both draws from the 2,261 bars that have a next open, seed 20260925, index 474. No rule here selects the same entry bars as one already scored. No chosen set is a subset of another, and no pair has Jaccard at or above 0.75. Coinbase Exchange public candles, products BTC-USD and ETH-USD, URL `https://api.exchange.coinbase.com/products/BTC-USD/candles` and the ETH-USD twin, were fetched 2026-09-25 14:22:58 UTC. The bucket start plus 3600 seconds, or plus 86400 seconds on the daily files, is when the close is published. CME futures BTC=F and ETH=F, exchangeName CME, URL `https://query1.finance.yahoo.com/v8/finance/chart/BTC%3DF` and the ETH=F twin, were fetched 2026-09-25 14:30:33 UTC. Yahoo's timestamp is the bar start. A null close is omitted. A non-null close is published at start plus the bar length. A close is usable only when that instant is strictly before the UK open. A close published at the same second is not used. Coinbase hourly gaps on 2025-10-25 and 2026-05-08 are not filled. Bitstamp was counted and not frozen: hourly both-below 906 against Coinbase 904, Jaccard 0.955, and daily 952 against 950, Jaccard 0.992. A second spot last trade is not a second source. The CME 24-hour both-below set, 1,058 bars, Jaccard 0.818 with the Coinbase 24-hour rule, was not frozen. The CME 7-day both-below set, 1,048 bars, Jaccard 0.838 with the Coinbase 7-day rule, was not frozen. Eight rules were hashed at 2026-09-25 14:34:23 UTC, before their own results. The record is `docs/agents/backtests/fp5/summary_pass69.json`. Counts before any return, out of 2,261 bars, were 904, 950, 976, 1,010, 1,255, 1,027, 399, and 440. Both books below the last Coinbase hourly close is -39,964.1 bps over 904 trips, both books negative. The null's p95 is -33,150.1. Both books below the last Coinbase daily close is -38,056.1 bps over 950 trips, both books negative. The null's p95 is -34,676.9. Both books below the Coinbase hourly close published more than 24 hours earlier is -41,629.1 bps over 976 trips, both books negative. The null's p95 is -35,873.1. Both books below the Coinbase daily close published more than 7 days earlier is -42,090.0 bps over 1,010 trips, both books negative. The null's p95 is -37,061.9. Both books below the last CME hourly close is -53,252.3 bps over 1,255 trips, both books negative. The null's p95 is -47,376.4. Both books below the last CME daily close is -43,420.8 bps over 1,027 trips, both books negative. The null's p95 is -37,916.6. None of these six beats its null. Buying the book that is below its Coinbase hourly close while the other is above is -7,800.2 bps over 399 trips, both books negative. Stress is -15,780.2. BTC is -8,348.2 and ETH is -7,252.1. The null's p95 is -13,281.4. The pool is above that p95 and is still negative. This is not close to a pass. Buying the book that is below its CME hourly close while the other is above is -8,818.2 bps over 440 trips, both books negative. Stress is -17,618.2. BTC is -12,359.8 and ETH is -5,276.6. The null's p95 is -15,124.1. The pool is above that p95 and is still negative. On a two-book trip the cost gap is 40 bps times the trip count. On a one-book trip the unbought book contributes 0, so the pool's gap is 20 bps times the trip count. The bought book is still charged 20 and 20, and stress still charges 40 and 40. That charge is not lowered. No sign is flipped. No testing row is opened. A numeric clear on these UK opens would still not be paper testing, because no order of this account was shown crossing the book. None of these eight cleared. Branch `cursor/revolut-x-search-d133`.

### [2026-09-25 14:15 UTC] Platform: Cursor | Model: Grok 4.7

**Eight UK-book price edges missed the testing bar.** No order, no new row, no edit to PR5, `trend-4h` or `pmrw.ts`, and this was not pushed to `main`. The fill is a printed Revolut X UK four-hour open to the next open, on BTC-USD and ETH-USD. `region=UK` is on every request. EEA candles are not read. No other pair is stood in. A zero-volume open is not a fill. This is the same pull as pass 62: 2,262 bars on each book, from 2025-09-11 00:00 UTC through the bar that starts 2026-09-22 20:00 UTC, every step four hours, and no zero-volume bar. The open that is paid has already printed. Fair value uses only prints strictly before that open. The entry is that open and the exit is the next bar's open. This is not a Binance daily open. The 29-day minute tape is not the fill. It has no ETH-USD. The 60-trip gate is not lowered. The five earlier numeric clears and the confirmation-time fall after a higher day stay void as Revolut X fills. Passes 62 through 67 are not rerun and their signs are not flipped. The pass 67 result of +263.2 bps over 17 trips stays not close to a pass. The high, the low, the wick, and the body are not the signal. Volume is not the signal. Which book's path is later or longer is not the signal. Spot is not shorted. The rich side of a spread is not the control and is not scored. Buying every eligible bar is not reported as a control. The null is 500 long-both draws from that rule's own window, seed 20260925, index 474. No rule here selects the same entry bars as one already scored. An entry ratio differing from the ratio six bars earlier is every one of 2,255 bars and is not a rule. An entry ratio differing from today's 00:00 ratio is every one of 1,879 later bars and is not a rule. Drafts that compared day-over-day opens and open-to-open steps, without a named fair value or a named spread, were not scored and are not in this commit. Eight rules were hashed at 2026-09-25 14:11:21 UTC, before their own results. The record is `docs/agents/backtests/fp5/summary_pass68.json`. Counts before any return were 955 of 2,255, 792 of 1,879, 130 of 375, 173 of 2,260, 915 of 2,255, 364 of 2,260, 221 of 2,260, and 1,482 of 2,243. Both books below the average of the previous six opens is -41,414.5 bps over 955 trips, both books negative. The null's p95 is -35,379.9. Both books below today's 00:00 open is -33,331.0 bps over 792 trips, both books negative. The null's p95 is -29,065.6. Both 00:00 opens below both of the two previous 00:00 opens is -4,067.2 bps over 130 trips, both books negative. The null's p95 is -3,589.4. The 60-trip gate is not lowered to 130. Both opens below the previous last trade is -6,717.2 bps over 173 trips, both books negative. The null's p95 is -4,859.5. None of these four beats its null. Buying the cheap book when the open ratio is outside the prior six ratios is -17,814.5 bps over 915 trips. Stress is -36,114.5. BTC is -16,047.0 and ETH is -19,582.0. The null's p95 is -33,574.2. The pool is above that p95 and is still negative. This is not close to a pass. Buying the book whose open is below its previous open, when the other open is above, is -7,014.9 bps over 364 trips. Stress is -14,294.9. BTC is -8,239.7 and ETH is -5,790.2. The null's p95 is -11,950.0. The pool is above that p95 and is still negative. Buying the book that opens below its previous last trade, when the other opens above, is -5,135.3 bps over 221 trips. Stress is -9,555.3. BTC is -5,846.8 and ETH is -4,423.8. The null's p95 is -6,823.4. The pool is above that p95 and is still negative. Buying the cheap book when the open ratio is farther from the median of the prior eighteen ratios than that window's median absolute deviation is -29,206.1 bps over 1,482 trips. Stress is -58,846.1. BTC is -26,415.9 and ETH is -31,996.4. The null's p95 is -57,383.4. The pool is above that p95 and is still negative. On a two-book trip the cost gap is 40 bps times the trip count. On a one-book trip the unbought book contributes 0, so the pool's gap is 20 bps times the trip count. The bought book is still charged 20 and 20, and stress still charges 40 and 40. That charge is not lowered. No sign is flipped. No testing row is opened. A numeric clear on these UK opens would still not be paper testing, because no order of this account was shown crossing the book. None of these eight cleared. Branch `cursor/revolut-x-search-d133`.

### [2026-09-25 13:55 UTC] Platform: Cursor | Model: Grok 4.7

**Eight UK-book day-open comparisons missed the testing bar.** No order, no new row, no edit to PR5, `trend-4h` or `pmrw.ts`, and this was not pushed to `main`. The fill is the next Revolut X UK four-hour open to the following open, on BTC-USD and ETH-USD. `region=UK` is on every request. EEA candles are not read. No other pair is stood in. A zero-volume open is not a fill. This is the same pull as pass 62: 2,262 bars on each book, from 2025-09-11 00:00 UTC through the bar that starts 2026-09-22 20:00 UTC, every step four hours, and no zero-volume bar. The signal is the six opens of one completed UTC day, read when the 20:00 bar closes. The entry is the next day's 00:00 open and the exit is 04:00. The hold is not stretched to a full day. The high, the low, the wick, the body, the close, and volume are not the signal. This is not a Binance daily open. The 29-day minute tape is not the fill. It has no ETH-USD. Twenty-nine days cannot make 60 daily trips. The 60-trip gate is not lowered. The five earlier numeric clears and the confirmation-time fall after a higher day stay void as Revolut X fills. Passes 62 through 66 are not rerun and their signs are not flipped. No rule here selects the same bars as one already scored. BTC's unique highest open at 16:00 with ETH's at 04:00 had no days and is not a rule. The last open step being the unique largest, BTC's positive and ETH's negative, had no days and is not a rule. Eight rules were hashed at 2026-09-25 13:52:31 UTC, before their own results. The record is `docs/agents/backtests/fp5/summary_pass67.json`. Counts before any return, out of 376 day-ends, were 64, 27, 186, 28, 93, 17, 111, and 60. Backups 69, 21, 178, 39, 90, 17, 123, and 69 were not frozen. BTC's unique highest open falling later than ETH's is -1,527.9 bps over 64 trips, both books negative. BTC's lowest open strictly before its highest, with ETH's lowest strictly after its highest, is -957.9 bps over 27 trips, both books negative. The 60-trip gate is not lowered to 27. BTC's open path a strictly larger multiple of its net change than ETH's is -8,902.6 bps over 186 trips, both books negative. BTC's 20:00 open strictly above the midpoint of that day's highest and lowest opens, with ETH's strictly below, is -1,213.6 bps over 28 trips, both books negative. The 60-trip gate is not lowered to 28. BTC having strictly more rising open steps than ETH is -2,499.4 bps over 93 trips, both books negative. BTC's longest rising run strictly longer than its longest falling run, with ETH's longest falling run strictly longer than its longest rising run, is +263.2 bps over 17 trips. Stress is -416.8. BTC is +23.2 and ETH is +503.3. March 2026 is 0.759 of the pool. The unrounded share is 0.759107 (199.817108 of 263.226659). The null's p95 is -60.4. The pool does not exceed 400 bps. The numeric bar is not clear. This is not close to a pass. The 60-trip gate is not lowered to 17. March is not dropped. Both books placing their unique highest open in the same slot, after each unique lowest open, is -6,105.0 bps over 111 trips, both books negative. BTC's unique largest absolute open step falling strictly later than ETH's is -2,692.6 bps over 60 trips, both books negative. No sign is flipped. No testing row is opened. A numeric clear on these UK opens would still not be paper testing, because no order of this account was shown crossing the book. None of these eight cleared. Branch `cursor/revolut-x-search-d133`.

### [2026-09-25 13:46 UTC] Platform: Cursor | Model: Grok 4.7

**Eight UK-book volume comparisons missed the testing bar.** No order, no new row, no edit to PR5, `trend-4h` or `pmrw.ts`, and this was not pushed to `main`. The fill is the next Revolut X UK four-hour open to the following open, on BTC-USD and ETH-USD. `region=UK` is on every request. EEA candles are not read. No other pair is stood in. A zero-volume open is not a fill. This is the same pull as pass 62: 2,262 bars on each book, from 2025-09-11 00:00 UTC through the bar that starts 2026-09-22 20:00 UTC, every step four hours, and no zero-volume bar. The signal is the base volume of a closed bar. The high, the low, the wick, and the body are not the signal. The open and the close are not the signal. BTC volume is not compared with ETH volume. This is not a Binance daily open. The 29-day minute tape is not the fill. It has no ETH-USD. Twenty-nine days cannot make 60 daily trips. The 60-trip gate is not lowered. The five earlier numeric clears and the confirmation-time fall after a higher day stay void as Revolut X fills. Passes 62, 63, 64, and 65 are not rerun and their signs are not flipped. Those passes compared highs, lows, wicks, and bodies with the previous bar. This pass does not. No rule here selects the same bars as one already scored. A whole BTC bar strictly above the previous last trade, with the whole ETH bar strictly below, had no days, and the swap had no days. Neither was written as a rule. An open strictly above the previous high, with the other book's open strictly below the previous low, had no days either way and is not a rule. Eight rules were hashed at 2026-09-25 13:43:02 UTC, before their own results. The record is `docs/agents/backtests/fp5/summary_pass66.json`. Counts before any return, out of 2,254 bars with six earlier bars and two later bars, were 416, 25, 139, 412, 154, 431, 359, and 130. Backups 422, 38, 132, 456, 145, 382, 336, and 136 were not frozen. BTC volume above the sum of the two previous volumes counted 532, and ETH volume below the mean of its two previous volumes counted 1,217. The joint is 154, so both legs bind. BTC's volume strictly above the previous bar, and ETH's strictly below, is -18,516.7 bps over 416 trips, both books negative. Two ordered rising BTC volume steps against two ordered falling ETH volume steps is -1,286.1 bps over 25 trips, both books negative. The 60-trip gate is not lowered to 25. BTC's volume strictly above both previous volumes, and ETH's strictly below both, is -5,379.9 bps over 139 trips, both books negative. BTC's volume strictly between the two previous volumes, and ETH's strictly outside, is -18,419.7 bps over 412 trips, both books negative. BTC's volume strictly above the sum of the two previous volumes, and twice ETH's volume strictly below the sum of its two previous volumes, is -7,500.6 bps over 154 trips, both books negative. BTC's volume strictly above the same UTC slot one day earlier, and ETH's strictly below, is -17,596.9 bps over 431 trips, both books negative. Both volumes up, with BTC's rise a strictly smaller fraction, is -12,268.4 bps over 359 trips, both books negative. BTC's volume turning up and ETH's volume turning down is -4,877.8 bps over 130 trips, both books negative. Every pool is negative, both books are negative, and none beat the null. No sign is flipped. No testing row is opened. A numeric clear on these UK opens would still not be paper testing, because no order of this account was shown crossing the book. None of these eight cleared. Branch `cursor/revolut-x-search-d133`.
