...
**fp297–fp304 are frozen. No return of these rules has been computed.** Fair value is the Coinbase Exchange BTC-USD daily close, or the Deribit BTC-PERPETUAL daily close. A close is used only after its bucket has ended, and only when that end is strictly earlier than the Binance entry open. The traded contract's open is the fill only. Spot, the coin-margined book and the USDT book are not each other's fair value. DISCU is not pre-registered: its fair value was the Binance spot close. Counts with no profit computed: 174/183, 170/184, 173/179, 132/226, 172/183, 169/172, 167/184, 133/223. The screen count stays 30. A mean that clears the edge-off trade by 20 bps or less is not taken out of sample. The next eight are not frozen. No pull request. Main was not pushed.
