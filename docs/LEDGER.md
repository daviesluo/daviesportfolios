...
**fp332–fp334 are frozen and not yet scored. The result is the discount change, not the two-day spot move.** Davies, 2026-09-25: from this round the open-to-open drift of the coin is not a price edge. The buy is an open below fair value, and the exit result is the change in that discount. Three mechanisms cleared a count of 30 cheap days, a round trip of forty basis points, and a cheap set strictly shorter than the edge-off set. They are not eight, and the counted failures are not used to fill eight. SPQTR: the quarterly buyer pays more than the Binance spot open; previous close basis at least 100 bp; 125 trades, 240 edge-off, 365 fillable. PEPRM: the 1000PEPE buyer overpays versus PEPE spot after dividing by 1,000; previous close premium at least 50 bp; 48 trades, 191 edge-off, 239 fillable. FDCSH: a negative TRBUSDT funding rate is cash the short pays the long on a hedged package; the signal is the completed-interval premium at least 50 bp cheap, and the print is not the signal; 85 trades, 815 edge-off, 36 entry days. Protocols `docs/agents/reviews/2026-09-25-fp332-protocol.md`, `fp333`, `fp334`. No screen file has been written. After this freeze is pushed, score each screen twice and require the copies to match. A negative mean, or a gap inside 20 bps, is not taken out of sample. No testing row. No pull request. Main was not pushed.
