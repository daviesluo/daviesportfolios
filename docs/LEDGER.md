...
**fp265–fp272 are frozen. No return of these rules has been computed.** PICK stays a research record. It is not a testing row and it is not a Revolut X paper candidate: the other trade was about one cent ahead (+$1.004429 against +$0.9919), 2025-01-01 through 2026-09-16 is +$0.6733, and the fill is a Binance daily open, not a price this account can get. LATER is void. The buys and the sells of those two rules were not moved. The eight rules are LASTUP, UNDER, FASTER, LOUDER, STALE, INUP, BACK and LEDSP. Each null is another trade held the same number of days, not the same leg with the condition off. Counts taken before this freeze, with no profit computed: LASTUP 63/63, UNDER 206/206, FASTER 118/118, LOUDER 170/175, STALE 89/89, INUP 69/69, BACK 123/123, LEDSP 169/169. Fillable days were 355/355, 346/354, 358/358, 345/345, 353/361, 341/341, 362/362 and 334/342. LOUDER's other set does not overlap the rule. The screen count stays 30. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. A pass of 2023 is not a testing row. No later year of these eight is scored. Reference §3.304. No pull request. Main was not pushed.
