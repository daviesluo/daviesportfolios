...
**CMF and QNEW pre-registrations are frozen. No later-year return has been computed. Neither is a testing row.** The 2023 screens stay `cd228903` (96 trades, +$471.5815) and `e8bfe70c` (40 trades, +$304.5022). CMF still buys BTCUSD_PERP for twelve days when its finished twelve-day return was negative and below spot's. The book at the freeze is BTCUSD_PERP bid 84668.7, ask 84668.8, half-spread 5.905366502152256e-07. The last entry is 2026-09-13 and the exit open is 2026-09-25. Spot closes used as the signal stop on 2026-09-12. QNEW still buys the most recently listed quarterly during ages 0 through 13 and sells eleven days later, before that expiry. The later contracts are the last Fridays in `2026-09-25-fp231-prereg-qnew.md`, not a 2024 open. The book at the freeze is BTCUSD_261225 bid 85644.4, ask 85685.6, half-spread 0.0002404716045059922. BTCUSD_260925 bid 0.0 and ask 0.0 is the expiry print and is not the spread. BTCUSD_261225 is not an entry. The null hold stays twelve days for CMF and eleven days for QNEW. Score each rule from 2024-01-01 only after this freeze, and do not move a buy or a sell. If both later-year bars fail, freeze and score at least eight new single-leg mechanisms in the same round. Not a one-day long or short of BTC, and not a two-leg spread. The count stays 30. MTH stays void. No pull request. Main was not pushed.
