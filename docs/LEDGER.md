...
**fp332–fp334 are scored. PEPRM is negative and is not taken out of sample. SPQTR clears the pre-registered later years and is not a testing row. FDCSH has no later-year trade and is not a testing row.** The protocol was `60b1b33`, pushed before any 2023 return. The pre-registration was `7ba71b7`, pushed before any later-year return. Each file was written twice and the copies matched. The result is the discount change, or the funding cash, not the coin's open-to-open move. SPQTR 2023: 125 / file gross +133.2947 / file mean +93.2947 / null +9.2826 / +$116.6183 (`d137286d…`). Median entry basis +130.5214 bp, median exit −1.0325 bp. The gap is 84.0121 bps. Later years `2ae6ce0b…`: 395 trades, mean +144.2213 bp, null p95 +1.4352 bp, gap 142.7861 bp, +$569.674. 2024 is +$419.5365 and 2025-01-01 through 2026-08-31 is +$150.1375. Doubled costs are +$411.674. April 2024 is 15.44%. The house annualised figure over 974 days is 2.134815. The holds overlap. PEPRM 48 / file gross +9.153 / file mean −30.847 / null −28.058 / −$14.8065 (`93512407…`). Median signal +69.9624 bp, median entry premium −15.558 bp, median exit −11.5694 bp. It sits 2.789 bp under its null. FDCSH 2023: 85 / file gross +128.5634 / file mean +88.5634 / null −36.9061 / +$75.2789 (`42030f61…`). Median cash +105.9454 bp, exit 0. The gap is 125.4695 bps. Later years `9caed9a2…`: 0 trades. The cheapest on-hour premium is −25.3746 bp. A millisecond snap still has 0 trades at −50 bp, cheapest −38.9493 bp. The line was not lowered. The counted failures were not used to fill eight. No testing row. Reference §3.390. No pull request. Main was not pushed.

**No same-unit file had thirty cheap days. The count is zero. Nothing was frozen and nothing was scored.** Davies, 2026-09-25: do not retest electricity, power, terawatt-hours, or miner revenue, and do not swap in the minting-cost upper bound. Do not hand in eight energy pages. A file counts only when it is the same unit as that contract, overlaps the daily bars for at least 30 days, and is already 25 bp cheap on at least 30 days before the entry. The cause is written after that count. Changing a column, an electricity price, or a coin does not make a second file. Redemption, par, realised price, another venue's close, a funding sign, and purchasing-power parity stay banned. Coin Metrics' community catalog has 32 metrics and no USD price besides the market price and the reference rate. Index Coop's DPI analytics object has a null NAV and DPIUSDT has zero of twelve 2023 monthly files. Treasury tokens and the stock tokens have zero of twelve. Frax's combined snapshot is one print at 2026-09-25 22:00:06 UTC. A block-level MEV file is dollars per block, not dollars per coin. No return was computed. Nothing is taken out of sample. No testing row. Reference §3.389. No pull request. Main was not pushed.

**fp324–fp331 are reviewed. Gold and the euro are two sentences. The six baskets are one. The next eight are not frozen.** Davies, 2026-09-25: GLDPM and ECBFX are two rules. BMACP, CPIPP, PPIPP, WAGPP, CLTHP and AIRPP are one purchasing-power sentence with the basket changed. The next round does not test purchasing power, another price index, a gold price divided by a stablecoin, or an ECB rate divided by a stablecoin. Realised price, token par, a funding sign, and another venue's close stay banned. A rule is not run until the derivation names who is wrong about which price, why the open paid is below a fair value already published, that the discount and the fill are the same unit, and that the discount already exceeded the round-trip fee. Swapping basket, exchange, threshold, or coin to fill eight is refused. Eight different causes are still required. None of those eight was written, so none was run. Leveraged-token net asset value is a different sentence, and the public market-data files do not carry that history. Four leveraged tokens would be one sentence. wNXM `getTokenPrice` is the mint price, not a bid the mutual pays. No return of a next round has been computed. CPIPP's 16.2028 bps gap stays inside 20. No testing row. Reference §3.385. No pull request. Main was not pushed.

**fp324–fp331 fail the 2023 screen. None is taken out of sample and none is a testing row.** The protocol was `a90b9b4`, pushed before any of these returns. Each screen file was written twice and the copies matched. GLDPM 154 / file gross +5.2892 / file mean −14.7014 / null −15.0982 / −$22.6402 (`55fb3385…`). It sits 0.3968 bps above its null. ECBFX 160 / file gross +7.1097 / file mean −12.8846 / null −22.5638 / −$20.6153 (`04137c22…`). It sits 9.6792 bps above its null. BMACP 148 / file gross +8.2805 / file mean −11.7161 / null −21.6836 / −$17.3398 (`d38be64f…`). It sits 9.9675 bps above its null. CPIPP 107 / file gross +15.1919 / file mean −4.8185 / null −21.0213 / −$5.1558 (`c0e82f54…`). It sits 16.2028 bps above its null, inside 20 bps. PPIPP 130 / file gross +3.2088 / file mean −16.7776 / null −17.5504 / −$21.8109 (`8871e2dc…`). It sits 0.7728 bps above its null. WAGPP 93 / file gross −7.9743 / file mean −27.9384 / null −10.4449 / −$25.9827 (`50fa607e…`). It sits 17.4935 bps under its null. CLTHP 120 / file gross +3.8495 / file mean −16.1382 / null −18.1312 / −$19.3658 (`62e7321d…`). It sits 1.993 bps above its null. AIRPP 146 / file gross +7.3722 / file mean −12.6225 / null −23.9904 / −$18.4289 (`09ce00a4…`). It sits 11.3679 bps above its null. Every mean is negative. The scored counts match the pre-freeze counts: 154/157, 160/182, 148/194, 107/212, 130/173, 93/160, 120/199, 146/173. No rule was changed after the freeze. None is taken out of sample. No testing row is added. The next eight are not frozen. The count stays 30. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.376–§3.384. No pull request. Main was not pushed.

**EREAL fails the pre-registered later years and is not a testing row. WBRAT and WBPAR failed 2023 and were not taken out of sample.** The protocol was `c824fd5`, pushed before any of these returns. Each screen file was written twice and the copies matched. EREAL 31 / file gross +313.5871 / file mean +292.9806 / null +76.5994 / +$90.824 (`6445081a…`). The edge-off set has 325 trades and a mean of −3.9242 bps. The cutoff is the house p95, not that mean. The gap is 216.3812 bps. The pre-registration was `577ba4f`. Two runs matched. 2023 reproduces: 31 trades, +$90.824, mean +292.9806 bps, null p95 +76.5994 bps. Entries 2024-01-01 through 2026-09-23: 232 trades, +$83.8137, mean +$0.361266, edge-off p95 +$0.3071 on 765 trades, gap 5.4189 bps. 2024 has no entry. 2025-01-01 through 2026-09-23 is +$83.8137. Doubled costs are +$37.2925. May 2025 is 58.61% of the total. Annualised over 998 days it is 0.306533. The file is `9be0c91a…`. WBRAT 43 / file gross +7.8115 / file mean −12.1842 / null −17.1134 / −$5.2392 (`794f6dc4…`). WBPAR 167 / file gross +3.124 / file mean −16.8623 / null −22.1764 / −$28.16 (`814dd798…`). WBRAT and WBPAR are negative. WBRAT sits 4.9292 bps above its null and WBPAR sits 5.3141 bps above its null. The scored counts match the pre-freeze counts: 31/325, 43/189, 167/196. No rule was changed after the freeze. No testing row is added. The count stays 30. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.370–§3.375. No pull request. Main was not pushed.

**fp305–fp312 are scored. All eight fail the 2023 screen. None is taken out of sample and none is a testing row.** The protocol was `cf2f128`, pushed before any of these returns. Each screen file was written twice and the copies matched. Fair value is a public daily close from Bitstamp, Bitfinex, BitMEX, OKX, Gate.io, KuCoin, HTX or WhiteBIT, used only after that bucket has ended. The three Binance lines are not each other's fair value. Coinbase and Deribit are not reused. A book ticker is not read. BSTCH 174 / file gross +221.7606 / file mean +201.3375 / null +315.7477 / +$350.3272 (`19d9d541…`). BFXRH 163 / file gross −304.234 / file mean −323.6062 / null −229.3598 / −$527.4781 (`34f259c4…`). MEXCH 157 / file gross +159.5842 / file mean +139.2854 / null +283.2216 / +$218.678 (`e9c6ca84…`). OKXCH 176 / file gross +402.7173 / file mean +381.9327 / null +405.2689 / +$672.2015 (`99505be5…`). GATCH 178 / file gross +205.6643 / file mean +185.2733 / null +258.5988 / +$329.7865 (`f3352d74…`). KUCCH 170 / file gross +321.2902 / file mean +300.6683 / null +366.0344 / +$511.1361 (`08430523…`). HTXCH 171 / file gross +187.9688 / file mean +167.6132 / null +415.3999 / +$286.6185 (`51981906…`). WBTCH 168 / file gross +390.8267 / file mean +370.0658 / null +545.9713 / +$621.7105 (`60cbfcf8…`). BSTCH, MEXCH, OKXCH, GATCH, KUCCH, HTXCH and WBTCH are positive and under their nulls. BFXRH is negative and under its null. OKXCH's edge-off set has 176 trades, the same length as the rule, so the house p95 equals the edge-off mean, +405.2689 bps. BSTCH's entries are the same timestamps as CBCHP; every stored Bitstamp close differs from the Coinbase close, and the dollars match because the fill is the USDT open. The scored counts match the pre-freeze counts: 174/183, 163/191, 157/193, 176/176, 178/180, 170/176, 171/185, 168/182. No rule was changed after the freeze. None clears the three screen bars, so none is taken out of sample. No testing row is added. The next eight are not frozen. The count stays 30. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.352–§3.359. No pull request. Main was not pushed.

**fp297–fp304 are scored. DBCHP passes the 2023 screen by 1.0902 bps and is not taken out of sample. The other seven fail. None is a testing row.** The protocol was `21d193c`, pushed before any of these returns. Each screen file was written twice and the copies matched. Fair value is the Coinbase Exchange BTC-USD daily close or the Deribit BTC-PERPETUAL daily close, used only after the bucket has ended. The three Binance lines are not each other's fair value. CBCHP 174 / file gross +221.7606 / file mean +201.3375 / null +315.7477 / +$350.3272 (`32260c5d…`). CBRCH 170 / file gross −307.6702 / file mean −327.0355 / null −236.7359 / −$555.9603 (`679cb205…`). CBSPT 173 / file gross +376.6109 / file mean +355.8784 / null +452.9495 / +$615.6696 (`cda55e40…`). CBWDN 132 / file gross −237.1917 / file mean −256.6978 / null −106.2501 / −$338.8411 (`3ff1230e…`). DBCHP 172 / file gross +344.4908 / file mean +323.8225 / null +322.7323 / +$556.9747 (`5b952dc8…`). DBRCH 169 / file gross −364.4739 / file mean −383.7257 / null −384.6684 / −$648.4965 (`5a48c10c…`). DBCMC 167 / file gross +166.5293 / file mean +146.2166 / null +201.3999 / +$244.1817 (`514e808a…`). DBWDN 133 / file gross −231.9279 / file mean −251.4445 / null −181.2094 / −$334.4212 (`0c1d4b8a…`). DBCHP clears the three screen bars. The edge-off set has 183 trades and a mean of +299.0321 bps. The cutoff is the house p95, not that mean. The gap is 1.0902 bps, inside 20 bps, so the later years are not scored. CBCHP, CBSPT and DBCMC are positive and under their nulls. CBRCH, CBWDN and DBWDN are negative and under their nulls. DBRCH is negative and above its null. The scored counts match the pre-freeze counts: 174/183, 170/184, 173/179, 132/226, 172/183, 169/172, 167/184, 133/223. No rule was changed after the freeze. DISCU is not pre-registered. No testing row is added. The next eight are not frozen. The count stays 30. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.343–§3.350. No pull request. Main was not pushed.

**fp289–fp296 are scored. DISCU passes the 2023 screen by 25.559 bps. It is not pre-registered, because its fair value was the Binance spot close. The other seven fail. None is a testing row.** The protocol was `94b463a`, pushed before any of these returns. Each screen file was written twice and the copies matched. DISCU 84 / file gross +383.5432 / file mean +362.7969 / null p95 +337.2379 / +$304.7494 (`9307125a…`). The edge-off set has 273 trades and a mean of +213.9465 bps. The cutoff is the house p95, not that mean. RICHU 57 / file gross −289.0015 / file mean −308.4041 / null −132.5773 / −$175.7903 (`d5763605…`). CHEAPS 55 / file gross +414.7059 / file mean +393.8973 / null +661.1058 / +$216.6435 (`bcd27f5a…`). WIDEN 46 / file gross −130.3313 / file mean −150.0509 / null −26.6817 / −$69.0234 (`31969d78…`). CHEAPC 93 / file gross +421.2353 / file mean +400.4137 / null +413.2256 / +$372.3847 (`c8c30013…`). DISCM 89 / file gross +217.8056 / file mean +197.3904 / null +243.7014 / +$175.6775 (`8bbb9551…`). GAPCM 148 / file gross −311.7568 / file mean −331.114 / null −152.7093 / −$490.0487 (`8c72edf6…`). RICHC 87 / file gross −185.211 / file mean −204.821 / null −327.3999 / −$178.1943 (`44cfcf75…`). DISCU clears the three screen bars and clears the edge-off trade by 25.559 bps. RICHU, WIDEN and GAPCM are negative and under their nulls. CHEAPS, CHEAPC and DISCM are positive and under their nulls. RICHC is negative and above its null. The scored counts match the pre-freeze counts: 84/273, 57/297, 55/297, 46/312, 93/253, 89/267, 148/195, 87/254. No rule was changed after the freeze. The later years of DISCU are not scored. No testing row is added. The count stays 30. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.334–§3.341. No pull request. Main was not pushed.

**fp281–fp288 are scored. They pick a side. None names a price edge, so none is taken out of sample and none is a testing row.** The protocol was `70c5966`, pushed before any of these returns. Each screen file was written twice and the copies matched. PEAK 54 / file gross +313.5634 / file mean +292.9569 / null +225.6317 / +$158.1967 (`f8cae8ca…`). REBND 88 / file gross +267.7883 / file mean +247.2732 / null +73.1577 / +$217.6004 (`eea2d97d…`). DROPCM 81 / file gross −332.6429 / file mean −351.9583 / null −353.9095 / −$285.0862 (`4953b6cf…`). TRIO 201 / file gross +582.9392 / file mean +561.7945 / null +561.1486 / +$1129.207 (`3f9b1d74…`). SOFTER 91 / file gross −495.8187 / file mean −514.8081 / null −510.1803 / −$468.4753 (`f092a338…`). RESUME 51 / file gross +86.7526 / file mean +66.5992 / null +34.4943 / +$33.9656 (`6fcf4652…`). LESSUP 94 / file gross +793.8868 / file mean +772.3206 / null +769.4514 / +$725.9814 (`74ae33ef…`). LIFTL 134 / file gross +368.3052 / file mean +347.5893 / null +317.213 / +$465.7697 (`7f2b96dc…`). PEAK, REBND, TRIO, RESUME, LESSUP and LIFTL clear the three screen bars. DROPCM is negative and above its null. SOFTER is negative and under its null. PEAK clears by 67.3252 bps, REBND by 174.1155 bps, RESUME by 32.1049 bps and LIFTL by 30.3763 bps. TRIO clears by 0.6459 bps and LESSUP by 2.8692 bps. A gap inside 20 bps stays inside 2023, and a side pick is not taken out of sample even when the gap is larger. The scored counts match the pre-freeze counts: 54, 88, 81, 201, 91, 51, 94, 134. No rule was changed after the freeze. The next eight are not frozen yet. A later rule has to name the fair value it is cheap against, or the spread or basis it earns. The count stays 30. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.325–§3.332. No pull request. Main was not pushed.

**fp273–fp280 are scored. RISE and LAGSP pass the 2023 screen and are not testing rows. The other six fail.** The protocol was `1057661`, pushed before any of these returns. Each screen file was written twice and the copies matched. DRIFT 131 / file gross +251.4984 / file mean +231.0159 / null +278.6329 / +$302.6308 (`c7d4a538…`). ABOVE 51 / file gross −482.1298 / file mean −501.1465 / null −502.9563 / −$255.5847 (`2b8096ae…`). DEEPCM 134 / file gross −433.6134 / file mean −452.7271 / null −206.7926 / −$606.6543 (`5afe2cd4…`). BOTHUP 187 / file gross +870.7697 / file mean +849.0499 / null +849.9417 / +$1587.7233 (`f0f7d8ba…`). COOLED 66 / file gross +145.2864 / file mean +125.0161 / null +241.5348 / +$82.5106 (`12fe3d00…`). BOTHDOWN 141 / file gross −547.0954 / file mean −565.9823 / null −567.0602 / −$798.0351 (`b322df26…`). RISE 225 / file gross +80.429 / file mean +60.2883 / null +48.0585 / +$135.6487 (`a63ea6da…`). LAGSP 174 / file gross +679.1516 / file mean +657.8146 / null +657.6838 / +$1144.5975 (`7e5cd11a…`). RISE and LAGSP clear the three screen bars. Their later years are not scored, so neither is a testing row. LAGSP clears the other trade by 0.1308 bps, the same class as PICK. RISE clears it by 12.2298 bps. DRIFT, BOTHUP and COOLED are positive and under their nulls. ABOVE and BOTHDOWN are negative and above their nulls. DEEPCM is negative and under its null. Every fill is one leg on a price that exists on that contract. Each null is the other trade, held the same number of days, not the opposite side and not the same leg with the condition off. The scored counts match the pre-freeze counts: 131, 51, 134, 187, 66, 141, 225, 174. No rule was changed after the freeze. LOUDER stays void. LASTUP stays void. UNDER and STALE were not taken out of sample. A Binance daily open is not a Revolut X fill. The count stays 30. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.316–§3.323. No pull request. Main was not pushed.

**LOUDER fails the pre-registered later years and is void.** The pre-registration was `f6b92c4`, pushed before any later-year return. The test was run twice and the copies matched. `docs/agents/backtests/fp268/louder_oos.json`, sha256 `f7bf741f…`. 2023 reproduces: 170 trades, +$1021.9923, mean +601.172 bps, quieter mean +529.6739 bps, sample p95 +551.9241 bps on 175 trades. Entries 2024-01-01 through 2026-09-04: 499 trades, +$977.9158, mean +$1.959751. The quieter set has 479 trades and a mean of +$1.562082. It is shorter than the rule, so the sample p95 is missing. That cutoff was not replaced with the quieter mean. 2024 is +$1028.8694 and 2025-01-01 through 2026-09-04 is −$50.9536. Doubled costs are +$876.2614. February 2024 is +$468.1748, 47.87% of the total; without it the total is +$509.741. Annualised over 998 days it is 3.576546. The second window is negative, the sample p95 is missing, and one month is above 40%. The buy and the sell were not moved. LASTUP stays void. UNDER and STALE were not taken out of sample. FASTER, BACK, INUP and LEDSP were not taken out of sample. LOUDER is not a testing row. The next eight are not frozen yet. Reference §3.313 and §3.314. No pull request. Main was not pushed.

**fp265–fp272 are scored. LASTUP, UNDER, LOUDER and STALE pass the 2023 screen and are not testing rows. The other four fail.** The protocol was `dd2cb6e`, pushed before any of these returns. Each screen file was written twice and the copies matched. LASTUP 63 / file gross +425.5617 / file mean +404.7314 / null −355.5073 / +$254.9808 (`1d3e890c…`). UNDER 206 / file gross +468.4063 / file mean +447.4904 / null +443.2493 / +$921.8302 (`59cff905…`). FASTER 118 / file gross −110.5572 / file mean −130.3164 / null −144.3478 / −$153.7733 (`9d77933f…`). LOUDER 170 / file gross +622.3955 / file mean +601.172 / null +551.9241 / +$1021.9923 (`22382308…`). STALE 89 / file gross +109.1949 / file mean +88.9967 / null +88.2984 / +$79.2071 (`9b43a28e…`). INUP 69 / file gross −562.1609 / file mean −581.0178 / null +676.4821 / −$400.9023 (`e996f477…`). BACK 123 / file gross −26.595 / file mean −46.5219 / null −138.7914 / −$57.2219 (`02a448fe…`). LEDSP 169 / file gross −616.4439 / file mean −635.1923 / null −635.7899 / −$1073.4749 (`0dbe0342…`). LASTUP, UNDER, LOUDER and STALE clear the three screen bars. Their later years are not scored, so none is a testing row. FASTER and BACK are negative and above their nulls. INUP is negative and under its null. LEDSP is negative and above its null. LOUDER's other trade has 175 fills and a mean of +529.6739 bps; the cutoff is the house p95, +551.9241. Every fill is one leg on a price that exists on that contract. Each null is the other trade, held the same number of days, not the same leg with the condition off. The scored counts match the pre-freeze counts: 63, 206, 118, 170, 89, 69, 123, 169. No rule was changed after the freeze. PICK stays out of testing and is not a Revolut X paper candidate. LATER stays void. A Binance daily open is not a Revolut X fill. The count stays 30. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.305–§3.312. No pull request. Main was not pushed.

**PICK passes the pre-registered later years and is not a testing row. LATER fails them and is void.** The pre-registrations were `8878fdc`, pushed before any later-year return. The checker phrases were aligned in `fc7f772` before the score. Each test was run twice and the copies matched. PICK `docs/agents/backtests/fp257/pick_oos.json`, sha256 `f6179573…`. 2023 reproduces: 156 trades, +$363.8263, mean +233.222 bps, other trade +230.2271 bps. Entries 2024-01-01 through 2026-09-16: 475 trades, +$477.1037, mean +$1.004429, other-trade cutoff +$0.9919 on 475 nine-day spot longs. 2024 is +$476.4304 and 2025-01-01 through 2026-09-16 is +$0.6733. Doubled costs are +$381.2452. February 2024 is +$174.3003, 36.53% of the total; without it the total is +$302.8034. Annualised over 998 days it is 1.744918. LATER `docs/agents/backtests/fp263/later_oos.json`, sha256 `8c099ae1…`. 2023 reproduces: 87 trades, +$380.6856, mean +437.5697 bps, other trade +329.1846 bps. Entries 2024-01-01 through 2026-08-26: 252 trades, +$148.8984, mean +$0.590867, other-trade cutoff +$0.8883 on 252 fifteen-day spot longs started later. 2024 is +$299.3036 and 2025-01-01 through 2026-08-26 is −$150.4052. Doubled costs are +$98.2512. February 2024 is +$150.1256, 100.82% of the total; without it the total is −$1.2272. Annualised over 998 days it is 0.544568. LATER's second window is negative, its mean is under the other trade, and one month is the whole profit. The nulls stayed the other trade. The buys and the sells were not moved. Neither is a testing row. Neither is a Revolut X paper candidate. The next eight were not started. Reference §3.302 and §3.303. No pull request. Main was not pushed.

**fp257–fp264 are scored. PICK and LATER pass the 2023 screen and are not testing rows. The other six fail.** The protocol was `73270f4`, pushed before any of these returns. Each screen file was written twice and the copies matched. PICK 156 / file gross +253.7089 / file mean +233.222 / null +230.2271 / +$363.8263 (`314500be…`). FADEU 214 / file gross −229.1096 / file mean −248.6318 / null +288.6992 / −$532.0721 (`0d9d4de4…`). DEFER 144 / file gross −274.0383 / file mean −293.4708 / null −203.409 / −$422.5979 (`5db612af…`). CMLAG 170 / file gross +551.3345 / file mean +530.253 / null +533.5308 / +$901.43 (`6b1705a1…`). LAGB 169 / file gross −138.7768 / file mean −158.4795 / null −160.716 / −$267.8303 (`9876b165…`). OTHER 108 / file gross +362.7863 / file mean +342.0814 / null +351.58 / +$369.448 (`ae1db46c…`). LATER 87 / file gross +458.4657 / file mean +437.5697 / null +329.1846 / +$380.6856 (`f8392a33…`). AFTER 154 / file gross +495.1066 / file mean +474.1374 / null +476.1511 / +$730.1716 (`457e995d…`). PICK and LATER clear the three screen bars. PICK later passed the pre-registered later years and LATER failed them. Neither is a testing row. FADEU and DEFER are negative and under their nulls. LAGB is negative and above its null. CMLAG, OTHER and AFTER are positive and under their nulls. OTHER's other trade has 240 fills and a mean of +264.3076 bps; the cutoff is the house p95, +351.58. Every fill is one leg on a price that exists on that contract. Each null is the other trade, held the same number of days, not the same leg with the condition off. The scored counts match the pre-freeze counts: 156, 214, 144, 170, 169, 108, 87, 154. No rule was changed after the freeze. A Binance daily open is not a Revolut X fill. The count stays 30. Reference §3.294–§3.301. No pull request. Main was not pushed.

**A Binance daily open that clears a numerical gate is not a Revolut X fill.** Davies, 2026-09-25: passing that gate does not mean Revolut X can trade it. The result is not written up as a Revolut X paper-testing candidate. A nearby signal is not substituted to force a pass. A rule still has to know its signal before the entry. The fill has to be a price that exists on that contract. LS-FADE's 60-trade reproduction, the control, and doubled costs are not relaxed. No testing row is added. LS-FADE stays failed (§3.34) and is not rewritten. This search's screen count stays 30. fp257–fp264 are scored above. PICK and LATER pass 2023 and are not testing rows.

**fp249–fp256 fail the 2023 screen. None is a testing row.** The protocol was `dfa98e6`, pushed before any of these returns. Each screen file was written twice and the copies matched. JOIN 152 / file gross +496.1709 / file mean +475.1995 / null +621.3966 / +$722.3032 (`9706cbfc…`). FADE 61 / file gross −599.9496 / file mean −618.731 / null −385.7913 / −$377.4259 (`e7f5e940…`). LAGU 172 / file gross −319.8428 / file mean −339.1838 / null −299.0266 / −$583.3961 (`6b2e7f8a…`). INNER 238 / file gross +550.4338 / file mean +529.3541 / null +631.1015 / +$1259.8627 (`e85e99ef…`). FLIP 93 / file gross +571.2084 / file mean +550.0871 / null +755.778 / +$511.581 (`19c4e30c…`). NEWUP 83 / file gross +547.6233 / file mean +526.5491 / null +859.5851 / +$437.0358 (`f74f3224…`). TWOD 80 / file gross −430.4524 / file mean −449.5724 / null −272.4165 / −$359.6579 (`e3e98044…`). ECHO 102 / file gross +828.9158 / file mean +807.2796 / null +826.0551 / +$823.4252 (`1e47bd94…`). JOIN, INNER, FLIP, NEWUP and ECHO are positive and under their nulls. FADE, LAGU and TWOD are negative and under their nulls. Every fill is one leg. Each null is that payoff with the extra condition off, held the same number of days. Funding cash is not added. The scored counts match the pre-freeze counts: 152, 61, 172, 238, 93, 83, 80, 102. No rule was changed. A three-day spot decline against a three-day USDT rise had 0 spans and was not scored. None of these is a testing row. The later years are not scored. TRIP and CFAL stay failed on the later years and are not testing rows. HI10 and STEP stay failed. CMF and QNEW stay failed. MTH stays void. The count stays 30. Reference §3.285–§3.292. No pull request. Main was not pushed.

**TRIP and CFAL fail the pre-registered later years. Neither is a testing row.** The pre-registrations were `efec1d8`, pushed before any later-year return. Each test was run twice and the copies matched. TRIP `docs/agents/backtests/fp246/trip_oos.json`, sha256 `10a7fdf1…`. 2023 reproduces: 55 trades, +$98.165. Entries 2024-01-01 through 2026-09-22: 123 trades, −$51.1106, mean −$0.415533, null p95 +$0.6731 on 996 three-day coin-margined longs. 2024 is −$8.824 and 2025-01-01 through 2026-09-22 is −$42.2866. Doubled costs are −$75.5839. November 2024 is +$27.3743; without it the total is −$78.4849. Annualised over 998 days it is −0.186928. CFAL `docs/agents/backtests/fp247/cfal_oos.json`, sha256 `1679d359…`. 2023 reproduces: 64 trades, +$485.7511. Entries 2024-01-01 through 2026-09-07: 215 trades, +$95.8119, mean +$0.445637, null p95 +$2.444 on 981 eighteen-day USDT longs. 2024 is +$362.9586 and 2025-01-01 through 2026-09-07 is −$267.1467. Doubled costs are +$52.6633. August 2026 is +$101.8726, 106.33% of the total. Annualised over 998 days it is 0.350414. The buys and the sells were not moved. The null holds stayed three and eighteen days. Both rules fail. Neither is a testing row. Reference §3.283 and §3.284. The count stays 30. HI10 and STEP stay failed. CMF and QNEW stay failed. MTH stays void. No pull request. Main was not pushed.

**fp241–fp248 are scored. TRIP and CFAL passed the 2023 screen and then failed the later years. The other six fail the 2023 screen. None is a testing row.** The protocol was `6f1213a`, pushed before any of these returns. Two runs of each screen matched. DROP 150 / file gross +469.2306 / file mean +448.313 / null +566.0566 / +$672.4695 (`a99c2d50…`). UPRI 198 / file gross −242.8102 / file mean −262.305 / null −170.1131 / −$519.364 (`ea3818b9…`). AHEAD 171 / file gross +392.992 / file mean +372.2267 / null +437.1806 / +$636.5077 (`2c5f17ad…`). CALM 161 / file gross +108.6554 / file mean +88.4583 / null +230.6992 / +$142.4179 (`cdf7e8e5…`). CDEC 123 / file gross −219.8468 / file mean −239.3876 / null −259.8823 / −$294.4467 (`d1969fae…`). TRIP 55 / file gross +198.8592 / file mean +178.4819 / null +151.7253 / +$98.165 (`65e67393…`). CFAL 64 / file gross +780.5256 / file mean +758.9861 / null +704.8709 / +$485.7511 (`6b1fd9b5…`). BOUN 53 / file gross +593.8978 / file mean +572.7312 / null +820.5322 / +$303.5475 (`e915e5d9…`). TRIP and CFAL cleared the three screen bars and then failed the later years. UPRI is negative and under its null. CDEC is negative and above its null. DROP, AHEAD, CALM and BOUN are positive and under their nulls. Each null is that single-leg payoff with the extra condition off, held the same number of days. Funding cash is not added. The scored counts match the pre-freeze counts: 150, 198, 171, 161, 123, 55, 64, 53. HI10 and STEP stay failed on the later years. CMF and QNEW stay failed. MTH stays void. The count stays 30. No pull request. Main was not pushed.

**HI10 and STEP fail the pre-registered later years. Neither is a testing row.** The pre-registrations were `e951ce4`, pushed before any later-year return. Each test was run twice and the copies matched. HI10 `docs/agents/backtests/fp233/hi10_oos.json`, sha256 `12c437e4…`. 2023 reproduces: 74 trades, +$273.3478. Entries 2024-01-01 through 2026-09-17: 184 trades, +$68.0852, mean +$0.370028, null p95 +$1.3145 on 991 eight-day spot longs. 2024 is +$131.5458 and 2025-01-01 through 2026-09-17 is −$63.4606. Doubled costs are +$31.1858. February 2024 is +$119.2415, 175.14% of the total. Annualised over 998 days it is 0.249009. STEP `docs/agents/backtests/fp237/step_oos.json`, sha256 `c1898b1e…`. 2023 reproduces: 112 trades, +$210.0476. Entries 2024-01-01 through 2026-09-21: 269 trades, +$0.7254, mean +$0.002697, null p95 +$0.5928 on 995 four-day longs. 2024 is +$47.7475 and 2025-01-01 through 2026-09-21 is −$47.0222. Doubled costs are −$53.0225. February 2024 is +$40.9587, 56.4667 times the total. Annualised over 998 days it is 0.002653. The buys and the sells were not moved. The null holds stayed eight and four days. Both rules fail. Neither is a testing row. Reference §3.273 and §3.274. The count stays 30. CMF and QNEW stay failed. MTH stays void. No pull request. Main was not pushed.

**fp233–fp240 are scored. HI10 and STEP pass the 2023 screen and are not testing rows. The other six fail.** The protocol was `55f8480`, pushed before any of these returns. Two runs of each screen matched. HI10 74 / file gross +390.1485 / file mean +369.3889 / null +329.1859 / +$273.3478 (`8e98355f…`). UMSH 82 / file gross −82.8535 / file mean −102.668 / null −139.9677 / −$84.1878 (`762e961e…`). TRI 203 / file gross +195.9277 / file mean +175.5563 / null +244.2694 / +$356.3792 (`566b04fa…`). BNC 59 / file gross +331.2037 / file mean +310.5619 / null +479.0876 / +$183.2315 (`289e9e51…`). STEP 112 / file gross +207.938 / file mean +187.5425 / null +158.3111 / +$210.0476 (`ff0517d5…`). GAP 96 / file gross +198.6343 / file mean +178.2574 / null +235.1411 / +$171.1271 (`6c37947a…`). QUIET 179 / file gross +352.6189 / file mean +331.9343 / null +451.1356 / +$594.1624 (`d169cae5…`). LEAD 177 / file gross +196.1993 / file mean +175.8273 / null +178.24 / +$311.2143 (`d26ae687…`). HI10 and STEP clear the three screen bars. Their later years are not scored, so neither is a testing row. UMSH is negative and above its null. TRI, BNC, GAP, QUIET and LEAD are positive and under their nulls. Each null is that single-leg payoff with the extra condition off, held the same number of days. Funding cash is not added. The scored counts match the pre-freeze counts: 74, 82, 203, 59, 112, 96, 179, 177. CMF and QNEW stay failed on the later years. MTH stays void. The count stays 30. No pull request. Main was not pushed.
...
**fp201–fp208 fail the 2023 screen. None is a testing row.** The protocol was `613a78c`, pushed before any of these returns. Two runs of each screen matched. TAKMK 173 trades, −$70.8887. UMVW 189 trades, −$90.908. CMIDX 183 trades, −$93.9931. MKCM 190 trades, −$66.2763, gross positive and the mean negative and under the null. UMRICH 81 trades, −$27.2918. CMFN 50 trades, −$9.9941. UMX 73 trades, −$54.213. MKUM 182 trades, −$40.5152, the mean negative and above its null. Each null is that rule's own payoff with the filter off, not an unconditional long. The count stays 30. No rule was rewritten. fp193–fp200 were not flipped into longs. The book was not read. The three missing book days were not filled in. No pull request. Main was not pushed.

**fp193–fp200 fail the 2023 screen. None is a testing row.** The protocol was `4fb0448`, pushed before any of these returns. Two runs of each screen matched. ASKSH 112 trades, −$69.3663. IDXSH 177 trades, −$98.5994. VWAPH 120 trades, −$39.3308, gross positive and the mean negative. CMH 151 trades, −$48.7695, gross positive and the mean negative. ON16 124 trades, −$24.7688. COISH 185 trades, −$91.0925. MRKSH 184 trades, −$64.2124. TAKSP 202 trades, −$69.6737, gross positive and the mean negative. Each null is that rule's own payoff with the filter off, not an unconditional long. The count stays 30. No rule was rewritten. The three missing book days were not filled in. fp185–fp192 stay closed. No pull request. Main was not pushed.
...
### [2026-09-25 23:31 UTC] Platform: Cursor | Model: Grok 4.7

The later years of SPQTR and FDCSH are scored. The pre-registration was `7ba71b7`, pushed before either return. Two runs matched. SPQTR reproduces 2023 and clears the later bar: 395 trades, mean +144.2213 bp, gap 142.7861 bp, +$569.674 (`2ae6ce0b…`). Both sub-windows are positive, doubled costs are positive, and April 2024 is 15.44%. FDCSH reproduces 2023 and has 0 later trades (`9caed9a2…`). The cheapest on-hour premium is −25.3746 bp. Neither is a testing row. Reference §3.390. No pull request. Main was not pushed.

### [2026-09-25 23:23 UTC] Platform: Cursor | Model: Grok 4.7

fp332–fp334 are scored. The protocol was `60b1b33`, pushed before any return. Two runs of each screen matched. SPQTR mean +93.2947 bps, 84.0121 bps above its null (`d137286d…`). PEPRM mean −30.847 bps, 2.789 bps under its null (`93512407…`), not taken out of sample. FDCSH mean +88.5634 bps, 125.4695 bps above its null (`42030f61…`). SPQTR and FDCSH are pre-registered. No later-year return has been computed. Reference §3.390. No pull request. Main was not pushed.

### [2026-09-25 23:18 UTC] Platform: Cursor | Model: Grok 4.7

fp332, fp333 and fp334 are frozen before any return. The scored number is the change in a discount, or the funding cash, not the coin's open-to-open move. SPQTR is 125 against 240 at a 100 bp previous close basis. PEPRM is 48 against 191 at a 50 bp previous close premium. FDCSH is 85 against 815, on 36 entry days, at a completed-interval premium of −50 bp. The other Binance-book identities that were counted did not clear 30 cheap days, or had no grid point above the forty-basis-point round trip, and were not scored. No screen file exists yet. No pull request. Main was not pushed.

### [2026-09-25 22:03 UTC] Platform: Cursor | Model: Grok 4.7

Same-unit price files were searched for a series that overlaps a 2023 daily book for 30 days and is already 25 bp cheap on 30 days. None was found. The count is zero. Electricity, power, terawatt-hours and miner revenue were not opened again. No cause was written and nothing was scored. Reference §3.389. No pull request. Main was not pushed.

### [2026-09-25 21:51 UTC] Platform: Cursor | Model: Grok 4.7

Fair-value files were downloaded and the overlap was counted before any cause was written. Cambridge's open CSV is terawatt-hours, not USD per BTC. The cost-of-minting chart answers HTTP 400. A third-party minting-cost file overlaps BTCUSDT on 365 days and is 25 bp cheap on 0 of 364 days. The richest discount is −3095.0454 bps. Nothing was frozen and nothing was scored. Reference §3.388. No pull request. Main was not pushed.

### [2026-09-25 21:32 UTC] Platform: Cursor | Model: Grok 4.7

The redemption search was continued and still none was scored. ANT's redeemer bytecode contains 0.0025376 ETH per token. The contract holds 0 ETH before 2023-11-01 and 14774.950418290462 ETH before 2023-11-03. Three of 59 later days are 25 bp cheap. The largest discount is 47.7354 bps. MC and BEAMX have no overlapping day. Ten project ids on the earn exchange-rate URL return one series. QUEEN has no Binance open. No return was computed. Reference §3.387. No pull request. Main was not pushed.

### [2026-09-25 21:15 UTC] Platform: Cursor | Model: Grok 4.7

Issuer redemption prices were searched and none was scored. PEOPLE's overflow bid is 1.009746439e-6 ETH per token before 2023-06-01 and 1.009743209e-6 before 2023-09-03; that day's discount is −8178.8552 bps, and zero of 365 days are 25 bp cheap under a 1.05e-6 bound. Leveraged-token net asset value is not in the vision bucket, and the live NAV hosts are 404 or 451. BDOT is par and the book stops when redemption opens. The WBETH rate URL is the series already scored. No return was computed. Reference §3.386. No pull request. Main was not pushed.

### [2026-09-25 19:13 UTC] Platform: Cursor | Model: Grok 4.7

fp324–fp331 are reviewed. GLDPM and ECBFX are two sentences. BMACP, CPIPP, PPIPP, WAGPP, CLTHP and AIRPP are one purchasing-power sentence with the basket changed. The next round does not repeat purchasing power, another price index, gold divided by a stablecoin, or an ECB rate divided by a stablecoin. Realised price, token par, a funding sign, and another venue's close stay banned. A later rule is not run until it names who is wrong, why the open is below an already published fair value, that the discount and the fill are the same unit, and that the discount already exceeded the round-trip fee. Swapping basket, exchange, threshold, or coin to fill eight is refused. No such eight were written, so none was run. Reference §3.385. No pull request. Main was not pushed.

### [2026-09-25 18:04 UTC] Platform: Cursor | Model: Grok 4.7

fp324–fp331 are scored. All eight means are negative. None is taken out of sample and none is a testing row. The protocol was `a90b9b4`, pushed before any of these returns. Two runs of each screen matched. GLDPM −14.7014 bps (`55fb3385…`). ECBFX −12.8846 (`04137c22…`). BMACP −11.7161 (`d38be64f…`). CPIPP −4.8185 (`c0e82f54…`), 16.2028 bps above its null and inside 20. PPIPP −16.7776 (`8871e2dc…`). WAGPP −27.9384 (`50fa607e…`), under its null. CLTHP −16.1382 (`62e7321d…`). AIRPP −12.6225 (`09ce00a4…`). The counts match the freeze. No threshold was moved. Reference §3.377–§3.384. The sentence in §3.376 that no return had been computed is left in place. No pull request. Main was not pushed.

### [2026-09-25 18:02 UTC] Platform: Cursor | Model: Grok 4.7

Eight published prices are frozen before any return. The previous round was three sentences: a realised coin price, a wrapper exchange rate, and par of one. Copying those sentences was refused, and that refusal is not a smaller round. GLDPM is the LBMA Gold Price PM over Coin Metrics BUSD on PAXGBUSD, 50 bp, 154/157. ECBFX is the ECB US dollars per euro over BUSD on EURBUSD, 25 bp, 160/182. BMACP is the US Big Mac price over the euro-area Big Mac price, over BUSD, 200 bp, 148/194. CPIPP is US CPI-U over euro-area HICP, 1 bp, 107/212. PPIPP is US finished-goods PPI over euro-area producer prices, 500 bp, 130/173. WAGPP is US average hourly earnings over the euro-area calendar-adjusted wage index, 500 bp, 93/160. CLTHP is US apparel over euro-area clothing and footwear, 1000 bp, 120/199. AIRPP is US airline fares over euro-area passenger air, 1 bp, 146/173. Holds are two days. The cheap set is the shorter one. The short side was not taken. No return of these rules has been computed. Protocols `docs/agents/reviews/2026-09-25-fp324-protocol.md` through `fp331`. Reference §3.376. No pull request. Main was not pushed.

### [2026-09-25 16:00 UTC] Platform: Cursor | Model: Grok 4.7

**EREAL fails the pre-registered later years.** The pre-registration was `577ba4f`. Two runs matched. 2023 reproduces. The later gap is 5.4189 bps, 2024 has no entry, and May 2025 is 58.61% of the total. EREAL is not a testing row. WBRAT and WBPAR stay inside 2023. The next rules are not frozen. Reference §3.375. No pull request. Main was not pushed.

### [2026-09-25 15:56 UTC] Platform: Cursor | Model: Grok 4.7

**EREAL is pre-registered. No later-year return has been computed.** The 2023 gap is 216.3812 bps. The kept book is bid 2673.58, ask 2673.59. The last entry is 2026-09-23. WBRAT and WBPAR are not pre-registered. Reference §3.374. No pull request. Main was not pushed.

### [2026-09-25 15:54 UTC] Platform: Cursor | Model: Grok 4.7

**fp321–fp323 are scored. EREAL clears 2023 by 216.3812 bps. WBRAT and WBPAR fail.** The protocol was `c824fd5`. Two runs matched. EREAL's later years are not scored in this commit. WBRAT and WBPAR are negative. The scored counts match the pre-freeze counts. No rule was changed. None is a testing row. Reference §3.371–§3.373. No pull request. Main was not pushed.

### [2026-09-25 15:52 UTC] Platform: Cursor | Model: Grok 4.7

**fp321–fp323 are frozen. No return of these rules has been computed.** Three same-unit discounts, not eight copies. Counts with no profit: 31/325, 43/189, 167/196. Reference §3.370. No pull request. Main was not pushed.

### [2026-09-25 15:33 UTC] Platform: Cursor | Model: Grok 4.7

**fp313–fp320 are reviewed. The four that clear 2023 are not taken out of sample.** The eight rules are two funding sentences copied across books. The open's discount in basis points was not computed. The control is the same side with the edge off, not the opposite side. No book ticker was frozen. The next eight are not frozen yet. Reference §3.369. No pull request. Main was not pushed.

### [2026-09-25 15:23 UTC] Platform: Cursor | Model: Grok 4.7

**fp313–fp320 are scored. Four clear 2023 by more than 20 bps and are not yet taken out of sample.** The protocol was `24e60b7`. Two runs matched. UZERO, CZERO, USOFR and MSOFR clear. EZERO, BZERO, CSOFR and ESOFR do not. The scored counts match the pre-freeze counts. No rule was changed. None is a testing row. The next eight are not frozen. Reference §3.361–§3.368. No pull request. Main was not pushed.

### [2026-09-25 15:17 UTC] Platform: Cursor | Model: Grok 4.7

**fp313–fp320 are frozen. No return of these rules has been computed.** Fair value is settled funding against the index, or settled funding against the published SOFR carry. Another venue's close is not an input. Counts with no profit computed: 36/328, 37/321, 40/318, 102/262, 126/238, 76/282, 120/244, 84/274. The screen count stays 30. No pull request. Main was not pushed.

### [2026-09-25 14:47 UTC] Platform: Cursor | Model: Grok 4.7

**fp305–fp312 are scored. All eight fail the 2023 screen. None is taken out of sample.** The protocol was `cf2f128`. Two runs matched. BSTCH, MEXCH, OKXCH, GATCH, KUCCH, HTXCH and WBTCH are positive and under their nulls. BFXRH is negative and under its null. OKXCH's house p95 equals the edge-off mean because the sets have the same length. The scored counts match the pre-freeze counts. No rule was changed. None is a testing row. The next eight are not frozen. Reference §3.352–§3.359. No pull request. Main was not pushed.


### [2026-09-25 14:44 UTC] Platform: Cursor | Model: Grok 4.7

**fp305–fp312 are frozen. No return of these rules has been computed.** Eight new public fair values, one side each. Coinbase and Deribit are not reused. A book ticker is not read. Counts with no profit computed: 174/183, 163/191, 157/193, 176/176, 178/180, 170/176, 171/185, 168/182. The screen count stays 30. No pull request. Main was not pushed.


### [2026-09-25 14:29 UTC] Platform: Cursor | Model: Grok 4.7

**fp297–fp304 are scored. DBCHP passes 2023 by 1.0902 bps and stays inside 2023. The other seven fail.** The protocol was `21d193c`. Two runs matched. DBCHP 172, +$556.9747, mean +323.8225 against a house p95 of +322.7323. The edge-off mean +299.0321 was not the cutoff. The gap is inside 20 bps, so the later years are not scored. CBCHP, CBSPT and DBCMC are positive and under their nulls. CBRCH, CBWDN and DBWDN are negative and under their nulls. DBRCH is negative and above its null. The scored counts match the pre-freeze counts. No rule was changed. DISCU is not pre-registered. None is a testing row. Reference §3.343–§3.350. No pull request. Main was not pushed.


### [2026-09-25 14:27 UTC] Platform: Cursor | Model: Grok 4.7

**fp297–fp304 are frozen. No return of these rules has been computed.** Fair value is the Coinbase Exchange BTC-USD daily close or the Deribit BTC-PERPETUAL daily close. A close is used only after its bucket has ended, and only when that end is strictly earlier than the Binance entry open. DISCU is not pre-registered. Counts with no profit computed: 174/183, 170/184, 173/179, 132/226, 172/183, 169/172, 167/184, 133/223. The three Binance lines are not each other's fair value. The screen count stays 30. No pull request. Main was not pushed.


### [2026-09-25 14:12 UTC] Platform: Cursor | Model: Grok 4.7

**fp289–fp296 are scored. DISCU passes 2023 by 25.559 bps. The other seven fail.** The protocol was `94b463a`. Two runs matched. DISCU 84, +$304.7494, mean +362.7969 against a house p95 of +337.2379 on 273 edge-off trades. The edge-off mean +213.9465 was not the cutoff. RICHU 57, −$175.7903. CHEAPS 55, +$216.6435, under its null. WIDEN 46, −$69.0234. CHEAPC 93, +$372.3847, under its null by 12.8119 bps. DISCM 89, +$175.6775, under its null. GAPCM 148, −$490.0487. RICHC 87, −$178.1943. The scored counts match the pre-freeze counts. No rule was changed. DISCU is not pre-registered in this commit. None is a testing row. Reference §3.334–§3.341. No pull request. Main was not pushed.

### [2026-09-25 14:09 UTC] Platform: Cursor | Model: Grok 4.7

**fp289–fp296 are frozen. No return of these rules has been computed.** Two price edges. Counts with no profit computed: 84/273, 57/297, 55/297, 46/312, 93/253, 89/267, 148/195, 87/254. The other trade is the same leg with the edge turned off. fp281–fp288 stay inside 2023. The screen count stays 30. No pull request. Main was not pushed.

### [2026-09-25 14:05 UTC] Platform: Cursor | Model: Grok 4.7

**fp281–fp288 are scored. They pick a side. None is taken out of sample.** The protocol was `70c5966`. Two runs matched. PEAK 54, +$158.1967, mean +292.9569 against +225.6317. REBND 88, +$217.6004, mean +247.2732 against +73.1577. DROPCM 81, −$285.0862. TRIO 201, +$1129.207, a gap of 0.6459 bps. SOFTER 91, −$468.4753. RESUME 51, +$33.9656, a gap of 32.1049 bps. LESSUP 94, +$725.9814, a gap of 2.8692 bps. LIFTL 134, +$465.7697, a gap of 30.3763 bps. The scored counts match the pre-freeze counts. No rule was changed. None names a price edge, so none is pre-registered. Reference §3.325–§3.332. No pull request. Main was not pushed.

### [2026-09-25 14:01 UTC] Platform: Cursor | Model: Grok 4.7

**fp281–fp288 are frozen. No return of these rules has been computed.** RISE and LAGSP stay inside 2023. A mean that clears the other trade by 20 bps or less is not taken out of sample. Counts with no profit computed: 54, 88, 81, 201, 91, 51, 94, 134. None uses the opposite side as the other trade. The screen count stays 30. No pull request. Main was not pushed.

### [2026-09-25 13:53 UTC] Platform: Cursor | Model: Grok 4.7

**fp273–fp280 are scored. RISE and LAGSP pass the 2023 screen and are not testing rows. The other six fail.** The protocol was `1057661`, pushed before any of these returns. Two runs of each screen matched. DRIFT 131, +$302.6308, mean +231.0159 against +278.6329. ABOVE 51, −$255.5847. DEEPCM 134, −$606.6543. BOTHUP 187, +$1587.7233, mean +849.0499 against +849.9417. COOLED 66, +$82.5106. BOTHDOWN 141, −$798.0351. RISE 225, +$135.6487, mean +60.2883 against +48.0585, a gap of 12.2298 bps. LAGSP 174, +$1144.5975, mean +657.8146 against +657.6838, a gap of 0.1308 bps. The scored counts match the pre-freeze counts. No rule was changed. The later years are not scored. Neither pass is a testing row. LOUDER stays void. LASTUP stays void. Reference §3.316–§3.323. No pull request. Main was not pushed.

### [2026-09-25 13:50 UTC] Platform: Cursor | Model: Grok 4.7

**fp273–fp280 are frozen. No return of these rules has been computed.** LOUDER is void. LASTUP stays void. The other six from the previous round are not taken out of sample. Counts with no profit computed: 131, 51, 134, 187, 66, 141, 225, 174. None uses the opposite side as the other trade. The screen count stays 30. No pull request. Main was not pushed.

### [2026-09-25 13:45 UTC] Platform: Cursor | Model: Grok 4.7

**LOUDER fails the pre-registered later years and is void.** Two runs matched. 499 trades, +$977.9158, mean +$1.959751. The quieter set has 479 trades, so the sample p95 is missing and was not replaced with its mean of +$1.562082. 2024 is +$1028.8694 and 2025-01-01 through 2026-09-04 is −$50.9536. February 2024 is 47.87% of the total. The buy and the sell were not moved. It is not a testing row. The next eight are not frozen yet. Reference §3.314. No pull request. Main was not pushed.

### [2026-09-25 13:43 UTC] Platform: Cursor | Model: Grok 4.7

**LOUDER is pre-registered. No later-year return has been computed.** LASTUP is void because the other trade was the same-day short. UNDER and STALE stay inside 2023. Their gaps are 4.2411 bps and 0.6983 bps. FASTER, BACK, INUP and LEDSP stay negative and are not taken out of sample. The USDT book was read at 2026-09-25T13:39:52.405491Z (bid 84066.00, ask 84066.10). The cutoff stays the sample p95, not the quieter mean. The buy and the sell were not moved. No pull request. Main was not pushed.

### [2026-09-25 13:36 UTC] Platform: Cursor | Model: Grok 4.7

**fp265–fp272 are scored. LASTUP, UNDER, LOUDER and STALE pass the 2023 screen and are not testing rows. The other four fail.** The protocol was `dd2cb6e`, pushed before any of these returns. Two runs of each screen matched. LASTUP 63, +$254.9808, mean +404.7314 against the other trade's −355.5073. UNDER 206, +$921.8302, mean +447.4904 against +443.2493. LOUDER 170, +$1021.9923, mean +601.172 against a house cutoff of +551.9241 on 175 quieter trades. STALE 89, +$79.2071, mean +88.9967 against +88.2984. FASTER 118, −$153.7733. INUP 69, −$400.9023. BACK 123, −$57.2219. LEDSP 169, −$1073.4749. The scored counts match the pre-freeze counts. No rule was changed. The later years are not scored. None is a testing row. PICK stays out of testing. LATER stays void. Reference §3.305–§3.312. No pull request. Main was not pushed.

### [2026-09-25 13:34 UTC] Platform: Cursor | Model: Grok 4.7

**fp265–fp272 are frozen. No return of these rules has been computed.** PICK is not a testing row and not a Revolut X paper candidate. The other trade was about one cent ahead, 2025-01-01 through 2026-09-16 is +$0.6733, and the fill is a Binance daily open, not a price this account can get. LATER is void. Counts taken before this freeze, with no profit computed: 63, 206, 118, 170, 89, 69, 123, 169. The screen count stays 30. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. No pull request. Main was not pushed.

### [2026-09-25 13:23 UTC] Platform: Cursor | Model: Grok 4.7

**PICK passes the pre-registered later years and is not a testing row. LATER fails them and is void.** Two runs of each test matched. PICK 475 trades, +$477.1037, mean +$1.004429 against the other trade's +$0.9919. 2024 is +$476.4304 and 2025-01-01 through 2026-09-16 is +$0.6733. Doubled costs +$381.2452. February 2024 is 36.53% of the total. Annualised 1.744918. LATER 252 trades, +$148.8984, mean +$0.590867 against +$0.8883. 2024 is +$299.3036 and 2025-01-01 through 2026-08-26 is −$150.4052. February 2024 is 100.82% of the total; without it the total is −$1.2272. The nulls stayed the other trade. The buys and the sells were not moved. Neither is a testing row. The next eight were not started. Reference §3.302 and §3.303. No pull request. Main was not pushed.
...
### [2026-09-25 13:09 UTC] Platform: Cursor | Model: Grok 4.7

**fp257–fp264 are scored. PICK and LATER pass the 2023 screen and are not testing rows. The other six fail.** The protocol was `73270f4`, pushed before any of these returns. Each screen file was written twice and the copies matched. PICK 156 / file gross +253.7089 / file mean +233.222 / null +230.2271 / +$363.8263 (`314500be…`). FADEU 214 / file gross −229.1096 / file mean −248.6318 / null +288.6992 / −$532.0721 (`0d9d4de4…`). DEFER 144 / file gross −274.0383 / file mean −293.4708 / null −203.409 / −$422.5979 (`5db612af…`). CMLAG 170 / file gross +551.3345 / file mean +530.253 / null +533.5308 / +$901.43 (`6b1705a1…`). LAGB 169 / file gross −138.7768 / file mean −158.4795 / null −160.716 / −$267.8303 (`9876b165…`). OTHER 108 / file gross +362.7863 / file mean +342.0814 / null +351.58 / +$369.448 (`ae1db46c…`). LATER 87 / file gross +458.4657 / file mean +437.5697 / null +329.1846 / +$380.6856 (`f8392a33…`). AFTER 154 / file gross +495.1066 / file mean +474.1374 / null +476.1511 / +$730.1716 (`457e995d…`). PICK and LATER clear the three screen bars. Their later years are not scored, so neither is a testing row. FADEU and DEFER are negative and under their nulls. LAGB is negative and above its null. CMLAG, OTHER and AFTER are positive and under their nulls. Every fill is one leg on a price that exists on that contract. Each null is the other trade, held the same number of days. The scored counts match the pre-freeze counts: 156, 214, 144, 170, 169, 108, 87, 154. No rule was changed after the freeze. A Binance daily open is not a Revolut X fill. The count stays 30. Reference §3.294–§3.301. No pull request. Main was not pushed.

### [2026-09-25 13:07 UTC] Platform: Cursor | Model: Grok 4.7

**fp257–fp264 are protocols only. No return of these rules has been computed.** Pins printed fp257 through fp264 pins ok. `FP257_OOS` aborts the pull and the scorer. Counts taken before this freeze, with no profit computed: PICK 156 (other trade 156), FADEU 214 (214), DEFER 144 (144), CMLAG 170 (170), LAGB 169 (169), OTHER 108 (240), LATER 87 (87), AFTER 154 (154). OTHER's shorter regime is the rule. The five-day and fifteen-day windows were not moved. Each position is one leg. Each null is the other trade, held the same number of days, not the same leg with the condition off. A missing open is not taken from another book. The count stays 30. A Binance daily open is not a Revolut X fill. No pull request. Main was not pushed.

### [2026-09-25 12:59 UTC] Platform: Cursor | Model: Grok 4.7

**A Binance daily open that clears a numerical gate is not a Revolut X fill.** Davies said so on 2026-09-25. Passing that gate does not mean Revolut X can trade it. The result is not a Revolut X paper-testing candidate. A nearby signal is not substituted to force a pass. A rule still has to know its signal before the entry. The fill has to be a price that exists on that contract. LS-FADE's 60-trade reproduction, the control, and doubled costs are not relaxed. No testing row is added. LS-FADE stays failed (§3.34) and is not rewritten. This search's screen count stays 30. Reference §3.293. No pull request. Main was not pushed.

### [2026-09-25 12:42 UTC] Platform: Cursor | Model: Grok 4.7

**fp249–fp256 fail the 2023 screen. None is a testing row.** The protocol was `dfa98e6`, pushed before any of these returns. Each screen file was written twice and the copies matched. JOIN 152 / file gross +496.1709 / file mean +475.1995 / null +621.3966 / +$722.3032 (`9706cbfc…`). FADE 61 / file gross −599.9496 / file mean −618.731 / null −385.7913 / −$377.4259 (`e7f5e940…`). LAGU 172 / file gross −319.8428 / file mean −339.1838 / null −299.0266 / −$583.3961 (`6b2e7f8a…`). INNER 238 / file gross +550.4338 / file mean +529.3541 / null +631.1015 / +$1259.8627 (`e85e99ef…`). FLIP 93 / file gross +571.2084 / file mean +550.0871 / null +755.778 / +$511.581 (`19c4e30c…`). NEWUP 83 / file gross +547.6233 / file mean +526.5491 / null +859.5851 / +$437.0358 (`f74f3224…`). TWOD 80 / file gross −430.4524 / file mean −449.5724 / null −272.4165 / −$359.6579 (`e3e98044…`). ECHO 102 / file gross +828.9158 / file mean +807.2796 / null +826.0551 / +$823.4252 (`1e47bd94…`). JOIN, INNER, FLIP, NEWUP and ECHO are positive and under their nulls. FADE, LAGU and TWOD are negative and under their nulls. Every fill is one leg. Each null is that payoff with the extra condition off, held the same number of days. Funding cash is not added. The scored counts match the pre-freeze counts: 152, 61, 172, 238, 93, 83, 80, 102. No rule was changed. A three-day spot decline against a three-day USDT rise had 0 spans and was not scored. None of these is a testing row. The later years are not scored. TRIP and CFAL stay failed on the later years and are not testing rows. HI10 and STEP stay failed. CMF and QNEW stay failed. MTH stays void. The count stays 30. Reference §3.285–§3.292. No pull request. Main was not pushed.

### [2026-09-25 12:41 UTC] Platform: Cursor | Model: Grok 4.7

**fp249–fp256 are protocols only. No return of these rules has been computed.** The protocol commit is `dfa98e6`. Pins printed fp249 through fp256 pins ok. `FP249_OOS` aborts the pull and the scorer. Counts taken before this freeze, with no profit computed: JOIN 152 (pool 347), FADE 61 (pool 332), LAGU 172 (pool 349), INNER 238 (pool 338), FLIP 93 (pool 344), NEWUP 83 (pool 335), TWOD 80 (pool 347), ECHO 102 (pool 341). A three-day spot decline against a three-day USDT rise had 0 spans. It was not scored. JOIN buys the USDT perpetual for nineteen days after spot and the coin-margined book both finished a four-day decline. FADE shorts the coin-margined perpetual for twenty-six days after a finished ten-day USDT rise that was smaller than the ten-day rise before it. LAGU shorts the USDT perpetual for seventeen days after spot's finished six-day return lagged the USDT return. INNER buys the coin-margined perpetual for twenty days after the absolute five-day spot return finished smaller than the absolute twenty-day return. FLIP buys spot for twenty-two days after a finished down day and then a finished up day. NEWUP buys the coin-margined perpetual for twenty-three days after a finished three-day spot rise that followed a three-day window that was not a rise. TWOD shorts spot for nineteen days after two finished down days. ECHO buys the USDT perpetual for twenty-five days after a coin-margined rise that had already finished and a later four-day spot rise. Each position is one leg. Each null is that payoff with the extra condition off, held the same number of days. The count stays 30. No percentile is used. No sign of a killed rule is flipped. TRIP and CFAL were not rewritten. HI10 and STEP stay failed. CMF and QNEW stay failed. MTH stays void. No pull request. Main was not pushed.

### [2026-09-25 12:33 UTC] Platform: Cursor | Model: Grok 4.7

**TRIP and CFAL fail the pre-registered later years. Neither is a testing row.** The pre-registrations were `efec1d8`, pushed before any later-year return. Each test was run twice and the copies matched. TRIP `docs/agents/backtests/fp246/trip_oos.json`, sha256 `10a7fdf1…`. 2023 reproduces: 55 trades, +$98.165. Entries 2024-01-01 through 2026-09-22: 123 trades, −$51.1106, mean −$0.415533, null p95 +$0.6731 on 996 three-day coin-margined longs. 2024 is −$8.824 and 2025-01-01 through 2026-09-22 is −$42.2866. Doubled costs are −$75.5839. November 2024 is +$27.3743; without it the total is −$78.4849. Annualised over 998 days it is −0.186928. CFAL `docs/agents/backtests/fp247/cfal_oos.json`, sha256 `1679d359…`. 2023 reproduces: 64 trades, +$485.7511. Entries 2024-01-01 through 2026-09-07: 215 trades, +$95.8119, mean +$0.445637, null p95 +$2.444 on 981 eighteen-day USDT longs. 2024 is +$362.9586 and 2025-01-01 through 2026-09-07 is −$267.1467. Doubled costs are +$52.6633. August 2026 is +$101.8726, 106.33% of the total. Annualised over 998 days it is 0.350414. The buys and the sells were not moved. The null holds stayed three and eighteen days. Both rules fail. Neither is a testing row. Reference §3.283 and §3.284. The count stays 30. HI10 and STEP stay failed. CMF and QNEW stay failed. MTH stays void. No pull request. Main was not pushed.

### [2026-09-25 12:25 UTC] Platform: Cursor | Model: Grok 4.7

**TRIP and CFAL pre-registrations are frozen. No later-year return of either rule has been computed.** The 2023 screens stay as scored at `7177882`. TRIP is `docs/agents/reviews/2026-09-25-fp246-prereg-trip.md`, sha256 `a6760c1a…`, frozen 2026-09-25T12:24:44Z. The book is BTCUSD_PERP bid 84187.9, ask 84188.0, half-spread 5.939092233854178e-07, read at 2026-09-25T12:24:36.772Z. The last entry is 2026-09-22. The exit open is 2026-09-25 and is not an entry. A bar on 2026-09-26 is not requested. Spot closes used as the signal stop on 2026-09-21. CFAL is `docs/agents/reviews/2026-09-25-fp247-prereg-cfal.md`, sha256 `4952f9d1…`, frozen at the same time. The book is the BTCUSDT USDT perpetual, bid 84212.8, ask 84212.9, half-spread 5.937336166111754e-07, read at 2026-09-25T12:24:37.190Z. The last entry is 2026-09-07. The exit open is 2026-09-25 and is not an entry. Coin-margined closes used as the signal stop on 2026-09-06. The null hold stays three days for TRIP and eighteen days for CFAL. The count stays 30. No daily open from 2024-01-01 has been read as an entry. Neither file arms a testing row. HI10 and STEP stay failed. CMF and QNEW stay failed. MTH stays void. The other six of fp241–fp248 stay failed on 2023. No pull request. Main was not pushed.

### [2026-09-25 12:23 UTC] Platform: Cursor | Model: Grok 4.7

**fp241–fp248 are scored. TRIP and CFAL pass the 2023 screen and are not testing rows. The other six fail.** The protocol was `6f1213a`, pushed before any of these returns. Each screen file was written twice and the copies matched. DROP 150 / file gross +469.2306 / file mean +448.313 / null +566.0566 / +$672.4695 (`a99c2d50…`). UPRI 198 / file gross −242.8102 / file mean −262.305 / null −170.1131 / −$519.364 (`ea3818b9…`). AHEAD 171 / file gross +392.992 / file mean +372.2267 / null +437.1806 / +$636.5077 (`2c5f17ad…`). CALM 161 / file gross +108.6554 / file mean +88.4583 / null +230.6992 / +$142.4179 (`cdf7e8e5…`). CDEC 123 / file gross −219.8468 / file mean −239.3876 / null −259.8823 / −$294.4467 (`d1969fae…`). TRIP 55 / file gross +198.8592 / file mean +178.4819 / null +151.7253 / +$98.165 (`65e67393…`). CFAL 64 / file gross +780.5256 / file mean +758.9861 / null +704.8709 / +$485.7511 (`6b1fd9b5…`). BOUN 53 / file gross +593.8978 / file mean +572.7312 / null +820.5322 / +$303.5475 (`e915e5d9…`). TRIP and CFAL clear the three screen bars. Their later years are not scored, so neither is a testing row. UPRI is negative and under its null. CDEC is negative and above its null. DROP, AHEAD, CALM and BOUN are positive and under their nulls. Every fill is one leg. Each null is that payoff with the extra condition off, held the same number of days. Funding cash is not added. The scored counts match the pre-freeze counts: 150, 198, 171, 161, 123, 55, 64, 53. No rule was changed. HI10 and STEP stay failed on the later years and are not testing rows. CMF and QNEW stay failed. MTH stays void. The count stays 30. Reference §3.275–§3.282. No pull request. Main was not pushed.

### [2026-09-25 12:21 UTC] Platform: Cursor | Model: Grok 4.7

**fp241–fp248 are protocols only. No return of these rules has been computed.** HI10 and STEP failed at `744353b`. Pins printed fp241 through fp248 pins ok. `FP241_OOS` aborts the pull and the scorer. Counts taken before this freeze, with no profit computed: DROP 150 (pool 342), UPRI 198 (pool 357), AHEAD 171 (pool 354), CALM 161 (pool 352), CDEC 123 (pool 351), TRIP 55 (pool 356), CFAL 64 (pool 348), BOUN 53 (pool 345). A six-day spot decline against a six-day USDT rise had 0 spans. It was not scored. DROP buys the coin-margined perpetual for sixteen days after a finished three-day spot decline. UPRI shorts spot for nine days after a finished two-day USDT rise. AHEAD buys the USDT perpetual for twelve days after spot's finished seven-day return beat the coin-margined return. CALM buys the coin-margined perpetual for six days after the absolute nine-day return finished smaller than the one before it. CDEC shorts the USDT perpetual for fifteen days after a finished twenty-day coin-margined decline. TRIP buys the coin-margined perpetual for three days after three finished two-day spot rises. It is not four consecutive higher closes. CFAL buys the USDT perpetual for eighteen days after two finished five-day coin-margined declines. BOUN buys spot for twenty-one days after yesterday's USDT close finished above the prior close and below the close five days earlier. Each position is one leg. Each null is that payoff with the extra condition off, held the same number of days. The count stays 30. No percentile is used. No sign of a killed rule is flipped. HI10 and STEP were not rewritten. CMF and QNEW stay failed. MTH stays void. No pull request. Main was not pushed.

### [2026-09-25 12:17 UTC] Platform: Cursor | Model: Grok 4.7

**HI10 and STEP fail the pre-registered later years. Neither is a testing row.** The pre-registrations were `e951ce4`, pushed before any later-year return. Each test was run twice and the copies matched. HI10 `docs/agents/backtests/fp233/hi10_oos.json`, sha256 `12c437e4…`. 2023 reproduces: 74 trades, +$273.3478. Entries 2024-01-01 through 2026-09-17: 184 trades, +$68.0852, mean +$0.370028, null p95 +$1.3145 on 991 eight-day spot longs. 2024 is +$131.5458 and 2025-01-01 through 2026-09-17 is −$63.4606. Doubled costs are +$31.1858. February 2024 is +$119.2415, 175.14% of the total, and the total without it is −$51.1564. Annualised over 998 days it is 0.249009. The last entry is 2026-09-17 and the exit open is 2026-09-25. Spot closes used as the signal stop on 2026-09-16. STEP `docs/agents/backtests/fp237/step_oos.json`, sha256 `c1898b1e…`. 2023 reproduces: 112 trades, +$210.0476. Entries 2024-01-01 through 2026-09-21: 269 trades, +$0.7254, mean +$0.002697, null p95 +$0.5928 on 995 four-day longs. 2024 is +$47.7475 and 2025-01-01 through 2026-09-21 is −$47.0222. Doubled costs are −$53.0225. February 2024 is +$40.9587, 56.4667 times the total, and the total without it is −$40.2333. Annualised over 998 days it is 0.002653. The last entry is 2026-09-21 and the exit open is 2026-09-25. Closes used as the signal stop on 2026-09-20. A 2025 spot monthly archive stamps the open in microseconds; that pull divides those stamps by 1000. The 2024-01-01 bar matches the screen on both books. The buys and the sells were not moved. The null holds stayed eight and four days. Both rules fail. Neither is a testing row. Reference §3.273 and §3.274. The count stays 30. CMF and QNEW stay failed. MTH stays void. No pull request. Main was not pushed.

### [2026-09-25 12:11 UTC] Platform: Cursor | Model: Grok 4.7

**HI10 and STEP pre-registrations are frozen. No later-year return of either rule has been computed.** The 2023 screens stay as scored at `4fc323f`. HI10 is `docs/agents/reviews/2026-09-25-fp233-prereg-hi10.md`, sha256 `4df73901…`, frozen 2026-09-25T12:10:37Z. The book is BTCUSDT spot bid 84640.0, ask 84640.01, half-spread 5.907372048690988e-08, read at 2026-09-25T12:10:14.022Z. The last entry is 2026-09-17. The exit open is 2026-09-25 and is not an entry. A bar on 2026-09-26 is not requested. Spot closes used as the signal stop on 2026-09-16. STEP is `docs/agents/reviews/2026-09-25-fp237-prereg-step.md`, sha256 `83d4aa15…`, frozen at the same time. The book is the BTCUSDT USDT perpetual, bid 84615.8, ask 84615.9, half-spread 5.909058408753729e-07, read at 2026-09-25T12:10:14.179Z. The last entry is 2026-09-21. The exit open is 2026-09-25 and is not an entry. Closes used as the signal stop on 2026-09-20. The null hold stays eight days for HI10 and four days for STEP. The count stays 30. No daily open from 2024-01-01 has been read as an entry. Neither file arms a testing row. CMF and QNEW stay failed. MTH stays void. The other six of fp233–fp240 stay failed on 2023. No pull request. Main was not pushed.

### [2026-09-25 12:07 UTC] Platform: Cursor | Model: Grok 4.7

**fp233–fp240 are scored. HI10 and STEP pass the 2023 screen and are not testing rows. The other six fail.** The protocol was `55f8480`, pushed before any of these returns. Each screen file was written twice and the copies matched. HI10 74 / file gross +390.1485 / file mean +369.3889 / null +329.1859 / +$273.3478 (`8e98355f…`). UMSH 82 / file gross −82.8535 / file mean −102.668 / null −139.9677 / −$84.1878 (`762e961e…`). TRI 203 / file gross +195.9277 / file mean +175.5563 / null +244.2694 / +$356.3792 (`566b04fa…`). BNC 59 / file gross +331.2037 / file mean +310.5619 / null +479.0876 / +$183.2315 (`289e9e51…`). STEP 112 / file gross +207.938 / file mean +187.5425 / null +158.3111 / +$210.0476 (`ff0517d5…`). GAP 96 / file gross +198.6343 / file mean +178.2574 / null +235.1411 / +$171.1271 (`6c37947a…`). QUIET 179 / file gross +352.6189 / file mean +331.9343 / null +451.1356 / +$594.1624 (`d169cae5…`). LEAD 177 / file gross +196.1993 / file mean +175.8273 / null +178.24 / +$311.2143 (`d26ae687…`). HI10 and STEP clear the three screen bars. Their later years are not scored, so neither is a testing row. UMSH is negative and above its null. TRI, BNC, GAP, QUIET and LEAD are positive and under their nulls. Every fill is one leg. Each null is that payoff with the extra condition off, held the same number of days. Funding cash is not added. The scored counts match the pre-freeze counts: 74, 82, 203, 59, 112, 96, 179, 177. No rule was changed. CMF and QNEW stay failed on the later years and are not testing rows. MTH stays void. The count stays 30. Reference §3.265–§3.272. No pull request. Main was not pushed.

### [2026-09-25 12:04 UTC] Platform: Cursor | Model: Grok 4.7

**fp233–fp240 are protocols only. No return of these rules has been computed.** CMF and QNEW failed at `3d46536`. Pins printed fp233 through fp240 pins ok. `FP233_OOS` aborts the pull and the scorer. Counts taken before this freeze, with no profit computed: HI10 74 (pool 358), UMSH 82 (pool 355), TRI 203 (pool 351), BNC 59 (pool 356), STEP 112 (pool 362), GAP 96 (pool 360), QUIET 179 (pool 353), LEAD 177 (pool 361). An opposite-sign five-day pair had 1 span. A Friday-to-Monday filter had 19 spans. A twenty-one-day sign split had 0 spans. None of those three was scored. HI10 buys spot for eight days after yesterday's close finished above each of the ten prior closes. UMSH shorts the USDT perpetual for eleven days after a finished four-day rise and a finished four-day fall. TRI buys the coin-margined perpetual for seven days after spot, the USDT perpetual and the coin-margined perpetual each finished a six-day rise. BNC buys the USDT perpetual for ten days after a finished two-day rise inside a finished eight-day fall. STEP buys the USDT perpetual for four days after two finished three-day rises. It is not four consecutive higher closes. GAP buys the USDT perpetual for six days after yesterday's open finished above the prior close. QUIET buys the USDT perpetual for thirteen days after the absolute three-day return finished smaller than the one before it. LEAD buys spot for five days after the coin-margined eight-day return finished above spot's. Each position is one leg. Each null is that payoff with the extra condition off, held the same number of days. The count stays 30. No percentile is used. No sign of a killed rule is flipped. CMF and QNEW were not rewritten. MTH stays void. No pull request. Main was not pushed.

### [2026-09-25 11:55 UTC] Platform: Cursor | Model: Grok 4.7

**CMF and QNEW fail the pre-registered later years. Neither is a testing row.** The pre-registrations were `1f8a900`, pushed before any later-year return. Each test was run twice and the copies matched. CMF `docs/agents/backtests/fp230/cmf_oos.json`, sha256 `46b5a6f7…`. 2023 reproduces: 96 trades, +$471.5815. Entries 2024-01-01 through 2026-09-13: 286 trades, −$179.3406, mean −$0.627065, null p95 +$1.5896 on 987 twelve-day longs. 2024 is +$97.2224 and 2025-01-01 through 2026-09-13 is −$276.563. Doubled costs are −$236.1253. August 2026 is +$92.9147 and the total without it is −$272.2553. Annualised over 998 days it is −0.655905. The last entry is 2026-09-13 and the exit open is 2026-09-25. Spot closes stop on 2026-09-12. QNEW `docs/agents/backtests/fp231/qnew_oos.json`, sha256 `e66a7118…`. 2023 reproduces: 40 trades, +$304.5022. Entries 2024-01-01 through 2026-09-13: 151 trades, +$225.9361, mean +$1.496266, null p95 +$1.7213 on 877 eleven-day longs. 2024 is −$63.7463 and 2025-01-01 through 2026-09-13 is +$289.6824. Doubled costs are +$195.3148. July 2025 is +$92.5527, 40.96% of the total. Annualised over 998 days it is 0.826319. Eleven later quarterlies were read from the archive. None was missing. No expiry bar was stored. BTCUSD_261225 was not an entry. The buys and the sells were not moved. The null holds stayed twelve and eleven days. Both rules fail. Neither is a testing row. Reference §3.263 and §3.264. The count stays 30. MTH stays void. No pull request. Main was not pushed.

### [2026-09-25 11:48 UTC] Platform: Cursor | Model: Grok 4.7

**CMF and QNEW pre-registrations are frozen. No later-year return of either rule has been computed.** The 2023 screens stay as scored at `f47a08f`. CMF is `docs/agents/reviews/2026-09-25-fp230-prereg-cmf.md`, sha256 `a62199e5…`, frozen 2026-09-25T11:45:09Z. The book is BTCUSD_PERP bid 84668.7, ask 84668.8, half-spread 5.905366502152256e-07, read at 2026-09-25T11:45:07.260Z. The last entry is 2026-09-13. The exit open is 2026-09-25 and is not an entry. A bar on 2026-09-26 is not requested. Spot closes used as the signal stop on 2026-09-12. QNEW is `docs/agents/reviews/2026-09-25-fp231-prereg-qnew.md`, sha256 `1faa38ec…`, frozen at the same time. The book is BTCUSD_261225 bid 85644.4, ask 85685.6, half-spread 0.0002404716045059922, read at 2026-09-25T11:45:08.701Z. BTCUSD_260925 printed bid 0.0 and ask 0.0 at 2026-09-25T08:06:14.215Z and is the expiry print, not the spread. The later quarterlies are last Fridays from BTCUSD_240329 through BTCUSD_260925. BTCUSD_261225 is not an entry and its daily bars are not requested. Ages 0 through 2 of BTCUSD_240329 stay outside both windows. The null hold stays twelve days for CMF and eleven days for QNEW. The count stays 30. No daily open from 2024-01-01 has been read as an entry. Neither file arms a testing row. MTH stays void. No pull request. Main was not pushed.

### [2026-09-25 11:38 UTC] Platform: Cursor | Model: Grok 4.7

**fp225–fp232 are scored. CMF and QNEW pass the 2023 screen and are not testing rows. The other six fail.** The protocol was `ec08ec7`, pushed before any of these returns. Each screen file was written twice and the copies matched. `FP225_OOS` aborts the scorer. QFAR 56 / file gross +236.5158 / file mean +216.0632 / null +454.864 / +$120.9954 (`d5ff2883…`). PBK 72 / file gross +318.8964 / file mean +298.2792 / null +426.7908 / +$214.761 (`07e1d377…`). CFD 223 / file gross −141.5503 / file mean −161.2475 / null −157.8331 / −$359.582 (`065b8584…`). UFL 122 / file gross +68.5612 / file mean +48.4442 / null +201.1551 / +$59.1019 (`9f288885…`). SLD 177 / file gross −382.3787 / file mean −401.5948 / null −254.4862 / −$710.8227 (`9a8d7413…`). CMF 96 / file gross +512.2342 / file mean +491.2307 / null +480.976 / +$471.5815 (`cd228903…`). QNEW 40 / file gross +782.7995 / file mean +761.2554 / null +599.9328 / +$304.5022 (`e8bfe70c…`). UMFD 206 / file gross −155.834 / file mean −175.5027 / null −177.8873 / −$361.5356 (`5633a66d…`). Every rule has fills. Every fill is one leg. CMF and QNEW clear the three screen bars. Their later years are not scored, so neither is a testing row. QFAR, PBK and UFL are positive and under their nulls. CFD and SLD are negative and under their nulls. UMFD is negative and above its null. Each null is that single-leg payoff with the extra condition off, held the same number of days. Funding cash is not added. The scored counts match the pre-freeze counts: 56, 72, 223, 122, 177, 96, 40, 206. No rule was changed. The count stays 30. MTH stays void. Reference §3.255–§3.262. No pull request. Main was not pushed.

### [2026-09-25 11:37 UTC] Platform: Cursor | Model: Grok 4.7

**fp225–fp232 are protocols only. No return of these rules has been computed.** MTH is void at `ed1637d`: the same-length null is +946.023 bps against the unchanged mean of +811.9657 bps. A version of CMF that also required spot's twelve-day return to be positive had 0 spans. A four-close USDT streak had 19 spans. Neither was scored, and neither is the frozen rule. Pins printed fp225 through fp232 pins ok. `FP225_OOS` aborts the pull and the scorer. Counts taken before the freeze, with no profit computed: QFAR 56 (pool 311), PBK 72 (pool 356), CFD 223 (pool 350), UFL 122 (pool 361), SLD 177 (pool 352), CMF 96 (pool 346), QNEW 40 (pool 343), UMFD 206 (pool 357). QFAR buys the front quarterly when 21 to 35 days remain and sells ten days later, before expiry. PBK buys spot for ten days after a finished twenty-day rise and a finished five-day decline. CFD shorts the coin-margined perpetual for eight days after a finished fifteen-day rise. UFL buys the USDT perpetual for five days after a finished thirty-day decline. SLD shorts spot for fourteen days after spot's finished ten-day return beat the USDT return. CMF buys the coin-margined perpetual for twelve days after its finished twelve-day return was negative and below spot's. QNEW buys the most recently listed quarterly during its first fourteen days and sells eleven days later, before expiry. UMFD shorts the USDT perpetual for nine days after a finished nine-day rise. Each position is one leg. The null is that payoff with the extra condition off, held the same number of days. The count stays 30. No pull request. Main was not pushed.
...
**MTH's seven-day null is not a pass. The same-length null is frozen. No return of that null has been computed.** The recorded screen stays `docs/agents/backtests/fp218/screen_2023.json` (`b028983e`), 84 trades, file gross +833.6112 bps, file mean +811.9657 bps, null +787.6951 bps, +$682.0512. That pool sold at the next month's open whenever at least seven days remained. The trades are unchanged: a UTC day numbered 1 through 7, one USDT-perpetual leg, sold at the next month's first open, a hold of 22 to 31 days. The new null draws, within each length the rule used, that many opens held exactly that many days. Lengths run ascending. Within a length the list is entry order. 200 draws, seed 20250925, index 190. A span count taken before this freeze, with no profit of this null computed: rule 84, pool 3395; by length 22 is 1 and 344, 23 is 1 and 343, 24 is 5 and 342, 25 is 12 and 341, 26 is 12 and 340, 27 is 12 and 339, 28 is 12 and 338, 29 is 11 and 337, 30 is 11 and 336, 31 is 7 and 335. Pins printed fp218 pins ok. `FP218_OOS` aborts the scorer. The later years are not scored. This is not a testing row. The count stays 30. Reference §3.247. No pull request. Main was not pushed.

### [2026-09-25 11:15 UTC] Platform: Cursor | Model: Grok 4.7

**fp217–fp224 are scored. MTH passes the 2023 screen and is not a testing row. The other seven fail.** The protocol was `3acc6ef`, pushed before any of these returns. Each screen file was written twice and the copies matched. `FP217_OOS` aborts the scorer. MONX 52 / file gross +93.6132 / file mean +73.4461 / null +202.8863 / +$38.192 (`5cbfcdee…`). MTH 84 / file gross +833.6112 / file mean +811.9657 / null +787.6951 / +$682.0512 (`b028983e…`). XEXP 112 / file gross +958.5785 / file mean +936.6832 / null +1588.5237 / +$1049.0852 (`b42af92a…`). BRD 81 / file gross +296.6595 / file mean +276.0868 / null +284.8539 / +$223.6303 (`97963d87…`). SMO 204 / file gross +195.0527 / file mean +174.683 / null +238.791 / +$356.3532 (`940c1f82…`). FRI7 51 / file gross +207.0796 / file mean +186.6858 / null +345.5275 / +$95.2098 (`16951b0d…`). FWK 135 / file gross +279.6981 / file mean +259.1592 / null +276.2519 / +$349.8649 (`61ae3dca…`). CMS 171 / file gross −96.0698 / file mean −115.8579 / null −128.2059 / −$198.117 (`043f064c…`). Every rule has fills. Every fill is one leg. MTH clears the three screen bars. Its later years are not scored, so it is not a testing row. The other seven means are positive and under their nulls, except CMS, whose mean is negative and above its null. Each null is that single-leg payoff with the extra condition off. Funding cash is not added. The scored counts match the pre-freeze counts: 52, 84, 112, 81, 204, 51, 135, 171. No rule was changed. The count stays 30. Same-day two-leg mean reversion was not rerun. fp209–fp216 were not rewritten. The book was not read. The three missing book days were not filled in. Reference §3.246–§3.253. No pull request. Main was not pushed.

### [2026-09-25 11:12 UTC] Platform: Cursor | Model: Grok 4.7

**fp217–fp224 are protocols only. No return of these rules has been computed.** fp209–fp216 were recorded at `0bb442f` and none passed. Every gross was positive and every mean was negative. Each fill was long one contract and short another, and the round trip on two legs cost more than the gross. Same-day two-leg mean reversion stops here. Swapping the pair is not a new rule. Those eight were not rewritten. Pins printed fp217 through fp224 pins ok before this commit. `FP217_OOS` aborts the pull and the scorer. Counts taken before the freeze, with no profit computed: MONX 52 (pool 362), MTH 84 (pool 293), XEXP 112 (pool 331), BRD 81 (pool 359), SMO 204 (pool 359), FRI7 51 (pool 359), FWK 135 (pool 359), CMS 171 (pool 346). MONX buys the USDT-perpetual open on Monday and sells Friday's open, four days, weekend not held. MTH buys a UTC day numbered 1 through 7 and sells the next month's first open, a hold of 22 to 31 days. XEXP buys the front coin-margined quarterly when 7 to 35 days remain and sells the expiry open. The March 2024 contract is not in the list. BRD buys the USDT perpetual for seven days after at least five of the seven finished sessions closed below their open. SMO buys spot for seven days after spot's close finished strictly above its close seven days earlier. FRI7 buys Friday's open and sells the next Friday's open, seven days, weekend inside the hold. FWK buys the USDT perpetual for seven days after the 16:00 funding rate finished strictly below the 16:00 rate seven days earlier. The 00:00 and 08:00 prints are not stored. CMS sells the coin-margined perpetual for seven days after its seven-day return finished strictly below the USDT return. The USDT book is a signal, not a second leg. Funding cash is not added. Each null is that single-leg payoff with the extra condition off. None of the holds is one day or overnight. The count stays 30. No percentile is used. No sign of a killed rule is flipped. The book was not read. The three missing book days were not filled in. The six-day range, the two-day hold, the three-close filter and the three-day hold stay closed. An engulfing body, a wick, and a high or a low stay closed. The funding range, the funding level and either tail stay closed. BRKHI stays void. fp209–fp216 stay failed and were not rewritten. No on-chain chart is read. No option file is read. No mempool chart is read. No hourly price bar is read. No liquidation file is read. No later year is in the request as a signal. A 2024-01-01 print, where a cover needs it, is an exit only. No testing row. No pull request. Main was not pushed.

### [2026-09-25 10:50 UTC] Platform: Cursor | Model: Grok 4.7

**fp209–fp216 fail the 2023 screen. None is a testing row.** The protocol was `59e8e3c`, pushed before any of these returns. Each screen file was written twice and the copies matched. `FP209_OOS` aborts the scorer. SVW 187 / file gross +5.3688 / file mean −34.602 / null −33.2198 / −$64.7057 (`b02a297c…`). UCR 190 / file gross +5.9791 / file mean −33.9928 / null −33.1814 / −$64.5864 (`cf5f0a52…`). FND 134 / file gross +4.5796 / file mean −35.3896 / null −33.7423 / −$47.422 (`7405bfb4…`). CAL 173 / file gross +9.0724 / file mean −30.9058 / null −32.3339 / −$53.467 (`5ee7ffa5…`). FCH 47 / file gross +7.0842 / file mean −32.89 / null −31.8763 / −$15.4583 (`2921e58d…`). MRK 184 / file gross +5.0549 / file mean −34.9152 / null −33.4673 / −$64.244 (`87201cf9…`). LVL 176 / file gross +5.6406 / file mean −34.3307 / null −33.2381 / −$60.4221 (`adfd15ed…`). SCM 143 / file gross +6.0315 / file mean −33.9406 / null −33.1383 / −$48.535 (`5b0bfe00…`). Every rule has fills. Every fill is long one contract and short the other. Every gross is positive and every mean is negative. CAL's mean is above its null and still fails, because a pass needs a positive mean. The other seven means are under their nulls. Each null is that spread with the extra filter off, not an unconditional long and not an unconditional short. Funding cash is not added. The scored counts match the pre-freeze counts: 187, 190, 134, 173, 47, 184, 176, 143. No rule was changed. The count stays 30. fp201–fp208 were not flipped into longs. The book was not read. The three missing book days were not filled in. No pull request. Main was not pushed.

### [2026-09-25 10:48 UTC] Platform: Cursor | Model: Grok 4.7

**fp209–fp216 are protocols only. No return of these rules has been computed.** fp201–fp208 were recorded at `0317aaa` and none passed. Every mean was negative. MKUM sat above its null and still failed, because a pass needs a positive mean. Those eight were not rewritten and were not flipped into longs. A filter on an unconditional short stops here, as does a filter on an unconditional long. Pins printed fp209 through fp216 pins ok before this commit. `FP209_OOS` aborts the pull and the scorer. Counts taken before the freeze, with no profit computed: SVW 187, UCR 190, FND 134, CAL 173, FCH 47, MRK 184, LVL 176, SCM 143. SVW longs the lower close-over-average and shorts the higher, next session, after the spot-versus-USDT gap widened. UCR does that with the USDT and coin-margined close/open. FND does it from the next open to the following open after the 16:00 funding gap widened. CAL longs the coin-margined perpetual and shorts that entry day's front quarterly, next session, after the quarterly return finished above the perpetual. FCH longs the book whose 16:00 funding rate fell and shorts the book whose rate rose, next session, when the changes have opposite signs. MRK longs the more negative mark residual and shorts the more positive, from the next close to the following close, spot against the USDT book. LVL longs the lower close and shorts the higher close, from the next close to the following close, after the USDT-versus-coin-margined gap widened. SCM longs the more negative mark residual and shorts the more positive, next session, spot against the coin-margined book. Funding cash is not added. Each null is that spread with the extra filter off. It is not an unconditional long and not an unconditional short. The count stays 30. No percentile is used. The book was not read. The three missing book days were not filled in. No pull request. Main was not pushed.

### [2026-09-25 10:25 UTC] Platform: Cursor | Model: Grok 4.7

**fp201–fp208 fail the 2023 screen. None is a testing row.** The protocol was `613a78c`, pushed before any of these returns. Each screen file was written twice and the copies matched. `FP201_OOS` aborts the scorer. TAKMK 173 / file gross −21.0382 / file mean −40.9761 / null −21.9161 / −$70.8887 (`bbe7ae28…`). UMVW 189 / file gross −28.1757 / file mean −48.0995 / null −23.804 / −$90.908 (`7efb3869…`). CMIDX 183 / file gross −31.4452 / file mean −51.3624 / null −23.0788 / −$93.9931 (`b92702cb…`). MKCM 190 / file gross +5.0879 / file mean −34.8823 / null −33.7302 / −$66.2763 (`1ca2a06c…`). UMRICH 81 / file gross −13.7411 / file mean −33.6936 / null −7.4658 / −$27.2918 (`68d9f7a9…`). CMFN 50 / file gross −0.0081 / file mean −19.9881 / null −19.9617 / −$9.9941 (`450442d5…`). UMX 73 / file gross −54.393 / file mean −74.2643 / null −2.9621 / −$54.213 (`9f69b416…`). MKUM 182 / file gross −2.2856 / file mean −22.2611 / null −23.9167 / −$40.5152 (`04974fa5…`). Every rule has fills. Every fill was recomputed from the stored prices and matched. Every mean is negative. MKUM sits above its own null and still fails, because a pass needs a positive mean. The other seven sit under their null as well. The null of each rule is its own payoff with the filter off: a coin-margined session short, a coin-margined open-to-next-open short, a USDT session short, a coin-margined long with a USDT short from open to next open, a USDT open-to-next-open short, a coin-margined overnight short, a spot close-to-close short, and a coin-margined close-to-close short. None of those is an unconditional long. Funding cash is not added. A hundred dollars sits on each leg of MKCM. A pre-freeze count, with no profit computed, was 170 for TAKMK, 79 for UMRICH, 52 for CMFN and 180 for MKUM. The scored books are 173, 81, 50 and 182. Two CMFN signal days had no bar to sell or no next open to buy. The rules were not changed. The book was not read. Book files for 2022-12-31, 2023-02-08 and 2023-02-09 were not filled in. The monthly coin-margined funding file ends on 2023-12-30 at 16:00, and 2023-12-31 was not filled in. The entry of each rule uses a print that has already happened. No rule reads a high, a low, a wick, or an engulfing body. Reference §3.230–§3.237. No percentile was used. No sign of a killed rule was flipped. fp193–fp200 were not flipped into longs. No count was lowered. The six-day range, the two-day hold, the three-close filter and the three-day hold stay closed. fp185–fp200 stay failed and were not rewritten. LAG6, C3 and fp177–fp184 stay failed. BRKHI stays void. No on-chain chart was read. No option file was read. No mempool chart was read. No hourly price bar was read. No liquidation file was read. No later year was read as a signal. A 2024-01-01 print, where a cover needs it, is an exit only. No testing row. No pull request. Main was not pushed.

### [2026-09-25 10:23 UTC] Platform: Cursor | Model: Grok 4.7

**fp201–fp208 are protocols only. No return of these rules has been computed.** fp193–fp200 were recorded at `58bc6cb` and none passed. Every mean was negative. VWAPH and CMH sat above their nulls and still failed, because a pass needs a positive mean. Those eight were not rewritten and were not flipped into longs. Pins printed fp201 through fp208 pins ok before this commit. `FP201_OOS` aborts the pull and the scorer. Counts taken before the freeze, with no profit computed: TAKMK 170, UMVW 189, CMIDX 183, MKCM 190, UMRICH 79, CMFN 52, UMX 73, MKUM 180. TAKMK shorts the next coin-margined session after the USDT taker-buy average finishes above the mark close. UMVW shorts the next coin-margined open to the following open after the USDT close finishes above its own average. CMIDX shorts the next USDT session after the coin-margined close/open finishes above the index close/open. MKCM is long the coin-margined perpetual and short the USDT perpetual, open to the next open, after the mark close/open finishes above the coin-margined close/open. A hundred dollars sits on each leg. UMRICH shorts the next USDT open to the following open after the USDT close finishes above the mark close. The close is an input, so the sell is the next open. CMFN sells the coin-margined close and buys the next open after the 00:00 rate is strictly negative and the 16:00 rate is strictly positive. The 08:00 rate is not stored. The monthly file ends on 2023-12-30 at 16:00, and 2023-12-31 is not filled in. UMX shorts spot from the next close to the following close after the USDT close finishes above the index close. MKUM shorts the coin-margined book from the next close to the following close after the mark close/open finishes above the USDT close/open. Funding cash is not added. Each null is that payoff with the filter off, and none of those payoffs is an unconditional long. The count stays 30. No percentile is used. No sign of a killed rule is flipped. The book is not read. The three missing book days were not filled in. The six-day range, the two-day hold, the three-close filter and the three-day hold stay closed. An engulfing body, a wick, and a high or a low stay closed. BRKHI stays void. fp185–fp200 stay failed and were not rewritten. LAG6 and C3 stay failed. No on-chain chart is read. No option file is read. No mempool chart is read. No hourly price bar is read. No liquidation file is read. No later year is in the request as a signal. A 2024-01-01 print, where a cover needs it, is an exit only. No testing row. No pull request. Main was not pushed.

### [2026-09-25 10:01 UTC] Platform: Cursor | Model: Grok 4.7

**fp193–fp200 fail the 2023 screen. None is a testing row.** The protocol was `4fb0448`, pushed before any of these returns. Each screen file was written twice and the copies matched. `FP193_OOS` aborts the scorer. ASKSH 112 / file gross −42.0381 / file mean −61.9342 / null −13.7277 / −$69.3663 (`d9dc206d…`). IDXSH 177 / file gross −35.7974 / file mean −55.7059 / null −22.5105 / −$98.5994 (`a9abb8b0…`). VWAPH 120 / file gross +7.1987 / file mean −32.7757 / null −33.4027 / −$39.3308 (`0e6582f0…`). CMH 151 / file gross +7.6777 / file mean −32.2977 / null −33.6862 / −$48.7695 (`ac64dc6f…`). ON16 124 / file gross +0.0052 / file mean −19.9748 / null −19.956 / −$24.7688 (`9efbc829…`). COISH 185 / file gross −29.3178 / file mean −49.2392 / null −29.906 / −$91.0925 (`1f181522…`). MRKSH 184 / file gross −14.9479 / file mean −34.898 / null −26.6463 / −$64.2124 (`f7f9e3cd…`). TAKSP 202 / file gross +5.4791 / file mean −34.4919 / null −33.7986 / −$69.6737 (`4dca03c2…`). Every rule has fills. Every fill was recomputed from the stored prices and matched. Every mean is negative. VWAPH and CMH sit above their own null and still fail, because a pass needs a positive mean. The other six sit under their null as well. The null of each rule is its own payoff with the filter off: a spot session short, an open-to-next-open short, a spot-long and perpetual-short session, a spot-long and coin-margined-short session, an overnight short, a USDT-perpetual session short, a USDT-perpetual open-to-next-open short, and a coin-margined-long with a USDT-perpetual-short. None of those is an unconditional long. Funding cash is not added. A pre-freeze count, with no profit computed, was 147 for CMH and 201 for TAKSP. The scored books are 151 and 202. The rules were not changed. Book files for 2022-12-31, 2023-02-08 and 2023-02-09 were absent and were not filled in. The entry of each rule uses a print that has already happened. No rule reads a high, a low, a wick, or an engulfing body. Reference §3.222–§3.229. No percentile was used. No sign of a killed rule was flipped. No count was lowered. The six-day range, the two-day hold, the three-close filter and the three-day hold stay closed. fp185–fp192 stay failed and were not rewritten. LAG6, C3 and fp177–fp184 stay failed. BRKHI stays void. No on-chain chart was read. No option file was read. No mempool chart was read. No hourly price bar was read. No liquidation file was read. No later year was read as a signal. The 2024-01-01 open, where a cover needs it, is an exit only. No testing row. No pull request. Main was not pushed.
...
**fp95–fp102 protocols only. No return of these rules has been computed.** The hourly-bar shape family stops at fp94. These eight screens are a different input and a different instrument: SOL, BNB, XRP, DOGE, ADA, AVAX, LINK and LTC daily quote volume divided by BTC's quote volume, long that coin the next day. ETH is not included, because ETH quote over BTC quote is the same ordering as the lower tail of the closed BTC share of BTC+ETH volume. Pins passed on synthetic bars. The opens are not inputs. The coin's own quote level is not the statistic, and the reciprocal is not a separate rule. No hourly bar is read. The null, when a screen is scored, is that coin's own one-day holds. AFTER-HIGH stays closed with no fill, and the 90-print window is not widened. IMPACT, PEAK, BAL-CHG, BODY, fp30–fp94, and the previous rounds' named ideas stay closed. No 2023 number of these rules was computed. No pull request. Main was not pushed.
...
### [2026-09-25 04:13 UTC] Platform: Cursor | Model: Grok 4.7

**fp54–fp61 are scored. Nothing passes the house bar.** Protocol was `68b331f`. The field-tuple fix was `96b48c5`. The 2023 passes were pre-registered in `1b3b81c` before any later-year quote or base volume, half-spread 5.9397938896041255e-08, frozen 2026-09-25T04:06:10Z, bid 84178.00000000, ask 84178.01000000. Each screen file and both out-of-sample files were written twice and the copies matched. VOL-CLOCK screen 38 / +66.65 / null +65.90 / +$25.33 (`b3b2686d…`). Out of sample: 109 trades, −$42.8954, mean −$0.393536, null +$0.2948, 2024 −$14.7672, later −$28.1282, doubled −$64.588, August 2026 +$6.8278, without it −$49.7232, annualised −15.69% (`0339111e…`). The 80th is −$73.9054 / 203 and the 95th is −$39.7305 / 71. Both neighbours lose and neither is a candidate. BOUNCE 40 / file mean +0.0707 / +67.59 / +$0.03 (`9f3afa15…`). CLOSE-HIGHS 28 / +54.86 / +84.17 / +$15.36 (`0c2613ce…`). BASE-CHG screen 44 / +65.20 / +63.98 / +$28.69 (`faa31420…`). Out of sample: 102 trades, −$6.934, mean −$0.067981, null +$0.2877, 2024 +$7.8662, later −$14.8002, doubled −$27.2998, February 2026 +$10.5814, without it −$17.5154, annualised −2.54% (`ab214f5b…`). The 80th is −$50.133 / 210 and the 95th is −$6.0329 / 65. Both neighbours lose and neither is a candidate. LAST-EXT 19 / −33.27 / file null +90.987 / −$6.32 (`9cbc5fb5…`). STEP-BASE 30 / +62.48 / file null +75.189 / +$18.74 (`1d11c890…`). OPEN-YLOW 41 / +5.82 / file null +70.1636 / +$2.39 (`02e1a3d5…`). LAST-HOUR 43 / +58.92 / file null +66.2261 / +$25.33 (`2e03db8d…`). Every 2023 fill matched fp5's `net_return`. 2023 reproduces inside the later-year runs: 38 trades, +$25.3277, and 44 trades, +$28.6869. Reference §3.83–§3.90. No sign was flipped. No count was lowered. The window was not shrunk. IMPACT, PEAK, BAL-CHG, BODY and fp30–fp53 stay closed, including AVG-CHG's positive 95th. No testing row. No pull request. Main was not pushed.

### [2026-09-25 04:08 UTC] Platform: Cursor | Model: Grok 4.7

**fp54–fp61 screens are scored. VOL-CLOCK and BASE-CHG passed 2023. Their later years are not pulled.** Protocol was `68b331f`. The field-tuple fix was `96b48c5`. Each file was scored twice and the two copies matched. VOL-CLOCK 38 / +66.65 / null +65.90 / +$25.33 (`b3b2686d…`), screen pass. BOUNCE 40 / +0.07 / +67.59 / +$0.03 (`9f3afa15…`; the file's mean is +0.0707 bps). CLOSE-HIGHS 28 / +54.86 / +84.17 / +$15.36 (`0c2613ce…`). BASE-CHG 44 / +65.20 / +63.98 / +$28.69 (`faa31420…`), screen pass. LAST-EXT 19 / −33.27 / file null +90.987 / −$6.32 (`9cbc5fb5…`). STEP-BASE 30 / +62.48 / file null +75.189 / +$18.74 (`1d11c890…`). OPEN-YLOW 41 / +5.82 / +70.16 / +$2.39 (`02e1a3d5…`). LAST-HOUR 43 / +58.92 / +66.23 / +$25.33 (`2e03db8d…`). Every 2023 fill matched fp5's `net_return`. VOL-CLOCK's pre-registration is `d0083afe…` and BASE-CHG's is `1b455c48…`, both frozen at 2026-09-25T04:06:10Z, bid 84178.00000000, ask 84178.01000000, half-spread 5.9397938896041255e-08. No hourly quote and no base volume from 2024 onward has been read. The 2024-01-01 open already in the screen files is an exit print. A rule rejected without a scored run does not count, so the six failures stay recorded and the two passes still have to be scored through 2026-09-24 after this commit is on the remote. No neighbour of a failed screen was scored. No sign was flipped. The count of 30 was not lowered. The window was not shrunk. IMPACT, PEAK, BAL-CHG, BODY and fp30–fp53 stay closed. No testing row. No pull request. Main was not pushed.

### [2026-09-25 04:04 UTC] Platform: Cursor | Model: Grok 4.7

**fp54 and fp56 fetches: a one-element field tuple was not a tuple.** `(7)` and `(4)` are integers. The quote field and the close field are unchanged. No bar has been pulled. No return has been computed. No pull request. Main was not pushed.

### [2026-09-25 04:03 UTC] Platform: Cursor | Model: Grok 4.7

**fp54–fp61 protocols only. No return has been computed.** Eight screens frozen together, each a different input from the fifty-three closed rounds: the quote-weighted hour, the close over the day's low, hours that break the running close, the rise in base volume, the later of the high's hour and the low's hour, the share of base volume in hours that closed above the prior hour, the open over yesterday's low, and the last hour's return. Pins passed on synthetic bars. The high does not enter the close-over-low rule. Hour 0's base volume does not enter the rising-hour share. The 13:00 hole does not drop the last-hour rule. AVG-CHG stays closed, including the later years, and its positive 95th is not a candidate. UP-STEP beat its null on 25 trades. The count stays 30. IMPACT, PEAK, BAL-CHG, BODY and fp30–fp53 stay closed. No 2023 number was computed. No pull request. Main was not pushed.

### [2026-09-25 03:55 UTC] Platform: Cursor | Model: Grok 4.7

**fp46–fp53 are scored. Nothing passes the house bar.** Protocol was `169d5ce`. The 2023 pass was pre-registered in `e63f691` before any later-year quote or trade count, half-spread 5.939630903800506e-08, frozen 2026-09-25T03:47:48Z, bid 84180.31000000, ask 84180.32000000. Each screen file and the out-of-sample file was written twice and the copies matched. CLOSE-MEAN 35 / +37.50 / null +78.43 / +$13.12 (`d6feef83…`). NEW-HIGHS 27 / +31.43 / +81.29 / +$8.49 (`e91e5648…`). AVG-CHG screen 48 / +77.64 / +60.96 / +$37.27 (`293190d9…`). Out of sample: 116 trades, −$14.8577, mean −$0.128083, null +$0.2669, 2024 +$3.839, later −$18.6967, doubled −$38.0048, November 2024 +$20.8241, without it −$35.6818, annualised −5.43% (`13d0368d…`). The 80th is −$25.3009 / 202 and the 95th is +$5.685 / 64. The 95th is positive and is not a candidate. UP-STEP 25 / +127.76 / +87.12 / +$31.94 (`1d7aed02…`). The mean beat the null and the count is under 30, so the count stays and the later years were not pulled. HIGH-HOUR 19 / +50.32 / file null +90.987 / +$9.56 (`b5b41853…`). ABOVE-OPEN 22 / +50.54 / file null +92.975 / +$11.12 (`50331566…`). QVOL-CHG 45 / +61.80 / +64.27 / +$27.81 (`e9cfb2dc…`). HL-GAP 22 / −33.14 / file null +92.975 / −$7.29 (`286a5de7…`). Every 2023 fill matched fp5's `net_return`. 2023 reproduces inside the later-year run: 48 trades, +$37.2656. Reference §3.75–§3.82. No sign was flipped. No count was lowered. The window was not shrunk. IMPACT, PEAK, BAL-CHG, BODY and fp30–fp45 stay closed. No testing row. No pull request. Main was not pushed.

### [2026-09-25 03:51 UTC] Platform: Cursor | Model: Grok 4.7

**fp46–fp53 screens are scored. AVG-CHG passed 2023. Its later years are not pulled.** Protocol was `169d5ce`. Each file was scored twice and the two copies matched. CLOSE-MEAN 35 / +37.50 / null +78.43 / +$13.12 (`d6feef83…`). NEW-HIGHS 27 / +31.43 / +81.29 / +$8.49 (`e91e5648…`). AVG-CHG 48 / +77.64 / +60.96 / +$37.27 (`293190d9…`), screen pass. UP-STEP 25 / +127.76 / +87.12 / +$31.94 (`1d7aed02…`). HIGH-HOUR 19 / +50.32 / +90.99 / +$9.56 (`b5b41853…`). ABOVE-OPEN 22 / +50.54 / file null +92.975 / +$11.12 (`50331566…`). QVOL-CHG 45 / +61.80 / +64.27 / +$27.81 (`e9cfb2dc…`). HL-GAP 22 / −33.14 / file null +92.975 / −$7.29 (`286a5de7…`). Every 2023 fill matched fp5's `net_return`. AVG-CHG's pre-registration is `e5463632…`, frozen at 2026-09-25T03:47:48Z, bid 84180.31000000, ask 84180.32000000, half-spread 5.939630903800506e-08. No quote volume and no trade count from 2024 onward has been read. The 2024-01-01 open already in the screen file is an exit print; its quote and trade count are stored as 0. A rule rejected without a scored run does not count, so the seven failures stay recorded and AVG-CHG still has to be scored through 2026-09-24 after this commit is on the remote. No neighbour of a failed screen was scored. No sign was flipped. The count of 30 was not lowered. The window was not shrunk. IMPACT, PEAK, BAL-CHG, BODY and fp30–fp45 stay closed, including STREAK and OPEN-DRIVE and their positive neighbours. No testing row. No pull request. Main was not pushed.
...
**fp38–fp45 are scored. Nothing passes the house bar.** Protocol was
`ff4d925`. The two 2023 passes were pre-registered in `3a830a9` before any
later-year price, half-spread 5.938241924546982e-08, frozen
2026-09-25T03:28:08Z. Each screen file and each out-of-sample file was
written twice and the copies matched. HALF-DIFF 34 / +22.92 / null +76.29 /
+$7.79 (`cc0389ba…`). INSIDE 10 / −56.14 / +117.12 / −$5.61 (`c8ede594…`;
11 signals, the last has no exit inside 2023). HI-LOWS 22 / +66.33 / file
null +92.975 / +$14.59 (`13a0f74f…`). STREAK screen 33 / +111.91 / +74.79 /
+$36.93 (`d08e3999…`). Out of sample: 84 trades, +$35.6965, mean +$0.424959,
null +$0.3632, 2024 +$30.7475, later +$4.949, doubled +$18.842, February
2024 is 48.47%, annualised +13.06% (`241e1218…`). The 80th is +$18.6522 /
138 and the 95th is +$32.9515 / 53. Both are positive and are not
candidates. AMIHUD 56 / +12.85 / +54.24 / +$7.20 (`9a330b9f…`). UP-VOL 33 /
+53.99 / +74.79 / +$17.82 (`832ecb42…`). OPEN-DRIVE screen 36 / +80.75 /
+72.62 / +$29.07 (`50cdbd2b…`; 37 signals, the last has no exit inside
2023). Out of sample: 106 trades, +$19.7853, mean +$0.186654, null +$0.2899,
2024 +$9.0681, later +$10.7172, doubled −$1.4331, July 2024 is 57.95%,
annualised +7.24% (`cf011fdd…`). The 80th is +$15.3272 / 209 and the 95th
is +$14.5699 / 64. Both are positive and are not candidates. YDAY-HIGH 43 /
+44.73 / +66.23 / +$19.23 (`b104a4b2…`). Every 2023 fill matched fp5's
`net_return`. 2023 reproduces inside both later-year runs. Reference
§3.67–§3.74. No sign was flipped. No count was lowered. IMPACT, PEAK,
BAL-CHG, BODY and fp30–fp37 stay closed. No testing row. No pull request.
Main was not pushed.
...
**fp28 out of sample: nothing passes.** Pre-registration was `fb4330e`
(`61c415a5…`). Two scores matched (`6f6710e8…`). 2023 reproduces: 37 trades,
+$32.0371. OOS is 113 trades, −$22.6606 against a null of +$0.2644. 2024 is
−$9.0706 and the later window is −$13.59. Doubled costs are −$45.1928.
Without 2024-11 the total is −$33.2177. Annualised −8.29%. The 80th neighbor
is −$50.2414 and the 95th is −$25.6306. Reference §3.57. The hourly grid
from 2024 on has no hole. A day whose volume and moves do not line up is
not a candidate, and neither neighbor is a candidate. BAL-CHG stays closed,
including the level of the address count and its 80th. BODY stays closed,
including the later years. No testing row. No pull request. Main was not
pushed.
...
**fp22 screen: nothing passes.** Protocol was `3426f0c`. Two scores matched
(`ebf5ec3b…`). VOL-HHI 29 trades, +68.57 bps against a null of +79.18,
+$19.89. Gross before costs was +88.73 bps. One hour is missing,
2023-03-24 13:00 UTC, and that day is not a print. Reference §3.51. The
count stays 30. The mean was positive and lost to the null. An even day
and the 80th are not candidates. No testing row. No pull request. Main
was not pushed.
...
**fp21 screen: nothing passes.** Protocol was `16c34db`. Two scores matched
(`99c2dee1…`). VWAP-PREM 44 trades, +28.10 bps against a null of +63.98,
+$12.36. Gross before costs was +48.17 bps. Thirty-one of the signal days
opened at or below the previous close. The daily grid has no hole.
Reference §3.50. The count cleared and the mean was positive; it lost to
the null. A close under the VWAP and the 80th are not candidates. No
testing row. No pull request. Main was not pushed.
...
**fp20 protocol only. No return has been computed.** A different family from
the fifteen closed rounds: the overnight gap, this open over the previous
close, long BTC at the following open. CLOSE-LOC, PAIR-CORR, AVG-SIZE,
AC-HOUR, RV-RATIO, the quiet-day range, the taker share, dispersion and
skew stay closed. A gap down is not a candidate. `pin_test.py` passed
before this commit. The screen is the next step. No pull request. Main was
not pushed.
...
**fp18 protocol only. No return has been computed.** A different family from
the thirteen closed rounds: the 30-day population correlation of BTCUSDT and
ETHUSDT daily close-to-close returns, long BTC the next day. AVG-SIZE,
AC-HOUR, RV-RATIO, the quiet-day range, the taker share, dispersion and
skew stay closed. The low-correlation tail is not a candidate.
`pin_test.py` passed before this commit. The screen is the next step. No
pull request. Main was not pushed.
...
**fp16 protocol only. No return has been computed.** A different family from
the eleven closed rounds: the lag-1 correlation of BTC's 24 hourly returns,
long spot the next day. RV-RATIO, the quiet-day range, DVOL minus realized
vol, dispersion and skew stay closed. The negative tail is not a candidate.
`pin_test.py` passed before this commit. The screen is the next step. No
pull request. Main was not pushed.
...
from the mid, long spot for the next 8h. `pin_test.py` passed before this
commit. The screen is the next step. No pull request. Main was not pushed.
