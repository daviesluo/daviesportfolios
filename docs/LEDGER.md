...
**fp281–fp288 are frozen. No return of these rules has been computed.** RISE and LAGSP stay inside 2023. RISE cleared the other trade by 12.2298 bps and LAGSP by 0.1308 bps. A mean that clears the other trade by 20 bps or less is not taken out of sample. Neither is a testing row. The eight rules are PEAK, REBND, DROPCM, TRIO, SOFTER, RESUME, LESSUP and LIFTL. None uses the opposite side as the other trade. Each null is another trade held the same number of days. It is not the same leg with the condition turned off. Counts taken before this freeze, with no profit computed: PEAK 54/54, REBND 88/88, DROPCM 81/81, TRIO 201/201, SOFTER 91/91, RESUME 51/51, LESSUP 94/94, LIFTL 134/134. Fillable days were 355/355, 358/358, 347/347, 337/345, 343/351, 361/361, 346/346 and 351/351. The screen count stays 30. A pass of 2023 is not a testing row. Later years are scored only when the mean net is strictly more than 20 bps above the other trade and the three screen bars all pass. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.324. No pull request. Main was not pushed.
