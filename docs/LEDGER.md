...
**fp46–fp53 screens are scored. AVG-CHG passed 2023. Its later years are not pulled.** Protocol was `169d5ce`. Each file was scored twice and the two copies matched. CLOSE-MEAN 35 / +37.50 / null +78.43 / +$13.12 (`d6feef83…`). NEW-HIGHS 27 / +31.43 / +81.29 / +$8.49 (`e91e5648…`). AVG-CHG 48 / +77.64 / +60.96 / +$37.27 (`293190d9…`), screen pass. UP-STEP 25 / +127.76 / +87.12 / +$31.94 (`1d7aed02…`). HIGH-HOUR 19 / +50.32 / +90.99 / +$9.56 (`b5b41853…`). ABOVE-OPEN 22 / +50.54 / file null +92.975 / +$11.12 (`50331566…`). QVOL-CHG 45 / +61.80 / +64.27 / +$27.81 (`e9cfb2dc…`). HL-GAP 22 / −33.14 / file null +92.975 / −$7.29 (`286a5de7…`). AVG-CHG's pre-registration is `e5463632…`, frozen at 2026-09-25T03:47:48Z, bid 84180.31000000, ask 84180.32000000, half-spread 5.939630903800506e-08. No quote volume and no trade count from 2024 onward has been read. The 2024-01-01 open already in the screen file is an exit print; its quote and trade count are stored as 0. Score AVG-CHG through 2026-09-24 only after this commit is on the remote. The seven failures stay recorded. Do not score a neighbour of a failed screen. Do not flip a sign. Do not lower the count of 30. Do not shrink the window. fp38–fp45 stay dead (§3.67–§3.74), including STREAK and OPEN-DRIVE and their positive neighbours. Do not score a close under the day's average, fewer new highs, fewer rising hourly closes, an earlier high, fewer hours above the open, a day quote volume did not rise, or a smaller clock gap. A day the average size did not rise is not a candidate, and neither is AVG-CHG's 80th or 95th until the pre-registered test, where each is a veto only. fp30–fp37 stay dead (§3.59–§3.66). PEAK stays dead (§3.58). IMPACT stays dead, including the later years (§3.57). Do not promote its 80th or its 95th. BAL-CHG stays dead (§3.56). BODY stays dead, including the later years (§3.55). Do not promote its 80th. Do not reopen EXCH-BAL, FEE-HIGH, the net exchange flow, UP-SHARE, VOL-HHI, VWAP-PREM, GAP-UP, CLOSE-LOC, PAIR-CORR, AVG-SIZE, AC-HOUR, RV-RATIO, the quiet-day range, the taker share, dispersion, or skew. fp5 through fp45 stay closed, including LS-FADE. No testing row. No pull request. No push to main.
