...
**fp5, eight halftime and stat-gap rules were run on the full sample and none clears the bar.** The 05:21 section froze them. Branch `cursor/polymarket-fp5-b50c`, not main. No testing or live row. `agents/pmrw.ts`, PR5 and trend-4h were not touched. REF, SOT, FOUL, CARD, SPREAD15, BTTS, OVER35, CORNERS, ELO, FORM5, TABLE, REST, VENUE, STREAK3, DRAWBASE, H2H, MARGIN, CONGEST and the earlier failed rules were not reopened. The search file is not written: nothing passed. Each run was repeated and the two files matched. The shared input sha256 is `084ddefe1ba9132e18893a39b7e839393c4a56d8d79303cf7ae1807958ae60b4` (599 contracts: 410 moneylines, 129 halftime results, 30 team totals at 1.5, 30 first-half overs at 0.5; 810 scores). One halftime-draw fill was recomputed with the fee formula and matched the scorer (−$10.1857), and August's 15 HTLEAD trades sum to the August figure (+$86.12661). `half_score.py` blob `b47f4e9185b46b4dffd4f974356bee0fab3a7bdd`. `half_inputs.py` blob `79062016b23650a9d70dbc727446c04e19a05d4d`.

- HTLEAD: **+$72.464046 on 70 trades**, 19 won and 51 lost. The first half is −$5.381603. Stress +$53.400842. The null's 95th percentile is +$235.799608. August is 119% of the profit; without it −$13.662563. The 4% a year on an $82.42 peak passes (ratio 1.268418). Picked-file sha256 `92deb08a244a97c34c281215890ae80b21258fc624734e6e9d82ccd32224b85b`. Both runs sha256 `849bcd3347cdd6ed2df8bd1889eb97f57847966e413af8424e39c758ef260954`. `htlead_test.py` blob `8ad92b6ae23086e97e03d8e3d374cdf92b19712b`. Write-up: `reviews/2026-09-25-polymarket-fp5-htlead.md`.
- HTDRAW: **−$28.558256 on 20 trades**, 6 won and 14 lost. One half is positive. Picked-file sha256 `7adbeeb11e5f6e21a00f7ec927a7975995c411eed707aa88b6e2202771329b73`. Both runs sha256 `92934d7c566683f512e57cf997dadf6598f53989ae5c7dfaedc9a0f30c91c2cb`. `htdraw_test.py` blob `c7e56822c5f9417bd04534ba7fd24c21580c3896`. Write-up: `reviews/2026-09-25-polymarket-fp5-htdraw.md`.
- CORN6: **+$17.537001 on 32 trades**, 13 won and 19 lost. The second half is −$41.13. Stress +$13.595731. The null's 95th percentile is +$140.459648. February is 249% of the profit; without it −$26.218066. The 4% a year on a $30 peak passes (ratio 0.843347). Picked-file sha256 `2fa177e36bc47f69db895e40ccf3188380a7ee946110cb6c608bd448fc5b2858`. Both runs sha256 `4c046148fe3daae07f08d78b8eacbe2f842ac12ac991286c174356df161d0249`. `corn6_test.py` blob `577a1117cbc7befba3e17932a0724b34f74842f3`. Write-up: `reviews/2026-09-25-polymarket-fp5-corn6.md`.
- HTWIN: **−$91.789366 on 31 trades**, 8 won and 23 lost. Both halves lose. Picked-file sha256 `7e0e60c6072c8c4eb6177fee3eafb858b30f6ecd5b9beebce7d98afc59aa39b8`. Both runs sha256 `03d4fb9e191119b5d917f3136dbd297fe8d40c1bec0ffa8668419570e1a889a1`. `htwin_test.py` blob `4f00bde005837370ab7f554eb0e2e47fb16a721e`. Write-up: `reviews/2026-09-25-polymarket-fp5-htwin.md`.
- CLEAN: **+$25.563222 on 36 trades**, 12 won and 24 lost. The second half is −$31.035. Stress +$20.602628. The null's 95th percentile is +$150.885975. May is 214% of the profit; without it −$29.083221. The 4% a year on a $30 peak passes (ratio 1.229325). Picked-file sha256 `fc95ac87e3588b3b5579a76fbc66bb5a74d9608e63110fb8a61b6ef24df7f63b`. Both runs sha256 `e572d20236552dba7c81392aab23dc33e2f28b47eba2fc8ae14444f1030e5079`. `clean_test.py` blob `13cb501c7d1017e033fb05c6172c9c9fb22d6716`. Write-up: `reviews/2026-09-25-polymarket-fp5-clean.md`.
- SHWIN: **−$118.897188 on 55 trades**, 15 won and 40 lost. Both halves lose. Picked-file sha256 `f386dd56217ad977b357bc5e094e607f715712d5594aa76108c05a945813e716`. Both runs sha256 `fd6e2422864845fe09f0d647b1fda53e85585a9f9b8cfb2760ea1d6736006767`. `shwin_test.py` blob `d1d7b395292ab6cfe6aa3e7a453a8b5173bcdf0a`. Write-up: `reviews/2026-09-25-polymarket-fp5-shwin.md`.
- TEAM15: **+$48.926696 on 14 trades**, 6 won and 8 lost. The first half has no trade. Stress +$43.875611. The null's 95th percentile is +$89.365217. August is 136% of the profit; without it −$17.553999. The 4% a year on a $30 peak passes (ratio 2.352865). Picked-file sha256 `fc01214721421a5131657f9f0f8ff03dcc740c259050f0f3481b5d133707e53b`. Both runs sha256 `f7543f401b1e40da5d3e3618f52be44631446c8a2505aae78f973561e32fbdd3`. `team15_test.py` blob `b8f44208b1cdc4d66bacfe53b1b0b808992ef908`. Write-up: `reviews/2026-09-25-polymarket-fp5-team15.md`.
- FH05: **+$6.280567 on 9 trades**, 7 won and 2 lost. The first half has no trade. Stress +$4.904419. The null's 95th percentile is +$33.778206. August is 202% of the profit; without it −$6.398111. The 4% a year on a $20 peak passes (ratio 0.453045). Picked-file sha256 `73b0661e1bd8b5b7af2de0abe66fe3d504fd1efdfe00821060807a15953d09bf`. Both runs sha256 `c4e2a0deae5600a017f30ad4fc0112e6f5b8aec4689bb3422a91bfd260d93f76`. `fh05_test.py` blob `c1a225aaea218612e8f75f80bbab47791dc8703e`. Write-up: `reviews/2026-09-25-polymarket-fp5-fh05.md`.
...
**fp5, nine Premier League rules were run on the full sample and none clears the bar.** The 04:35 section froze ten. CONGEST named no side: over 14 days the match-count gap was 0 on 331 matches and 1 on 79, never 2, so it has no fill and does not count (`reviews/2026-09-25-polymarket-fp5-round10-kills.md`). The gap was not lowered. This section is the nine that filled. Branch `cursor/polymarket-fp5-b50c`, not main. No testing or live row. `agents/pmrw.ts`, PR5 and trend-4h were not touched. PEER, DIURNAL, SHIFT, NEXT, BACK, MEAN3, DRIFT, AGREE and the earlier failed rules were not reopened. The search file is not written: nothing passed. Each run was repeated and the two files matched. The shared score file sha256 is `7371d59e898866878da6a28ae913ed3300fc7988a87c5e67f2be2c3582bc3416` (410 matches, 810 scores). One draw fill was recomputed with the fee formula and matched the scorer (−$10.2322), and January's 19 DRAWBASE trades sum to the January figure (+$201.313801).
- ELO: **−$66.157951 on 223 trades**, 60 won and 163 lost. Both halves lose. Picked-file sha256 `acf89c18cb6491c9a2944689b0dc62c53ee67b935ef26c6259388823aca5e46b`. Both runs sha256 `772bc1089f47f06f3e6a0e8ec2e8d645f11172add7ad58af78957562e16adc66`. `elo_test.py` blob `88640b80e8ea062ddd2395ff745f5761b945cd11`. Write-up: `reviews/2026-09-25-polymarket-fp5-elo.md`.
- FORM5: **−$88.765702 on 54 trades**, 16 won and 38 lost. Both halves lose. Picked-file sha256 `8436b52b1c9f19bc10c2766fe637305b9e63bffb93ed3969d2564b51f44b42ee`. Both runs sha256 `4ba9e206bc012f35cd6534049838c6537f3937434e90d75f8d87310c4737a08f`. `form_test.py` blob `8249c888ea73fc7273f6e2b8138c1a557f9ca0ba`. Write-up: `reviews/2026-09-25-polymarket-fp5-form5.md`.
- TABLE: **−$100.994277 on 77 trades**, 25 won and 52 lost. The second half has no trade. Picked-file sha256 `8f7ae96775ab570f4ca511676155224a81cd7510f390ad03a53c2422ed054864`. Both runs sha256 `9b9fae253bd8c66e33e8cd53a0631e1c58b99b3d707d098f818e1d2a5fa93115`. `table_test.py` blob `f1d2e1f476e1a4ff6e22609e865810e5529063cd`. Write-up: `reviews/2026-09-25-polymarket-fp5-table.md`.
- REST: **−$9.782792 on 15 trades**, 3 won and 12 lost. One half is positive. Picked-file sha256 `d34c882f0ba495feaff28ec9a025ee7f2587df42007ef30933713292d86b80d8`. Both runs sha256 `425d50638abee22461a556e16037c347da9b76591b28cf7220510d1246947dd8`. `rest_test.py` blob `6637b1aab80e8b58fe792c188b81cfad07c2681b`. Write-up: `reviews/2026-09-25-polymarket-fp5-rest.md`.
- VENUE: **−$141.56766 on 111 trades**, 38 won and 73 lost. Both halves lose. Picked-file sha256 `080e42a4ad04a3beedbf6c72aeb1ef267fe4732dfa4fe51834b59ce31430d730`. Both runs sha256 `9b4ef8c69d235b23909e973e2337c147beaf19a0b64ea23422fce02dd52eafc2`. `venue_test.py` blob `d464f984f049dde0a0b447cad466a01eac04cf2d`. Write-up: `reviews/2026-09-25-polymarket-fp5-venue.md`.
- STREAK3: **−$30.399 on 3 trades**, all lost. The second half has no trade. Picked-file sha256 `882a7e238af8fc97658e67607fca59e59d19c35e31faddba1bfc14823d862879`. Both runs sha256 `8055e5c9320586391d32252c994a1b3f99d00294a885cafe7676494bd4a7a221`. `streak_test.py` blob `a01c09c441a27454b6191aaa776e43f1955d3353`. Write-up: `reviews/2026-09-25-polymarket-fp5-streak3.md`.
- DRAWBASE: **+$361.593043 on 100 trades**, 29 won and 71 lost. The second half is −$54.03. Stress and the null and the trade count and +1,304% a year on a $40 peak pass. January is 56%; without it +$160.28. Picked-file sha256 `772f9690ef83a87c79da214dd12bf9e5f5d5bac8c971e03995ea637495c89a81`. Both runs sha256 `07df6a9fd911e6a2748f86112a96acef9f08fd67aff6735ef534557d9e8af8c8`. `draw_test.py` blob `4f349aafbdc7d588bfe07e87eda48604f77d4996`. Write-up: `reviews/2026-09-25-polymarket-fp5-drawbase.md`. Not retried with January or the second half removed.
- H2H: **+$23.997203 on 120 trades**, 45 won and 75 lost. The second half is −$4.33. February is several times the profit; without it −$73.45. Stress and +49% a year on a $70 peak pass. The null's 95th is +$241.33. Picked-file sha256 `69c81dd8e31f2cfce9bfd0c8d29c94d88cddffd044b3e84e40dc4aa5bb0dfafe`. Both runs sha256 `0f5d4cf29a76c212119b561d1f82c98a79bfbcf016ad92813e3ffcbbb00dfc89`. `h2h_test.py` blob `ea9d1cb8000a285ebba6cf41579ea8c8470991e2`. Write-up: `reviews/2026-09-25-polymarket-fp5-h2h.md`. Not retried with February removed.
- MARGIN: **−$96.802399 on 34 trades**, 8 won and 26 lost. Both halves lose. Picked-file sha256 `d6a3c0ebff48160e55f3cb5ad8d4b01a6e37e166c5ee7e0c9631d93dbe183e1a`. Both runs sha256 `6de94881c50fa9bc9f251e328361c48cc7390738478c2a310314edf43eaa3a1a`. `margin_test.py` blob `2f60de740e0ee64f0dad9f4421d71334eb9f2c90`. Write-up: `reviews/2026-09-25-polymarket-fp5-margin.md`.
