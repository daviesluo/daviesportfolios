...
**fp273–fp280 are frozen. No return of these rules has been computed.** LOUDER failed the later years and is void. LASTUP stays void. UNDER, STALE, FASTER, BACK, INUP and LEDSP were not taken out of sample. The eight rules are DRIFT, ABOVE, DEEPCM, BOTHUP, COOLED, BOTHDOWN, RISE and LAGSP. None uses the opposite side as the other trade. Each null is another trade held the same number of days. Counts taken before this freeze, with no profit computed: DRIFT 131/131, ABOVE 51/51, DEEPCM 134/134, BOTHUP 187/187, COOLED 66/66, BOTHDOWN 141/141, RISE 225/225, LAGSP 174/174. Fillable days were 357/357, 348/348, 342/342, 339/339, 350/350, 338/330, 363/363 and 340/340. The screen count stays 30. A pass of 2023 is not a testing row. No later year of these eight is scored. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.315. No pull request. Main was not pushed.
