...
**fp313–fp320 are scored and reviewed. Four clear 2023 by more than 20 bps and are not taken out of sample. The other four fail. None is a testing row.** The retrospective is §3.369. The eight rules are two sentences copied onto four books: a negative settled funding rate, or a settled rate below the published eight-hour SOFR. The index level was not stored. The open's discount in basis points was not computed. Funding versus SOFR compares two rates, and the fill is a price. The other trade is the same book and the same side with the edge off, not the opposite side. UZERO clears by 70.2341 bps, CZERO by 47.6347 bps, USOFR by 42.5238 bps and MSOFR by 43.1351 bps. EZERO is under its null by 13.7659 bps, BZERO by 52.6487 bps, CSOFR by 3.4805 bps and ESOFR by 24.9594 bps. No book ticker was frozen. No later-year bar is requested as an entry. The next round does not copy either sentence onto another contract, and it does not buy because a close finished under another venue's close. The next eight are not frozen yet. The count stays 30. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.361–§3.369. No pull request. Main was not pushed.
