...
**fp289–fp296 are frozen. No return of these rules has been computed.** Two price edges are stated. The USDT book against spot is DISCU, RICHU, CHEAPS and WIDEN. The coin-margined book against the USDT book is CHEAPC, DISCM, GAPCM and RICHC. Each null is that same leg, on the same prices, with the edge turned off. It is not the opposite side and it is not an unconditional hold. Counts taken before this freeze, with no profit computed: DISCU 84/273, RICHU 57/297, CHEAPS 55/297, WIDEN 46/312, CHEAPC 93/253, DISCM 89/267, GAPCM 148/195, RICHC 87/254. Fillable days were 357, 354, 352, 358, 347, 360, 348 and 342. The five-basis-point line is 0.0005. No profit was computed to choose it. The screen count stays 30. A pass of 2023 is not a testing row. Later years are scored only when the three screen bars pass and the mean net is strictly more than 20 bps above the edge-off trade. fp281–fp288 stay inside 2023. They pick a side. LS-FADE's 60-trade reproduction, the control, doubled costs, and the rule that no month is above 40% of the profit are not relaxed. Reference §3.333. No pull request. Main was not pushed.
