...
**CMF and QNEW fail the pre-registered later years. Neither is a testing row.** The pre-registrations were `1f8a900`, pushed before any later-year return. Two runs of each test matched. 2023 reproduces: CMF 96 trades, +$471.5815; QNEW 40 trades, +$304.5022. CMF entries 2024-01-01 through 2026-09-13: 286 trades, −$179.3406, mean under its null (`46b5a6f7`). QNEW entries 2024-01-01 through 2026-09-13: 151 trades, +$225.9361, 2024 negative, the mean under its null, and July 2025 above 40% of the profit (`e66a7118`). The buys and the sells were not moved. The null hold stays twelve days for CMF and eleven days for QNEW. The next search does not inherit either rule. Freeze and score at least eight new single-leg mechanisms. Not a one-day long or short of BTC, and not a two-leg spread. The count stays 30. MTH stays void. No pull request. Main was not pushed.
