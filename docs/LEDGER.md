...
**fp225–fp232 are frozen and not yet scored. MTH is void.** The matched MTH null failed: 84 trades, mean +811.9657 bps, gross +833.6112 bps, +$682.0512, same-length null +946.023 bps (`dde12644`). That is not a testing row. The later years were not scored. No return of QFAR, PBK, CFD, UFL, SLD, CMF, QNEW or UMFD has been computed. Span counts taken before this freeze, with no profit computed: QFAR 56 (pool 311), PBK 72 (pool 356), CFD 223 (pool 350), UFL 122 (pool 361), SLD 177 (pool 352), CMF 96 (pool 346), QNEW 40 (pool 343), UMFD 206 (pool 357). Each position is one leg. The count stays 30. No pull request. Main was not pushed.
