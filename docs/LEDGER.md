...
**fp241–fp248 are protocols only. No return of these rules has been computed.** HI10 and STEP failed the later years at `744353b` and are not testing rows. Counts taken before this freeze, with no profit computed: DROP 150 (pool 342), UPRI 198 (pool 357), AHEAD 171 (pool 354), CALM 161 (pool 352), CDEC 123 (pool 351), TRIP 55 (pool 356), CFAL 64 (pool 348), BOUN 53 (pool 345). A spot-down and USDT-up pair had 0 spans and was not scored. Each position is one leg. Each null is that payoff held the same number of days, the extra condition off. The count stays 30. CMF and QNEW stay failed. MTH stays void. No pull request. Main was not pushed.
