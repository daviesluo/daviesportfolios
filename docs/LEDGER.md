...
**fp324–fp331 are frozen and have not been scored.** Eight published prices, each a different series. The other trade is the same spot book, same side, with the edge off. Span counts, with no profit computed: GLDPM 154/157, ECBFX 160/182, BMACP 148/194, CPIPP 107/212, PPIPP 130/173, WAGPP 93/160, CLTHP 120/199, AIRPP 146/173. Holds are two days. Thresholds are 50, 25, 200, 1, 500, 500, 1000 and 1 basis points, the smallest line at which the cheap set has at least 30 spans and the edge-off set is at least as long. Every pair of cheap sets is under 80 percent of the smaller set. Not shipped, and no return computed: M2 at 1 bp had 27 cheap spans; unit labour costs, rent, services, house prices, energy, used cars, new cars and hotels overlapped a shipped set; food at 1 bp had 18 cheap spans; annual GDP purchasing power was the longer set. Realised price, par, and another threshold are not retested. No return of these rules has been computed. No testing row. The gap bar stays strictly more than 20 bps. The count stays 30. Score only after this protocol is on the branch. The next eight are not frozen. Reference §3.376. No pull request. Main was not pushed.
