...
**LOUDER is pre-registered. No later-year return has been computed.** LASTUP is void: the other trade was the same-day short. A losing short is not the control for a long. UNDER and STALE are not taken out of sample. UNDER cleared by 4.2411 bps and STALE by 0.6983 bps, the same class as PICK, and neither is a testing row. FASTER, BACK, INUP and LEDSP have negative means and are not taken out of sample. The USDT book was read at 2026-09-25T13:39:52.405491Z (bid 84066.00, ask 84066.10, half-spread 5.947704216257381e-07). LOUDER's other trade stays the quieter twenty-one-day USDT long. The cutoff stays the sample p95, not the quieter mean. The buy and the sell were not moved. A mean that clears the p95 by 10 bps or less voids the rule. A pass is not a testing row. The file is `docs/agents/reviews/2026-09-25-fp268-prereg-louder.md`. The next eight are not frozen. No pull request. Main was not pushed.
