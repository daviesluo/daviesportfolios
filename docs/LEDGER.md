...
**fp217–fp224 are scored. MTH passes the 2023 screen and is not a testing row. The other seven fail.** The protocol was `3acc6ef`, pushed before any of these returns. Two runs of each screen matched. MONX 52 trades, +$38.192, mean under its null. MTH 84 trades, +$682.0512, mean +811.9657 bps against a null of +787.6951 bps. XEXP 112 trades, +$1049.0852, mean under its null. BRD 81 trades, +$223.6303, mean under its null. SMO 204 trades, +$356.3532, mean under its null. FRI7 51 trades, +$95.2098, mean under its null. FWK 135 trades, +$349.8649, mean under its null. CMS 171 trades, −$198.117, mean negative and above its null. Each position is one leg. The later years of MTH are not scored. The count stays 30. No rule was rewritten. No pull request. Main was not pushed.
