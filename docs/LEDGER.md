...
**fp233–fp240 are protocols only. No return of these rules has been computed.** CMF and QNEW failed the later years at `3d46536` and are not testing rows. Counts taken before this freeze, with no profit computed: HI10 74 (pool 358), UMSH 82 (pool 355), TRI 203 (pool 351), BNC 59 (pool 356), STEP 112 (pool 362), GAP 96 (pool 360), QUIET 179 (pool 353), LEAD 177 (pool 361). An opposite-sign five-day pair had 1 span, a Friday filter had 19, and a twenty-one-day sign split had 0. None of those three was scored. Each position is one leg. Each null is that payoff held the same number of days, the extra condition off. The count stays 30. MTH stays void. No pull request. Main was not pushed.
