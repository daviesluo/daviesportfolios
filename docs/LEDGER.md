...
**fp257–fp264 are protocols only. No return of these rules has been computed.** Pins printed fp257 through fp264 pins ok. `FP257_OOS` aborts the pull and the scorer. Counts taken before this freeze, with no profit computed: PICK 156 (other trade 156, fillable 349 and 357), FADEU 214 (214, 353 and 353), DEFER 144 (144, 356 and 356), CMLAG 170 (170, 350 and 342), LAGB 169 (169, 360 and 352), OTHER 108 (240, 348 and 348), LATER 87 (87, 351 and 351), AFTER 154 (154, 352 and 344). OTHER's shorter regime is the rule. The five-day and fifteen-day windows were not moved. That assignment used the counts only. PICK buys the coin-margined book for nine days after a finished four-day spot decline; the other trade buys spot. FADEU shorts the USDT book for thirteen days after a finished twelve-day rise; the other trade is the long. DEFER shorts spot for ten days after a finished six-day decline; the other trade shorts spot ten days later. CMLAG buys the USDT book for sixteen days when spot's finished eight-day return beat the coin-margined return; the other trade buys the coin-margined book. LAGB shorts the USDT book for six days when the coin-margined eleven-day return lagged spot; the other trade shorts the coin-margined book. OTHER buys the coin-margined book for ten days when the absolute five-day spot return finished larger than the absolute fifteen-day return; the other trade is the quieter regime. LATER buys spot for fifteen days after a new two-day rise; the other trade buys spot fifteen days later. AFTER buys the USDT book for fourteen days after spot and USDT both finished a five-day decline; the other trade buys the coin-margined book. Each position is one leg. Each null is the other trade, held the same number of days, not the same leg with the condition off. A missing open is not taken from another book. The count stays 30. No percentile is used. No sign of a killed rule is flipped. TRIP and CFAL were not rewritten. A Binance daily open is not a Revolut X fill. No pull request. Main was not pushed.

**A Binance daily open that clears a numerical gate is not a Revolut X fill.** Davies, 2026-09-25: passing that gate does not mean Revolut X can trade it. The result is not written up as a Revolut X paper-testing candidate. A nearby signal is not substituted to force a pass. A rule still has to know its signal before the entry. The fill has to be a price that exists on that contract. LS-FADE's 60-trade reproduction, the control, and doubled costs are not relaxed. No testing row is added. LS-FADE stays failed (§3.34) and is not rewritten. This search's screen count stays 30. fp257–fp264 are frozen above and have no return yet.
