...
**fp321–fp323 are frozen. No return of these rules has been computed.** §3.369 said the previous eight were two funding sentences, and that a rate is not a price. This round is three rules. Copying one sentence onto more coins, thresholds, or exchanges is the failure that section records. EREAL buys ETHUSD_PERP for two days when the previous close is at least 1 bp under the Coin Metrics realized ETH price. Counts with no profit: 31 / 325, with 2 neither and 358 fillable. Five basis points selects the same 31 days and is not a second rule. WBRAT buys WBETHETH for two days when that close is at least 25 bp under Binance's published WBETH exchange rate. At 1 bp and at 10 bp the cheap set was longer, and the short was not taken. Counts: 43 / 189, with 1 neither and 233 fillable. WBPAR buys WBTCBTC for two days when that close is at least 1 bp under the standing 1 BTC par. Counts: 167 / 196, with 1 neither and 364 fillable. BTC realized price had 12 cheap days and was not shipped. Thermocap price had 0. USDC and BETH against par 1 are the same par sentence and were not shipped. A USD fix was not paired with a USDT quote. Funding signs, funding versus SOFR, and another venue's close are not in this round. The fill is that contract's own open. The other trade is the same leg with the discount below the threshold. The screen count stays 30. fp313–fp320 stay inside 2023 and are not taken out of sample. No testing row is added. No pull request. Main was not pushed.
