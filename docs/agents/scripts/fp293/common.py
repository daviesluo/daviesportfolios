"""The search fp293. Fair value of the coin-margined book is the USDT close. The finished coin-margined close was strictly under that fair value. Buy the coin-margined book for eleven days. The other trade buys it for eleven days when it is not cheap to the USDT book.
