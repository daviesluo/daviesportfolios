"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp241/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp241-research"}
...
def main() -> None:
    ...
    counts.append(len(pull("cm", "BTCUSD_PERP", c.fp5.SCREEN_END_MS, "cm1d")))
    print("fp241 " + " ".join(str(n) for n in counts))
