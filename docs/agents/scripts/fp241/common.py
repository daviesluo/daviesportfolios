"""The search fp241. A finished three-day spot decline, then a sixteen-day coin-margined long.
...
not added. The null is that same 16-day long on every day.
"""
