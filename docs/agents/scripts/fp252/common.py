"""The search fp252. The absolute five-day spot return finished inside the absolute twenty-day return, then a twenty-day coin-margined long.
...
not added. The null is that same 20-day long on every day.
"""
...
def _signal(spot: dict, cm: dict, entry: int) -> bool:
    ...
    near = finished(spot, entry, 5)
    far = finished(spot, entry, 20)
