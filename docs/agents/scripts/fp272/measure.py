"""Score the fp272 screen. 2023 entries only.

    python3 docs/agents/scripts/fp272/measure.py
"""
...
def run() -> None:
    ...
    if c.IDEA != 'LEDSP' or c.MIN_N != 30 or c.HOLD_DAYS != 24:
    ...
    payload = {
        ...
        "code_sha256": {
            "fp272_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp272_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp272/screen_2023.json"
