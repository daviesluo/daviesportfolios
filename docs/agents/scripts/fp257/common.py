"""The search fp257. After a finished four-day spot decline, buy the coin-margined book for nine days. The other trade buys spot for those same nine days.
...
def _signal(spot, um, cm, entry) -> bool:
    move = finished(spot, entry, 4)
    return move is not None and move < 0.0
