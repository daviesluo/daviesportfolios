"""Score the fp29 screen. 2023 only.

    python3 docs/agents/scripts/fp29/measure.py
"""
...
PROTOCOL = ROOT / "docs/agents/reviews/2026-09-25-fp29-protocol.md"
...
def main() -> None:
    ...
    row = c.fp5.summarise(
        "PEAK", c.peak_trades(daily), pool, c.MIN_N,
        "Close versus the prior 30 daily closes' high, above its own trailing 90th. Next day, long BTC.",
    )
    payload = {
        "protocol_sha256": sha256(PROTOCOL),
        "code_sha256": {
            "fp29_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp29_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp29/screen_2023.json"
