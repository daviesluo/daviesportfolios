"""Pull the public series the fp121 screen is allowed to see.
...
requested. ETH, BNB, DOGE and XRP option files are not requested.
    ...
    python3 docs/agents/scripts/fp121/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp121-research"}
SPOT_FIELDS = (1,)
