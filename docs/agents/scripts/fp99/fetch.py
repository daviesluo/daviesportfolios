"""Pull daily bars for the fp99 screen.

ADAUSDT and BTCUSDT each store the open and quote volume. The 2024-01-01
...
exit and cannot be a print. No hourly bar is requested.
    ...
    python3 docs/agents/scripts/fp99/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp99-research"}
...
def main() -> None:
    ...
    btc = pull("BTCUSDT")
    print(
        f"fp99 ADAUSDT 1d {len(alt)} first {min(alt)} last {max(alt)}; "
