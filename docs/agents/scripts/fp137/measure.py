"""Score the fp137 screen. 2023 entries only. The hold is one day.

    python3 docs/agents/scripts/fp137/measure.py
"""
...
PROTOCOL = ROOT / "docs/agents/reviews/2026-09-25-fp137-protocol.md"
NOTE = "Sum of today's three BTC funding rates minus yesterday's sum, above its own trailing 90th. Next day, long BTC for one day."
...
def main() -> None:
    ...
    row = c.fp5.summarise("FRJMP", trades, pool, c.MIN_N, NOTE)
    payload = {
        "protocol_sha256": sha256(PROTOCOL),
        "code_sha256": {
            "fp137_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp137_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp137/screen_2023.json"
