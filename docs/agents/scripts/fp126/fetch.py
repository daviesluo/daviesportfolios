"""Pull the public series the fp126 screen is allowed to see.
...
requested. ETH, BNB, DOGE and XRP option files are not requested.
    ...
    python3 docs/agents/scripts/fp126/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp126-research"}
SPOT_FIELDS = (1,)
    ...
    for ymd in days:
        ...
        for row in reader:
            ...
            if delta is None or oi is None:
                continue
            out_rows.append((float(hour), delta, oi))
