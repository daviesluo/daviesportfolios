...
"""Pins for the fp312 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'WBTCH' or c.HOLD_DAYS != 16 or c.NULL_KIND != "other_regime":
    ...
    if c.FAIR_KEY != 'wb' or c.FAIR_KEY in ("spot", "um", "cm", "cb", "db"):
