"""Score the fp26 screen. 2023 only.

    python3 docs/agents/scripts/fp26/measure.py
"""
...
PROTOCOL = ROOT / "docs/agents/reviews/2026-09-25-fp26-protocol.md"
...
def main() -> None:
    ...
    row = c.fp5.summarise(
        "BODY", c.body_trades(daily), pool, c.MIN_N,
        "Body as a share of the day's range, above its own trailing 90th. Next day, long BTC.",
    )
    payload = {
        "protocol_sha256": sha256(PROTOCOL),
        "code_sha256": {
            "fp26_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp26_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp26/screen_2023.json"
