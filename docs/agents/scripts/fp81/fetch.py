...
because it can be an exit. A later open is a bug.
    ...
    python3 docs/agents/scripts/fp81/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp81-research"}
...
def main() -> None:
    ...
    print(
        f"fp81 BTCUSDT 1h {len(hourly)} first {min(hourly)} last {max(hourly)}; "
