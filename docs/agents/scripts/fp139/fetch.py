"""Pull the taker long/short volume ratio for the fp139 screen. The level is not the stored signal. No other metrics column is stored. No spot taker-buy field is requested.

    python3 docs/agents/scripts/fp139/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp139-research"}
...
COLUMN = 7
COLUMN_NAME = "sum_taker_long_short_vol_ratio"
METRICS_REL = "metrics/taker_range.json"
