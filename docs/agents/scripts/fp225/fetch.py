"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp225/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp225-research"}
...
def main() -> None:
    ...
    for expiry, symbol in c.QUARTERS:
        counts.append(len(pull("cm", symbol, (1,), True, expiry, "cm1d")))
    print("fp225 " + " ".join(str(n) for n in counts))
