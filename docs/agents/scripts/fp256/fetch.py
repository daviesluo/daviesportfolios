"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp256/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp256-research"}
...
def main() -> None:
    ...
    counts.append(len(pull("um", "BTCUSDT", end, "um1d")))
    print("fp256 " + " ".join(str(n) for n in counts))
