"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp228/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp228-research"}
...
def main() -> None:
    ...
    rows = pull("um", "BTCUSDT", (1, 4), False, c.fp5.SCREEN_END_MS, "um1d")
    print("fp228 " + str(len(rows)))
