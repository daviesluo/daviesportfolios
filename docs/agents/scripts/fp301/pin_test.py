...
"""Pins for the fp301 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'DBCHP' or c.HOLD_DAYS != 11 or c.NULL_KIND != "other_regime":
        raise SystemExit("the idea moved")
    if c.MODE != "regime" or c.RULE_SIDE != 'long' or c.RULE_BOOK != 'um':
        raise SystemExit("the leg moved")
    if c.EDGE != 'cheap' or c.DISCOUNT != 0.0 or c.WIDEN_LAG != 0:
