"""Score the fp301 screen. 2023 entries only.

    python3 docs/agents/scripts/fp301/measure.py
"""
...
def run() -> None:
    ...
    if c.IDEA != 'DBCHP' or c.MIN_N != 30 or c.HOLD_DAYS != 11 or c.NULL_KIND != "other_regime":
    ...
    payload = {
        ...
        "code_sha256": {
            "fp301_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp301_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp301/screen_2023.json"
