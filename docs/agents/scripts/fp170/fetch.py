"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp170/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp170-research"}
...
def main() -> None:
    ...
    spot = pull_opens(c.fp5.SCREEN_END_MS, (1,))
    print("fp170 " + f"funding {len(funding)} spot {len(spot)} last {max(spot)}")
