"""The search fp278. Spot and the USDT book both finished a nine-day decline. Sell the USDT book for twenty-eight days. The other trade sells the coin-margined book for those same twenty-eight days. The entry open is not an input. One leg.
...
def _signal(spot, um, cm, entry) -> bool:
    spot_ret = finished(spot, entry, 9)
