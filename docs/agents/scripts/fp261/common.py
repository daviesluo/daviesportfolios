"""The search fp261. When the finished eleven-day coin-margined return is below the finished eleven-day spot return, short the USDT book for six days. The other trade shorts the coin-margined book for those same six days.
...
def _signal(spot, um, cm, entry) -> bool:
    s = finished(spot, entry, 11)
    m = finished(cm, entry, 11)
    return s is not None and m is not None and m < s
