"""Score the fp57 screen. 2023 only.

    python3 docs/agents/scripts/fp57/measure.py
"""
...
PROTOCOL = ROOT / "docs/agents/reviews/2026-09-25-fp57-protocol.md"
...
def main() -> None:
    ...
    row = c.fp5.summarise(
        "BASE-CHG", c.base_trades(daily), pool, c.MIN_N,
        "Rise in base volume, above its own trailing 90th. Next day, long BTC.",
    )
    payload = {
        "protocol_sha256": sha256(PROTOCOL),
        "code_sha256": {
            "fp57_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp57_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp57/screen_2023.json"
