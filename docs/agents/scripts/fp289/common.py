"""The search fp289. Fair value of the USDT book is the spot close. The finished USDT close was at least five basis points under that fair value. Buy the USDT book for nine days. The other trade buys it for nine days when that discount is absent.
