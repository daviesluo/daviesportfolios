...
"""Pins for the fp289 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'DISCU' or c.HOLD_DAYS != 9 or c.NULL_KIND != "other_regime":
