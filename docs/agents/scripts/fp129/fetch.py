...
bar is requested. No funding print is requested. No mempool chart is requested.
    ...
    python3 docs/agents/scripts/fp129/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp129-research"}
SPOT_FIELDS = (1,)
...
CHART = "https://api.blockchain.info/charts/avg-block-size"
UNIT = "MB"
