"""The search fp302. Fair value is the Deribit BTC-PERPETUAL daily close. The finished coin-margined close was at least five basis points above that close, so the next coin-margined open is a price that finished rich to Deribit. Sell the coin-margined book for sixteen days. The other trade sells the coin-margined book for sixteen days on these same prices when that premium is absent.
