...
"""Pins for the fp306 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'BFXRH' or c.HOLD_DAYS != 12 or c.NULL_KIND != "other_regime":
    ...
    if c.FAIR_KEY != 'bf' or c.FAIR_KEY in ("spot", "um", "cm", "cb", "db"):
