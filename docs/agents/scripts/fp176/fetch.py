"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp176/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp176-research"}
...
def main() -> None:
    ...
    spot = pull_opens(end, (1, 2, 3, 4))
    print("fp176 " + f"spot {len(spot)} last {max(spot)}")
