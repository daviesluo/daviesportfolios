"""The search fp106. The fill and the null are fp5's.
...
is read. No alt quote is read. The hold is 5 days, fixed in this file.
"""
...
def frng_trades(
    ...
    """Enter the next BTC daily open. Hold 5 days. The open is not an input."""
    trades = []
