"""Score the fp263 screen. 2023 entries only.

    python3 docs/agents/scripts/fp263/measure.py
"""
...
def run() -> None:
    ...
    if c.IDEA != 'LATER' or c.MIN_N != 30 or c.HOLD_DAYS != 15:
    ...
    payload = {
        ...
        "code_sha256": {
            "fp263_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp263_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp263/screen_2023.json"
