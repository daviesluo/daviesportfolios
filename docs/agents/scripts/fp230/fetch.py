"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp230/fetch.py
"""
...
def main() -> None:
    ...
    cm = pull("cm", "BTCUSD_PERP", (1, 4), False, c.fp5.SCREEN_END_MS, "cm1d")
    spot = pull("spot", "BTCUSDT", (4,), False, last, "spot1d")
    print(f"fp230 cm {len(cm)} spot {len(spot)}")
