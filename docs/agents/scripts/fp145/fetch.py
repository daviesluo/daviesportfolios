"""Pull the last taker long/short volume ratio. The range is not stored. No hourly price bar is requested.

    python3 docs/agents/scripts/fp145/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp145-research"}
