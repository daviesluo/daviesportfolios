"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp226/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp226-research"}
...
def main() -> None:
    ...
    rows = pull("spot", "BTCUSDT", (1, 4), False, c.fp5.SCREEN_END_MS, "spot1d")
    print("fp226 " + str(len(rows)))
