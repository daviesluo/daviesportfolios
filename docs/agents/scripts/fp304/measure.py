"""Score the fp304 screen. 2023 entries only.

    python3 docs/agents/scripts/fp304/measure.py
"""
...
def run() -> None:
    ...
    if c.IDEA != 'DBWDN' or c.MIN_N != 30 or c.HOLD_DAYS != 10 or c.NULL_KIND != "other_regime":
    ...
    payload = {
        ...
        "code_sha256": {
            "fp304_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp304_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp304/screen_2023.json"
