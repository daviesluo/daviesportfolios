"""The search fp297. Fair value is the Coinbase Exchange BTC-USD daily close. The finished USDT close was at least ten basis points under that close, so the next USDT open is a price that finished cheap to Coinbase. Buy the USDT book for nine days. The other trade buys the USDT book for nine days on these same prices when that discount is absent.
