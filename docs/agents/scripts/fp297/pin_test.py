...
"""Pins for the fp297 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'CBCHP' or c.HOLD_DAYS != 9 or c.NULL_KIND != "other_regime":
        raise SystemExit("the idea moved")
    if c.MODE != "regime" or c.RULE_SIDE != 'long' or c.RULE_BOOK != 'um':
        raise SystemExit("the leg moved")
    if c.EDGE != 'cheap' or c.DISCOUNT != 0.001 or c.WIDEN_LAG != 0:
