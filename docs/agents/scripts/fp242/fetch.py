"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp242/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp242-research"}
...
def main() -> None:
    ...
    counts.append(len(pull("um", "BTCUSDT", last, "um1d")))
    counts.append(len(pull("spot", "BTCUSDT", c.fp5.SCREEN_END_MS, "spot1d")))
    print("fp242 " + " ".join(str(n) for n in counts))
