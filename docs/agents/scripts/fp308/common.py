"""The search fp308. Fair value is the OKX spot BTC-USDT daily close. The finished Binance spot close was strictly under that close, so the next Binance spot open is a price that finished cheap to OKX. Buy Binance spot for fourteen days. The other trade buys Binance spot for fourteen days on these same prices when that discount is absent.
...
FILES = {
    ...
    FAIR_KEY: ('ox1d/BTC-USDT.json', False),
}
PULLS = [
    ('spot', 'BTCUSDT', 'spot1d', True),
    ('ox', 'BTC-USDT', 'ox1d', False),
]
