...
"""Pins for the fp308 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'OKXCH' or c.HOLD_DAYS != 14 or c.NULL_KIND != "other_regime":
    ...
    if c.FAIR_KEY != 'ox' or c.FAIR_KEY in ("spot", "um", "cm", "cb", "db"):
