"""Pull daily bars for the fp101 screen.

LINKUSDT and BTCUSDT each store the open and quote volume. The 2024-01-01
...
exit and cannot be a print. No hourly bar is requested.
    ...
    python3 docs/agents/scripts/fp101/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp101-research"}
...
def main() -> None:
    ...
    btc = pull("BTCUSDT")
    print(
        f"fp101 LINKUSDT 1d {len(alt)} first {min(alt)} last {max(alt)}; "
