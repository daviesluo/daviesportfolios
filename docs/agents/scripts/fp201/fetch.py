"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp201/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp201-research"}
