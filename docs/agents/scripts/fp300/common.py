"""The search fp300. Fair value is the Coinbase Exchange BTC-USD daily close. The basis is the finished USDT close over that fair value. It finished positive and strictly above the basis five days earlier, so the next USDT open sells a premium to Coinbase that has widened. Sell the USDT book for eight days. The other trade sells the USDT book for eight days on these same prices when that wider premium is absent.
...
WIDEN_LAG = 5
FAIR_KEY = 'cb'
FAIR_LAST_MS = fp5.SCREEN_END_MS - fp5.DAY_MS
RULE_BOOK = 'um'
NULL_BOOK = 'um'
RULE_SIDE = 'short'
NULL_SIDE = 'short'
FILES = {
    ...
    FAIR_KEY: ('cb1d/BTC-USD.json', False),
}
PULLS = [
    ('um', 'BTCUSDT', 'um1d', True),
    ('cb', 'BTC-USD', 'cb1d', False),
]
