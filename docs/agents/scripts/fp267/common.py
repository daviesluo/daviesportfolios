"""The search fp267. A finished three-day USDT decline was strictly faster than the three-day window that ended three days earlier. Sell the USDT book for eight days. The other trade sells it eight days later for another eight days.
...
def _signal(spot, um, cm, entry) -> bool:
    ...
    prev = finished(um, entry - 3 * fp5.DAY_MS, 3)
