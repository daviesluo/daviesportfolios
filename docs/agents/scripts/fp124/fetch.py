"""Pull the public series the fp124 screen is allowed to see.
...
requested. ETH, BNB, DOGE and XRP option files are not requested.
    ...
    python3 docs/agents/scripts/fp124/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp124-research"}
SPOT_FIELDS = (1,)
    ...
    for ymd in days:
        ...
        for row in reader:
            ...
            if gamma is None or oi is None:
                continue
            out_rows.append((float(hour), gamma, oi))
