"""The search fp311. Fair value is the HTX btcusdt daily close, published at 16:00 UTC. The finished USDT close was strictly under the latest HTX close whose bucket had already ended, so the next USDT open is a price that finished cheap to HTX. Buy the USDT book for ten days. The other trade buys the USDT book for ten days on these same prices when that discount is absent.
...
WIDEN_LAG = 0
FAIR_KEY = 'hx'
FAIR_SHIFT_MS = 57600000
LOOKBACK_MS = 1667318400000
...
FILES = {
    ...
    FAIR_KEY: ('hx1d/btcusdt.json', False),
}
PULLS = [
    ('um', 'BTCUSDT', 'um1d', True),
    ('hx', 'btcusdt', 'hx1d', False),
]
