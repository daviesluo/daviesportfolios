"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp227/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp227-research"}
...
def main() -> None:
    ...
    rows = pull("cm", "BTCUSD_PERP", (1, 4), False, c.fp5.SCREEN_END_MS, "cm1d")
    print("fp227 " + str(len(rows)))
