...
because it can be an exit. A later open is a bug.
    ...
    python3 docs/agents/scripts/fp86/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp86-research"}
...
def main() -> None:
    ...
    print(
        f"fp86 BTCUSDT 1h {len(hourly)} first {min(hourly)} last {max(hourly)}; "
