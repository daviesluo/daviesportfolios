"""The search fp109. The fill and the null are fp5's.
...
is read. No alt quote is read. The hold is 10 days, fixed in this file.
"""
...
def frng_trades(
    ...
    """Enter the next BTC daily open. Hold 10 days. The open is not an input."""
    trades = []
