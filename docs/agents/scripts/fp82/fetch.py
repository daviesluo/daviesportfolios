...
because it can be an exit. A later open is a bug.
    ...
    python3 docs/agents/scripts/fp82/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp82-research"}
...
def main() -> None:
    ...
    print(
        f"fp82 BTCUSDT 1h {len(hourly)} first {min(hourly)} last {max(hourly)}; "
