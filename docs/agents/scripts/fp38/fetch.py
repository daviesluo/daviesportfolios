"""Pull BTCUSDT bars for the fp38 screen.
...
entry. A later open is a bug.
    ...
    python3 docs/agents/scripts/fp38/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp38-research"}
...
def main() -> None:
    ...
    print(
        f"fp38 BTCUSDT 1h {len(hourly)} first {min(hourly)} last {max(hourly)}; "
