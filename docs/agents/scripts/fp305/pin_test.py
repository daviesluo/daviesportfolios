...
"""Pins for the fp305 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'BSTCH' or c.HOLD_DAYS != 9 or c.NULL_KIND != "other_regime":
    ...
    if c.FAIR_KEY != 'bs' or c.FAIR_KEY in ("spot", "um", "cm", "cb", "db"):
