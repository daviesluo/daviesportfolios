"""Score the fp303 screen. 2023 entries only.

    python3 docs/agents/scripts/fp303/measure.py
"""
...
def run() -> None:
    ...
    if c.IDEA != 'DBCMC' or c.MIN_N != 30 or c.HOLD_DAYS != 6 or c.NULL_KIND != "other_regime":
    ...
    payload = {
        ...
        "code_sha256": {
            "fp303_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp303_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp303/screen_2023.json"
