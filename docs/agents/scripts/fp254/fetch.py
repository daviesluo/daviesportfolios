"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp254/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp254-research"}
...
def main() -> None:
    ...
    counts.append(len(pull("cm", "BTCUSD_PERP", end, "cm1d")))
    print("fp254 " + " ".join(str(n) for n in counts))
