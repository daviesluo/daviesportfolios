"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp164/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp164-research"}
...
def main() -> None:
    ...
    spot = pull_opens(end, "spot1d/BTCUSDT.json", (1, 2, 3, 4))
    print("fp164 " + f"spot {len(spot)} last {max(spot)}")
