"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp255/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp255-research"}
...
def main() -> None:
    ...
    counts.append(len(pull("spot", "BTCUSDT", end, "spot1d")))
    print("fp255 " + " ".join(str(n) for n in counts))
