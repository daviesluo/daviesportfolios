"""Pull daily bars for the fp102 screen.

LTCUSDT and BTCUSDT each store the open and quote volume. The 2024-01-01
...
exit and cannot be a print. No hourly bar is requested.
    ...
    python3 docs/agents/scripts/fp102/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp102-research"}
...
def main() -> None:
    ...
    btc = pull("BTCUSDT")
    print(
        f"fp102 LTCUSDT 1d {len(alt)} first {min(alt)} last {max(alt)}; "
