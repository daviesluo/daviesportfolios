"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp202/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp202-research"}
...
def main() -> None:
    ...
    um = pull_klines("um", "BTCUSDT", "um1d/BTCUSDT.json", (4, 5, 7), last, (2022, 12))
    ...
    print("fp202 " + f"um {len(um)} cm {len(cm)} last {max(cm)}")
