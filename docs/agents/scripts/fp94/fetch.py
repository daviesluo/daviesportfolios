...
because it can be an exit. A later open is a bug.
    ...
    python3 docs/agents/scripts/fp94/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp94-research"}
...
def main() -> None:
    ...
    print(
        f"fp94 BTCUSDT 1h {len(hourly)} first {min(hourly)} last {max(hourly)}; "
