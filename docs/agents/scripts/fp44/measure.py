"""Score the fp44 screen. 2023 only.

    python3 docs/agents/scripts/fp44/measure.py
"""
...
PROTOCOL = ROOT / "docs/agents/reviews/2026-09-25-fp44-protocol.md"
...
def main() -> None:
    ...
    row = c.fp5.summarise(
        "OPEN-DRIVE", c.drive_trades(daily, hours), pool, c.MIN_N,
        "The first hour's return, above its own trailing 90th. Next day, long BTC.",
    )
    payload = {
        "protocol_sha256": sha256(PROTOCOL),
        "code_sha256": {
            "fp44_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp44_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp44/screen_2023.json"
