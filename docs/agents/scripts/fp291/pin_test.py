...
"""Pins for the fp291 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'CHEAPS' or c.HOLD_DAYS != 14 or c.NULL_KIND != "other_regime":
