"""The search fp291. Fair value of spot is the USDT close. The finished spot close was strictly under that fair value. Buy spot for fourteen days. The other trade buys spot for fourteen days when it is not cheap to the USDT book.
...
RULE_SIDE = 'long'
NULL_SIDE = 'long'
FILES = {'spot': ('spot1d/BTCUSDT.json', True), 'um': ('um1d/BTCUSDT.json', False)}
PULLS = [('spot', 'BTCUSDT', 'spot1d', True), ('um', 'BTCUSDT', 'um1d', False)]
