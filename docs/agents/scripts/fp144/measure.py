"""Score the fp144 screen. 2023 entries only. The hold is one day.

    python3 docs/agents/scripts/fp144/measure.py
"""
...
PROTOCOL = ROOT / "docs/agents/reviews/2026-09-25-fp144-protocol.md"
NOTE = "The 16:00 BTC funding rate minus the 00:00 rate, above its own trailing 90th. Next day, long BTC for one day."
...
def main() -> None:
    ...
    signal = load_book(DATA / "funding/ends.json")
    ...
    row = c.fp5.summarise("FRIN", trades, pool, c.MIN_N, NOTE)
    payload = {
        "protocol_sha256": sha256(PROTOCOL),
        "code_sha256": {
            "fp144_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp144_measure": sha256(Path(__file__)),
            "fp5_common": sha256(Path(__file__).resolve().parents[1] / "fp5" / "common.py"),
        },
        "input_sha256": {
            "funding_ends": sha256(DATA / "funding/ends.json"),
    ...
    out = ROOT / "docs/agents/backtests/fp144/screen_2023.json"
