"""The search fp290. Fair value of the USDT book is the spot close. The finished USDT close was strictly above that fair value. Sell the USDT book for twelve days. The other trade sells it for twelve days when it is not rich to spot.
