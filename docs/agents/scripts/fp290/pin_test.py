...
"""Pins for the fp290 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'RICHU' or c.HOLD_DAYS != 12 or c.NULL_KIND != "other_regime":
