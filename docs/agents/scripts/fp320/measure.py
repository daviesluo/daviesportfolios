"""Score the fp320 screen. 2023 entries only.

    python3 docs/agents/scripts/fp320/measure.py
"""
...
def run() -> None:
    ...
    if c.IDEA != "MSOFR" or c.MIN_N != 30 or c.HOLD_DAYS != 2 or c.FAIR_KIND != "sofr":
    ...
    payload = {
        ...
        "code_sha256": {
            "fp320_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp320_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp320/screen_2023.json"
