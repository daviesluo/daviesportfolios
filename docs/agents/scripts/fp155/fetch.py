"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp155/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp155-research"}
...
def main() -> None:
    ...
    taker = pull_metric_ends("2023-12-31", "taker")
    spot = pull_opens("BTCUSDT", "/api/v3/klines", end, "spot1d/BTCUSDT.json", 2)
    print("fp155 " + f"taker {len(taker)} spot {len(spot)}")
