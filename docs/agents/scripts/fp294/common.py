"""The search fp294. Fair value of the USDT book is the coin-margined close. The finished USDT close was at least five basis points under that fair value. Buy the USDT book for six days. The other trade buys it for six days when that discount is absent.
...
RULE_SIDE = 'long'
NULL_SIDE = 'long'
FILES = {'um': ('um1d/BTCUSDT.json', True), 'cm': ('cm1d/BTCUSD_PERP.json', False)}
PULLS = [('um', 'BTCUSDT', 'um1d', True), ('cm', 'BTCUSD_PERP', 'cm1d', False)]
