...
"""Pins for the fp294 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'DISCM' or c.HOLD_DAYS != 6 or c.NULL_KIND != "other_regime":
