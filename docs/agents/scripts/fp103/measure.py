"""Score the fp103 screen. 2023 entries only. The hold is 2 days.

    python3 docs/agents/scripts/fp103/measure.py
"""
...
PROTOCOL = ROOT / "docs/agents/reviews/2026-09-25-fp103-protocol.md"
...
def main() -> None:
    ...
    row = c.fp5.summarise(
        "FRNG-2", trades, pool, c.MIN_N,
        "Range of BTC's three funding prints, above its own trailing 90th. "
        "Next day, long BTC for 2 days.",
    )
    payload = {
        "protocol_sha256": sha256(PROTOCOL),
        "code_sha256": {
            "fp103_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp103_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp103/screen_2023.json"
