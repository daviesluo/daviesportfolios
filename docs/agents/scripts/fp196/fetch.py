"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp196/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp196-research"}
...
def main() -> None:
    ...
    print("fp196 " + f"spot {len(spot)} last {max(spot)} cm {len(cm)} last {max(cm)}")
