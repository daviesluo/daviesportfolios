...
bar is requested. No funding print is requested. No mempool chart is requested.
    ...
    python3 docs/agents/scripts/fp130/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp130-research"}
SPOT_FIELDS = (1,)
...
CHART = "https://api.blockchain.info/charts/median-confirmation-time"
UNIT = "Minutes"
