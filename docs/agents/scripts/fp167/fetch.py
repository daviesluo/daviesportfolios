"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp167/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp167-research"}
...
def main() -> None:
    ...
    spot = pull_opens(c.fp5.SCREEN_END_MS, "spot1d/BTCUSDT.json", (1, 2, 3, 4))
    print("fp167 " + f"spot {len(spot)} last {max(spot)}")
