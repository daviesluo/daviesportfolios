...
"""Pins for the fp307 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'MEXCH' or c.HOLD_DAYS != 7 or c.NULL_KIND != "other_regime":
    ...
    if c.FAIR_KEY != 'mx' or c.FAIR_KEY in ("spot", "um", "cm", "cb", "db"):
