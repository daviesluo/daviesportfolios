"""The search fp275. The finished six-day coin-margined return was negative. Sell the coin-margined book for sixteen days. The other trade sells it sixteen days later for another sixteen days. Both windows have to fill. The entry open is not an input. One leg.
