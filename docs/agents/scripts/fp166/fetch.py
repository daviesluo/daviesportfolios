"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp166/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp166-research"}
...
def main() -> None:
    ...
    spot = pull_opens(end, "spot1d/BTCUSDT.json", (1, 5))
    print("fp166 " + f"spot {len(spot)} last {max(spot)}")
