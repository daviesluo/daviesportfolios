"""Score the fp54 screen. 2023 only.

    python3 docs/agents/scripts/fp54/measure.py
"""
...
PROTOCOL = ROOT / "docs/agents/reviews/2026-09-25-fp54-protocol.md"
...
def main() -> None:
    ...
    row = c.fp5.summarise(
        "VOL-CLOCK", c.clock_trades(daily, hours), pool, c.MIN_N,
        "Quote-weighted hour of the day, above its own trailing 90th. Next day, long BTC.",
    )
    payload = {
        "protocol_sha256": sha256(PROTOCOL),
        "code_sha256": {
            "fp54_common": sha256(Path(__file__).resolve().parent / "common.py"),
            "fp54_measure": sha256(Path(__file__)),
    ...
    out = ROOT / "docs/agents/backtests/fp54/screen_2023.json"
