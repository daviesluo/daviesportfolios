"""The search fp299. Fair value is the Coinbase Exchange BTC-USD daily close. The finished Binance spot close was at least five basis points under that close, so the next Binance spot open is a price that finished cheap to Coinbase. Buy Binance spot for fourteen days. The other trade buys Binance spot for fourteen days on these same prices when that discount is absent.
...
NULL_SIDE = 'long'
FILES = {
    RULE_BOOK: ('spot1d/BTCUSDT.json', True),
    FAIR_KEY: ('cb1d/BTC-USD.json', False),
}
PULLS = [
    ('spot', 'BTCUSDT', 'spot1d', True),
