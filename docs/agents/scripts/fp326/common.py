"""The search fp326. Fair value is the Economist Big Mac absolute purchasing-power ratio, the US local price divided by the euro-area local price, then divided by the Coin Metrics BUSD PriceUSD that had already completed. The result is quoted in the same unit as EURBUSD. The previous EURBUSD close is at least two hundred basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent.
...
PARTS = {
    "usd": {
        ...
        "first": 1643673600000,
        "last": 1690848000000,
        "first_px": "1.140271493212669683257918552",
        "last_px": "1.056818181818181818181818182",
    },
    "busd": {
        "file": "busd.json",
        "n": 425,
...
BIG_PAIRS = (
    ("2022-01-01", ("5.04", "4.42")),
    ("2022-07-01", ("5.15", "4.65")),
    ("2023-01-01", ("5.36", "4.81")),
    ("2023-07-01", ("5.58", "5.28")),
)
NOTE = (
    "Fair value is the Big Mac US price divided by the euro-area Big Mac price, then divided by the Coin Metrics BUSD price that had already completed. The previous EURBUSD close is at least two hundred basis points under that price. Buy the spot book for two days. The other trade buys it for two days when that discount is absent. Same prices, same side, the edge turned off. One leg. The traded open is the fill only. The entry day's close is not an input. Another venue's close is not an input. A book ticker is not read."
)
