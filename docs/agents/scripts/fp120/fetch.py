"""Pull the public series the fp120 screen is allowed to see.
...
requested. ETH, BNB, DOGE and XRP option files are not requested.
    ...
    python3 docs/agents/scripts/fp120/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp120-research"}
SPOT_FIELDS = (1,)
