"""The search fp309. Fair value is the Gate.io BTC_USDT daily close. The finished USDT close was at least five basis points under that close, so the next USDT open is a price that finished cheap to Gate.io. Buy the USDT book for eight days. The other trade buys the USDT book for eight days on these same prices when that discount is absent.
...
FILES = {
    ...
    FAIR_KEY: ('gt1d/BTC_USDT.json', False),
}
PULLS = [
    ('um', 'BTCUSDT', 'um1d', True),
    ('gt', 'BTC_USDT', 'gt1d', False),
]
