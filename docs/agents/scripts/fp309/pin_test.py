...
"""Pins for the fp309 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != 'GATCH' or c.HOLD_DAYS != 8 or c.NULL_KIND != "other_regime":
    ...
    if c.FAIR_KEY != 'gt' or c.FAIR_KEY in ("spot", "um", "cm", "cb", "db"):
