...
because it can be an exit. A later open is a bug.
    ...
    python3 docs/agents/scripts/fp79/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp79-research"}
...
def main() -> None:
    ...
    print(
        f"fp79 BTCUSDT 1h {len(hourly)} first {min(hourly)} last {max(hourly)}; "
