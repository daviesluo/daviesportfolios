"""Pull the inputs this rule stores. No later year is requested as a signal.
    ...
    python3 docs/agents/scripts/fp240/fetch.py
"""
...
UA = {"User-Agent": "daviesportfolios-fp240-research"}
...
def main() -> None:
    ...
    counts.append(len(pull("spot", "BTCUSDT", c.fp5.SCREEN_END_MS, "spot1d")))
    counts.append(len(pull("cm", "BTCUSD_PERP", last, "cm1d")))
    print("fp240 " + " ".join(str(n) for n in counts))
