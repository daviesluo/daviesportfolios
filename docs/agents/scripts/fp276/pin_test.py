...
"""Pins for the fp276 rule. No file and no return from 2023 is read."""
...
def test_rule() -> None:
    if c.IDEA != "BOTHUP" or c.HOLD_DAYS != 27 or c.NULL_KIND != "other_book":
