"""The search fp245. A finished twenty-day coin-margined decline, then a fifteen-day USDT short.
...
not added. The null is that same 15-day short on every day.
"""
