# Pre-registration: BASE-CHG, the change in base volume (fp57)
...
`2026-09-25-fp57-prereg-base.sha256`.

## Why this one

The screen in `2026-09-25-fp57-protocol.md` scored one idea on 2023 only.
BASE-CHG passed: 44 trades, mean net +65.1976 bps after 20 bps of fees, total
+$28.6869 on $100 a trade, against a null p95 of +63.9818 bps (200 draws,
seed 20250925). This file is the test that decides whether that pass was
the year.

fp5 through fp56 and fp58 through fp61 stay dead, including LS-FADE, BODY,
BAL-CHG, IMPACT, PEAK, STREAK, OPEN-DRIVE, and AVG-CHG. VOL-CLOCK is
pre-registered beside this file and is not retuned here. Nothing in the dead
rules is retuned. A day whose base volume did not rise is not a candidate.
The 80th of a failed screen is not a candidate. IMPACT's 80th and 95th are
not candidates. STREAK's, OPEN-DRIVE's and AVG-CHG's 80th and 95th are not
candidates. PEAK's close under the prior 30-day high, and its 80th, are not
candidates. BODY's 80th is not a candidate. The level of the address count
is not scored, and BAL-CHG's 80th is not a candidate.
...
the code that reproduces the screen. No base volume from 2024 onward has
...
entry. That bar's base volume is stored as 0.
...
* The statistic is today's base volume divided by yesterday's base volume,
  minus 1. Both must be positive. Yesterday is exactly one day earlier.
  Quote volume and the trade count do not enter.
...
* Reproduction, not the bar: entries in 2023, at the screen's fee with no
  spread. Must come back as 44 trades and +$28.6869 within one cent. If it
...
* OOS2: entries on [2025-01-01, 2026-09-25). The last entry is 2026-09-24
  ...
  The 2026-09-25 base volume is stored as 0.
