...
import { mergeOvernightSeries } from '../prices/overnight_intraday.js';
import { fourHourSlots, SLOTS_PER_DAY } from '../prices/market_hours.js';
...
import { COMPANY_NAMES } from '../tables/holdings_list.jsx';

// Ticker classification predicates moved to `src/prices/ticker_class.js` so
...
export function TickerChartModal({ ticker, holding, marketData, extendedHours, phase, onClose, portfolioTotalValue, hideValues }) {
  ...
  // Moving-average overlay — pure math lives in `src/charts/indicators.js`.
