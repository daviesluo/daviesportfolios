...
describe('applyTrading212', () => {
  it('replaces lots / shares / cost for matching tickers; leaves others alone', () => {
    const holdings = {
      'VUAG.L': {
        currency: 'GBP',
        lastPrice: 110,
        lots: [{ date: '2024-01-01', shares: 5, cost: 500 }],
        shares: 5,
        cost: 500,
      },
      'SEGM.L': {
        currency: 'GBP',
        lastPrice: 12,
        lots: [{ date: '2024-06-01', shares: 100, cost: 1000 }],
        shares: 100,
        cost: 1000,
      },
      'NVDA': {
