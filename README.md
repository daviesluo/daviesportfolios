...
npm test              # vitest (163 client-side cases — YTD math, indicators, cache, ticker shape, fetch strategy, portfolio metrics + FX, lot sanitisation, market-cache + legacy fallback, SW banner suppression window, ops-badge desktop gate, portfolio fingerprint diffing)
