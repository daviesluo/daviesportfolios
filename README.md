...
- **Agents** is the crypto strategies page. Headline: **TOTAL REALIZED
  ...
  **what the rule sees** — one row per symbol of the latest observation as
  ...
  against equal-weight buy-and-hold). Refreshes every minute while open; the
  hide-values toggle masks money the same way as everywhere else.
