...
- **Agents (crypto auto-trading, paper first)** — an "Agents" page behind
  ...
  since migration `0039`, AVAX — its 1h variant, 30-day momentum and
  relative-strength rotation over BTC/ETH/SOL/XRP) across two venues — Revolut X executes at 0 % maker and reads Kraken's candles
