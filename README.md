...
| `docs/handover.md` | The ledger's **archive**: the append-only decision log and the raw session transcripts, 35k lines. Closed operations move here verbatim from `LEDGER.md`. Opened only when a closed item is reopened or audited. Quotes real positions — do not copy balances out of it. |
