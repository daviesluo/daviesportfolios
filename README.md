...
- **Top Movers · Today** — the largest **actual** winners and losers,
  up to five each, ranked either way from a `%` / `$` switch in the
  panel's title row. `%` asks what moved; `$` asks what moved the
